<?php
// $Header: /cvsroot/tikiwiki/tiki/lib/imagegals/imagegallib.php,v 1.45.2.43 2008/01/28 17:36:26 mose Exp $
...
# this is probably uneeded now
  ...
  function issupported($imagetype) {
            ...
            $this->havegd == true)
    {
      ...
      case 'image/pjpeg':
      case 'image/jpg':
	if (isSet($this->gdinfo["JPG Support"]))
	        return ($this->gdinfo["JPG Support"]);
	else
		return ($this->gdinfo["JPEG Support"]);
