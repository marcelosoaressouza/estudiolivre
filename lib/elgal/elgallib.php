...
class ELGalLib extends TikiLib {
  ...
  // 2.0 re-implementado em Publication
  function check_field_titulo($name) {
    return $this->check_required_field($name, 'O título é obrigatório');
  }
  function check_field_autor($value) {
    return $this->check_required_field($value, 'O autor é obrigatório');
  }
  function check_field_descricao($value) {
    return $this->check_required_field($value, 'A descrição é obrigatória');
  }
  // 2.0 re-implementado em Publication
  ...
  function check_field_tamanhoImagemX($value) {
    return $this->check_numeric_field($value, 'Largura deve ser um número');
  }
  function check_field_tamanhoImagemY($value) {
    return $this->check_numeric_field($value, 'Altura deve ser um número');
  }
  function check_field_dpi($value) {
    return $this->check_numeric_field($value, 'DPI deve ser um número');
  }
  function check_field_duracao($value) {
    return $this->check_numeric_field($value, 'Duração deve ser um número');
  }
  function check_field_bpm($value) {
    return $this->check_numeric_field($value, 'BPM deve ser um número');
  }
  function check_field_sampleRate($value) {
    return $this->check_numeric_field($value, 'Sample rate deve ser um número');
  }
  function check_field_bitRate($value) {
    return $this->check_numeric_field($value, 'Bit rate deve ser um número');
  }
