...
class Field {
  ...
  function isIndexable() {
    return $this->_test('weight');
  }
  function isSuggestedFilter() {
    return $this->_test('suggestedFilter');
  }
  function isSuggestedField() {
    return $this->_test('suggestedField');
  }
  function isVersionable() {
    return $this->_test('versionable');
  }
  ...
  function renderFilter() {
    return $this->render("filter", false);
  }
