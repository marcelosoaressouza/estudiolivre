...
// $Header: /cvsroot/tikiwiki/tiki/tiki-webmail_download_attachment.php,v 1.6.2.4 2008/01/31 20:34:56 marclaporte Exp $
...
$content = $part->body;
$names = preg_split('/;/', $part->headers["content-disposition"]);
