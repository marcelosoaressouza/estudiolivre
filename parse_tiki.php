<?php // $Header: /cvsroot/tikiwiki/tiki/Attic/parse_tiki.php,v 1.5 2004/06/16 01:24:10 teedog Exp $
...
#AABBFF; }
                                                     .atime, .ctime, .mtime, .date { background-color:
#dedede; }
                                                         .size, .rev, .tag { background-color:
#ededed; }
