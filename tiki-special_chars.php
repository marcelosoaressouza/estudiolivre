<?php // -*- coding:utf-8 -*-
/* $Header: /cvsroot/tikiwiki/tiki/tiki-special_chars.php,v 1.1.2.6 2007/12/22 01:55:57 mose Exp $ */
...
<form name="characters">
  ...
  <option value="}">
              ...
              <option value="'"> ' </option>
                            ...
                            onclick="javascript:window.opener.document.getElementById('<?php echo $area;
              ?>').value=window.opener.document.getElementById('<?php echo $area;
              ?>').value+getElementById('spec').value;" name="ins" value="ins" />
              <input type="button" class="button"
