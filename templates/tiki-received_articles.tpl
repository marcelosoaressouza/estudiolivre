{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-received_articles.tpl,v 1.17.2.13 2007/08/05 15:37:47 bluestrain Exp $ *}
<h1><a class="pagetitle" href="tiki-received_articles.php">{tr}Received articles{/tr}</a>

{if $feature_help eq 'y'}
<a href="{$helpurl}Communication+Center" target="tikihelp" class="tikihelp" title="{tr}Received Articles{/tr}">
