...
<a href="{$helpurl}i18n" target="tikihelp" class="tikihelp" title=" 
{tr}edit translations{/tr}"><img src="img/icons/help.gif" border="0" height="16" width="16" alt='{tr}help{/tr}' /></a>
{/if}
