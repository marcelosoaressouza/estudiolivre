...
<div class="cbox-data">
Our latest stable release is Tiki 1.9.8.3 -Sirius- you can download
...
<li>At the <a href="tiki-galleries.php" class="link">images galleries</a> section you can see and upload some images.</li>
