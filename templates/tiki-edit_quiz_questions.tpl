{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-edit_quiz_questions.tpl,v 1.16.2.9 2007/08/04 20:35:34 marclaporte Exp $ *}
...
<a href="{$helpurl}Quiz" target="tikihelp" class="tikihelp" title="{tr}edit quiz questions{/tr}"><img border='0' src='img/icons/help.gif' alt="{tr}help{/tr}" /></a>{/if}
...
<h2>{tr}Import questions from text{/tr}
 {if $feature_help eq 'y'}
<! -- help link data -- >
  <a href="{$helpurl}Quiz+Question+Import" target="tikihelp" class="tikihelp">
