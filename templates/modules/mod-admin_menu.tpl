{* $Header: /cvsroot/tikiwiki/tiki/templates/modules/mod-admin_menu.tpl,v 1.24.2.7 2007/08/11 20:45:52 marclaporte Exp $ *}
...
{/if}
    ...
    {/if}
    {if $tiki_p_admin_chat eq 'y' and $feature_chat eq 'y'}
      &nbsp;<a href="tiki-admin_chat.php" class="linkmenu">{tr}Chat{/tr}</a><br />
    {/if}
    {if $tiki_p_admin_categories eq 'y' and $feature_categories eq 'y'}
      &nbsp;<a href="tiki-admin_categories.php" class="linkmenu">{tr}Categories{/tr}</a><br />
    {/if}   
    {if $tiki_p_admin_banners eq 'y' and $feature_banners eq 'y'}
    ...
    {/if}
    {if $tiki_p_admin_drawings eq 'y' and $feature_drawings eq 'y'}
      &nbsp;<a href="tiki-admin_drawings.php" class="linkmenu">{tr}Admin drawings{/tr}</a><br />
    {/if}
    {if $tiki_p_admin_dynamic eq 'y' and $feature_dynamic_content eq 'y'}
    ...
    {/if}
    {if $tiki_p_admin_mailin eq 'y' and $feature_mailin eq 'y'}
    ...
    {/if}
    {if $tiki_p_edit_html_pages eq 'y' and $feature_html_pages eq 'y'}
      &nbsp;<a href="tiki-admin_html_pages.php" class="linkmenu">{tr}HTML pages{/tr}</a><br />
    {/if}
    {if $tiki_p_admin_shoutbox eq 'y' and $feature_shoutbox eq 'y'}
    ...
    {/if}
    {if $tiki_p_view_referer_stats eq 'y' and $feature_referer_stats eq 'y'}
    &nbsp;<a href="tiki-referer_stats.php" class="linkmenu">{tr}Referer stats{/tr}</a><br />
    {/if}
    {if $tiki_p_admin eq 'y'}

{* This would need a check to see if mods is installed
