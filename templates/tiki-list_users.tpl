{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-list_users.tpl,v 1.2.2.27 2007/08/05 14:16:31 marclaporte Exp $ *}
<h1><a class="pagetitle" href="tiki-list_users.php">{tr}User List{/tr}</a>

{if $feature_help eq 'y'}
<a href="{$helpurl}Community" target="tikihelp" class="tikihelp" title="{tr}User List{/tr}">
