{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-quiz_edit.tpl,v 1.14.2.8 2007/08/04 15:58:47 marclaporte Exp $ *}
...
{if $feature_help}
&nbsp &nbsp &nbsp<a title="{tr}help{/tr}" href="{$helpurl}Quiz" target="help"><img src="img/icons/help.gif" border="0" height="16" width="16" alt='{tr}help{/tr}' /></a>
{/if}
</h1>
