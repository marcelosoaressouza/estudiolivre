...
<a href="{$helpurl}RSS+User" target="tikihelp" class="tikihelp" title="{tr}admin RSS modules{/tr}">
...
<div class="rbox" name="tip">
<div class="rbox-title" name="tip">{tr}Tip{/tr}</div>  
<div class="rbox-data" name="tip">{tr}To aggregate several RSS feeds, use {literal}{rss id=x+y+z}{/literal}. <b>"show publish date" must be checked.<b/>{/tr}</div>
</div>
<br />
...
<tr><td class="formcolor">{tr}URL{/tr}:</td><td class="formcolor"><input size="47" type="text" name="url" value="{$url|escape}" />
<a {popup text='Do not add an RSS feed of the current site. You could create a loop. Use modules instead (such as last_articles).'}><img src="img/icons/help.gif" border="0" height="16" width="16" alt='{tr}help{/tr}' /></a>
</td></tr>
...
<tr><td class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" class="button" name="save" value="{tr}Save{/tr}" /></td></tr>
</table>
</form>
