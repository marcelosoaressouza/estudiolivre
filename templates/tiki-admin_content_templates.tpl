...
<a href="{$helpurl}Content+Template" target="tikihelp" class="tikihelp" title="{tr}Managing content templates{/tr}"><img src="img/icons/help.gif" border="0" height="16" width="16" alt='{tr}help{/tr}' /></a>
{/if}
