{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-file_galleries.tpl,v 1.26.2.24 2007/08/29 07:20:31 luciash Exp $ *}

<h1><a class="pagetitle" href="tiki-file_galleries.php?galleryId={$galleryId}">{tr}File Galleries{/tr}</a>

{if $feature_help eq 'y'}
<a href="{$helpurl}File+Gallery" target="tikihelp" class="tikihelp" title="{tr}File Galleries{/tr}">
