{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-edit_quiz.tpl,v 1.19.2.12 2007/08/04 16:16:23 marclaporte Exp $ *}
...
<a href="{$helpurl}Quiz" target="tikihelp" class="tikihelp" title="{tr}Quizzes{/tr}">
