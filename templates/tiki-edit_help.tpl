{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-edit_help.tpl,v 1.24.2.29 2007/11/13 14:54:50 ricks99 Exp $ *}
...
<p>{tr}For more information, please see <a href="{$helpurl}Wiki+Syntax">Wiki Syntax</a>{/tr}</p>
