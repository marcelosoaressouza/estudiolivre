{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-my_tiki.tpl,v 1.12.2.13 2007/08/11 05:00:23 marclaporte Exp $ *}
...
{/capture}
{$smarty.capture.my}
{if $smarty.capture.my|strip:'' eq ''}{tr}To display the objects you participate to:{/tr} <a href="tiki-user_preferences.php?tab3#MyTiki">{tr}My Tiki{/tr}</a>{/if}