{* $Header: /cvsroot/tikiwiki/tiki/templates/comments.tpl,v 1.44.2.40 2007/08/13 15:09:30 luciash Exp $ *}
...
{if ($tiki_p_forum_post eq 'y' and $forum_mode eq 'y') or ($tiki_p_post_comments eq 'y' and $forum_mode ne 'y')}
  ...
  {/if}
    ...
    <tr>
      ...
      <td class="formcolor"><input type="text" size="60" name="comments_title" id="comments-title" value="{$comment_title|escape}" /></td>
    </tr>
...
{* End: Xenfasa adding and testing article ratings in comments here *}
    ...
    <tr>
	  ...
	  <br /><br />{include file="textareasize.tpl" area_name='editpost2' formId='editpostform'}<br /><br />{if $quicktags}{include file=tiki-edit_help_tool.tpl area_name='editpost2'}{/if}</td>
