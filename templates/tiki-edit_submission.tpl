...
{html_select_date prefix="publish_" time=$publishDate start_year="-5" end_year="+10"} {tr}at{/tr} <span dir="ltr">{html_select_time prefix="publish_" time=$publishDate display_seconds=false}
&nbsp;{tr}Your time{/tr}
</span>
</td></tr>
...
{html_select_date prefix="expire_" time=$expireDate start_year="-5" end_year="+10"} {tr}at{/tr} <span dir="ltr">{html_select_time prefix="expire_" time=$expireDate display_seconds=false}
&nbsp;{tr}Your time{/tr}
</span>
</td></tr>
</table>
