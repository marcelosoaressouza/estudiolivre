...
<br/>
	<div class="pb" id="descriptionInfo">
		...
		<div id="descCont" class="itemCont" style="display:block">
			...
			{else}
				{ajax_textarea permission=$permission style="width: 250px; height:125px; border: 1px outset rgb(233, 233, 174);padding: 3px;font-size: 12px; font-family: Arial, Verdana, Helvetica, Lucida, Sans-Serif;background-color: #f1f1f1;margin-bottom: 5px;" id="description" value=$arquivo->description display="block" wikiParsed=1}
			{/if}
		</div>
	</div>
...
<div class="pb"	id="pubComments">		
		<div class="sectionTitle">
			...
			{tr}Comentários{/tr} (<span id="ajax-commentCount">{$comments}</span>)</h3>
				</span>
		</div>
