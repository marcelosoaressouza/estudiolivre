...
{* --- page title block --- *}
{strip}
		<title>{tr}Confirm your action{/tr}: {if $trail}{breadcrumbs type="fulltrail" loc="head" crumbs=$trail}{else}{$siteTitle}
				...
				<div id="wrapper"><!-- START of column 1 wrapper -->
					<div id="col1" class="{if $feature_left_column ne 'n'} marginleft{/if}{if $feature_right_column ne 'n'} marginright{/if}">
						...
						<div class="content">
							...
							<div class="cbox">
								<div class="cbox-title">{$errortitle|default:"{tr}Please, confirm your action{/tr}"}</div>
								<div class="cbox-data">{$msg}
