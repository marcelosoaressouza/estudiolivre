{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-assignpermission.tpl,v 1.49.2.28 2007/12/19 22:19:50 redflo Exp $ *}
{* TODO: Must fix even/odd table rows detection by using Smarty 'cycle' *}


<h1><a href="tiki-assignpermission.php?group={$group}" class="pagetitle">{tr}Assign permissions to group{/tr}: {$group}</a>
{if $feature_help eq 'y'}
<a href="{$helpurl}Permissions" target="tikihelp" class="tikihelp" title="{tr}Edit Article{/tr}">
