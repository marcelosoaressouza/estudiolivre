...
<h1>{tr}Tiki installer{/tr} v1.9.10.1 <a title='{tr}help{/tr}' href='http://doc.tikiwiki.org/Installation' target="help"><img
...
<td>&nbsp;</td>
 ...
 rowspan="1" height="26"><font size="5"><b>{tr}Install{/tr}</b></font>
			...
			<a target="_blank" href="http://doc.tikiwiki.org/Profiles" class="link">{tr}Descriptions of the 
available profiles{/tr}</a>
		    </td>
		    <tr><td colspan="2">
 ...
 rowspan="1" height="26"><font size="5"><b>{tr}Upgrade{/tr}</b></font>
		    ...
		    <tr><td colspan="2">
		    	{tr}For information about tiki-secdb_*.sql files, please see <a target="help" 
href="http://doc.tikiwiki.org/Security+Admin">http://doc.tikiwiki.org/Security+Admin{/tr}</a>
     ...
     <form name="loginbox" action="tiki-install.php" method="post">
		  ...
		  {/if}
    	{else}
    		<b>{$succcommands|@count} {tr}sql queries have successfully been executed.{/tr}</b><br /><br />
    		...
    		{tr}Your database has been configured and Tiki is ready to run, if
