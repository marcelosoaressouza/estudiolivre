{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-edit_help_tool.tpl,v 1.15.2.10 2007/08/19 06:32:37 marclaporte Exp $ *}
<div class="quicktag">
{literal}
...
{/literal}
<a href="javascript:toggleBlock('quicktags{$qtnum}');" onclick="needToConfirm = false;" class="link"><img src="img/icons/plus.gif" border='0' alt='+' />&nbsp;{tr}Quicktags{/tr} ...</a><br /><br />
...
{section name=qtg loop=$quicktags}
<a title="{tr}{$quicktags[qtg].taglabel}{/tr}" href="javascript:taginsert('{$area_name}','{$quicktags[qtg].tagId}');" onclick="needToConfirm = false;"><img
...
<br /><a href="tiki-admin_quicktags.php" class="link" onclick="needToConfirm = true;" >{tr}admin quicktags{/tr}</a>
{/if}
</div>
</div>
