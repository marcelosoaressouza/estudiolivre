...
// $Header: /cvsroot/tikiwiki/tiki/tiki-forum_queue.php,v 1.10.2.8 2007/07/09 06:26:40 nkoth Exp $
...
if (isset($_REQUEST['qId'])) {
	...
	check_ticket('forum-queue');
		...
		$commentslib->replace_queue($_REQUEST['qId'], $_REQUEST['forumId'], 'forum:' . $_REQUEST['forumId'], $_REQUEST['parentId'],
			$_REQUEST['origuser'], $_REQUEST['title'], $_REQUEST['data'], $_REQUEST['type'], $_REQUEST['topic_smiley'], $_REQUEST['summary'],
			$_REQUEST['topic_title']);
		unset ($_REQUEST['qId']);
	}
