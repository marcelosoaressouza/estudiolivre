...
// $Header: /cvsroot/tikiwiki/tiki/tiki-webmail.php,v 1.25.2.17 2008/01/31 20:20:29 marclaporte Exp $
...
if($_REQUEST["locSection"] == 'read') {
  ...
  if(isset($_REQUEST["delete_one"])) {
    ...
    if(isset($aux["Message-Id"])) {
      $aux["Message-ID"] = $aux["Message-Id"];
    }

    elseif(isset($aux["Message-id"])) {
      $aux["Message-ID"] = $aux["Message-id"];
    }
