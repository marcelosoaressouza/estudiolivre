...
if ($feature_trackers == 'y') {
	...
	if (isset($module_params["trackerId"]) && isset($module_params["name"])) {
		...
		$smarty->assign('modLastItems', array_reverse($modLastItems));
	} else {
		// TODO: improve this, maybe give out an error.
		if (!isset($module_params["trackerId"])) $smarty->assign('modLastItems', array()); 
		if (!isset($module_params["name"])) $smarty->assign('modlifn', ""); 
    }
