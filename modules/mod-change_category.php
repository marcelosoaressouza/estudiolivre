<?php
// $Header: /cvsroot/tikiwiki/tiki/modules/mod-change_category.php,v 1.1.2.6 2007/08/12 13:13:08 ohertel Exp $
...
if($feature_categories == 'y' and isset($_REQUEST['page'])) {
  ...
  if(!is_object($categlib)) require("lib/categories/categlib.php");
