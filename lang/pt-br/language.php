...
"since_last_visit_new" => "Últimas Alterações",
"who_is_there" => "amigos online",
...
"Users can vote only one item from this chart per period" => "Usuári@s só podem votar em um item deste gráfico por período",
"Prevent users from voting same item more than one time" => "Evitar que @s usuári@s votem mais de uma vez no mesmo item",
...
"Users can subscribe any email addresss" => "Usuári@s podem assinar de qualquer endereço de email",
...
"Anonymous users cannot edit pages" => "Usuári@s anônim@s não podem editar páginas",
...
"Unexistant user" => "Usuári@ inexistente",
"The user has choosen to make his information private" => "@ usuári@ escolheu deixar suas informações privadas",
...
"In blog listing show user as" => "Na listagem de Blog mostrar @ usuári@ como",
...
"Users see and add events in their timezone" => "Usuári@s visualizam e adicionam eventos no horário local",
...
"you can see users rank by score in the module users_rank, for that go to" => "você pode ver o raking de usuári@s por pontos no módulo users_rank, para isso vá para",
"list events" => "listar eventos",
"admin events" => "eventos do administrador",
"send events" => "enviar eventos",
"Add all users" => "Adicionar tod@s @s usuári@s",
...
"Company:" => "Empresa:",
"create new user" => "criar nov@ usuári@",
...
"Sorry the task user has no right to recive tasks" => "Desculpe, @ usuári@ da tarefa não tem permissão para receber tarefas",
...
"User \$a_user can not receive messages" => "Usuári@ \$a_user não pode receber mensagens",
"Invalid user: \$a_user" => "Usuári@ Inválido: \$a_user",
...
"Add all your site users to this newsletter (broadcast)" => "Adicionar tod@s usuári@s do seu site a este comunicado (comunicado geral)",
...
"Error: This page is being edited by another user." => "Erro: Esta página está sendo editada por outr@ usuári@.",
...
"Invalid username or activation code" => "Usuári@ ou código de ativação inválido",
...
// "Publicação inexistente" => "Publicação inexistente",
// "Estúdio Livre: Acervo" => "Estúdio Livre: Acervo",
// "Imagem redimensionada" => "Imagem redimensionada",
// "Impossível gravar miniatura" => "Impossível gravar miniatura",
// "O arquivo fornecido não é uma imagem." => "O arquivo fornecido não é uma imagem.",
// "O tamanho máximo da miniatura é de \$maxSize kBytes." => "O tamanho máximo da miniatura é de \$maxSize kBytes.",
// "Você não escolheu nenhum arquivo!" => "Você não escolheu nenhum arquivo!",
// "Arquivo inexistente!" => "Arquivo inexistente!",
// "');\nTikiSetup::prependIncludePath('lib/elgal/model" => "');\nTikiSetup::prependIncludePath('lib/elgal/model",
// "O ponto de montagem e a senha devem ser compostos apenas por letras (sem acento) e números, sem espaços." => "O ponto de montagem e a senha devem ser compostos apenas por letras (sem acento) e números, sem espaços.",
// "Esse ponto de montagem já existe, por favor escolha outro." => "Esse ponto de montagem já existe, por favor escolha outro.",
// "Você precisa definir o usuário" => "Você precisa definir o usuário",
// "Feed RSS para blogs de \$userName" => "Feed RSS para blogs de \$userName",
// "Feed RSS das mensagens enviadas para \$userName" => "Feed RSS das mensagens enviadas para \$userName",
// "Andorra" => "Andorra",
...
// "Duração deve ser um número em segundos" => "Duração deve ser um número em segundos",
// "BPM deve ser um número" => "BPM deve ser um número",
// "\"Sample rate\" deve ser um número" => "\"Sample rate\" deve ser um número",
// "\"Bit rate\" deve ser um número" => "\"Bit rate\" deve ser um número",
// "Erro: extensão de arquivo não suportada pelo acervo." => "Erro: extensão de arquivo não suportada pelo acervo.",
// "Erro: extensão \$m[1] não suportada pelo acervo." => "Erro: extensão \$m[1] não suportada pelo acervo.",
// "Largura deve ser um número" => "Largura deve ser um número",
// "Altura deve ser um número" => "Altura deve ser um número",
// "DPI deve ser um número" => "DPI deve ser um número",
// "O título é obrigatório" => "O título é obrigatório",
// "O autor é obrigatório" => "O autor é obrigatório",
// "A descrição é obrigatória" => "A descrição é obrigatória",
// "Você deve escolher uma licença" => "Você deve escolher uma licença",
// "Você não terminou de enviar o arquivo" => "Você não terminou de enviar o arquivo",
// "Duração deve ser um número" => "Duração deve ser um número",
// "section edit" => "section edit",
// "EstudioLivre" => "EstudioLivre",
// "index" => "index",
// "Você tentou inserir um template dentro dele mesmo, isso causaria um loop infinito. Por favor conserte isso na edição da página." => "Você tentou inserir um template dentro dele mesmo, isso causaria um loop infinito. Por favor conserte isso na edição da página.",
...
// "Mostra lista de arquivos do acervo com determinada tag ou por id" => "Mostra lista de arquivos do acervo com determinada tag ou por id",
// "Este wikiplugin ficou obsoleto e foi substituído pelo ACERVO" => "Este wikiplugin ficou obsoleto e foi substituído pelo ACERVO",
...
// "Threaded" => "Threaded",
// "Tem certeza que quer apagar esse arquivo do acervo?" => "Tem certeza que quer apagar esse arquivo do acervo?",
// "Não mostrar este aviso novamente" => "Não mostrar este aviso novamente",
// "SIM" => "SIM",
// "NÃO" => "NÃO",
// "Erro no formulário" => "Erro no formulário",
// "Assinar RSS do acervo" => "Assinar RSS do acervo",
// "Estrelas" => "Estrelas",
// "Título" => "Título",
...
// "tipo" => "tipo",
// "ler mais" => "ler mais",
// "Arquivo sem descrição" => "Arquivo sem descrição",
// "baixado" => "baixado",
// "vez" => "vez",
// "vezes" => "vezes",
// "visto" => "visto",
...
// "Detentor(a) dos DA" => "Detentor(a) dos DA",
// "Produtora" => "Produtora",
// "Contato" => "Contato",
// "Tipo do audio" => "Tipo do audio",
// "Gênero" => "Gênero",
// "Álbum" => "Álbum",
// "lyrics" => "lyrics",
// "Ficha Técnica" => "Ficha Técnica",
// "Tipo de imagem" => "Tipo de imagem",
// "Tipo da publicação" => "Tipo da publicação",
// "Idioma do Vídeo" => "Idioma do Vídeo",
// "Tem legenda" => "Tem legenda",
// "Idioma da Legenda" => "Idioma da Legenda",
// "Acionando o botão \"CONCORDO\" abaixo, você está concordando com todos os Termos e Política de Uso deste site." => "Acionando o botão \"CONCORDO\" abaixo, você está concordando com todos os Termos e Política de Uso deste site.",
// "Informo ser o titular do material (fonogramas, imagens, audiovisual, softwares, textos, samples, etc.) que envio para o ESTUDIOLIVRE.ORG, e autorizo, sem exclusividade, a sua exibição e distribuição eletrônica no endereço www.estudiolivre.org segundo as condições no <a href=\"tiki-index.php?page=pol%C3%ADtica+de+uso\">Termo de Política de Uso do site</a> e da licença escolhida." => "Informo ser o titular do material (fonogramas, imagens, audiovisual, softwares, textos, samples, etc.) que envio para o ESTUDIOLIVRE.ORG, e autorizo, sem exclusividade, a sua exibição e distribuição eletrônica no endereço www.estudiolivre.org segundo as condições no <a href=\"tiki-index.php?page=pol%C3%ADtica+de+uso\">Termo de Política de Uso do site</a> e da licença escolhida.",
// "Declaro que todos os direitos autorais e conexos relacionados ao material submetido para armazenamento, exibição e distribuição no site foram integralmente satisfeitos e autorizados, me responsabilizando exclusivamente de forma irrevogável e irretratável pelas informações ora prestadas e assumindo a responsabilidade referente a quaisquer reclamações de terceiros acerca do material ora submetido." => "Declaro que todos os direitos autorais e conexos relacionados ao material submetido para armazenamento, exibição e distribuição no site foram integralmente satisfeitos e autorizados, me responsabilizando exclusivamente de forma irrevogável e irretratável pelas informações ora prestadas e assumindo a responsabilidade referente a quaisquer reclamações de terceiros acerca do material ora submetido.",
// "Também, estou ciente que o ESTUDIOLIVRE.ORG não assume nenhuma obrigação ou garantia relacionada à exibição e distribuição da obra ora licenciada, exposta e distribuída por este site." => "Também, estou ciente que o ESTUDIOLIVRE.ORG não assume nenhuma obrigação ou garantia relacionada à exibição e distribuição da obra ora licenciada, exposta e distribuída por este site.",
// "CONCORDO" => "CONCORDO",
// "NÃO CONCORDO" => "NÃO CONCORDO",
// "Selecione o tipo de publicação que deseja criar" => "Selecione o tipo de publicação que deseja criar",
// "Áudio" => "Áudio",
// "Imagem" => "Imagem",
// "Texto" => "Texto",
// "Vídeo" => "Vídeo",
// "Outro" => "Outro",
// "mais um arquivo..." => "mais um arquivo...",
// "Autor" => "Autor",
// "Autor da obra" => "Autor da obra",
// "outra miniatura..." => "outra miniatura...",
// "Escreva aqui a descrição da sua obra" => "Escreva aqui a descrição da sua obra",
// "Licença" => "Licença",
// "Tags" => "Tags",
// "Outras informações deste arquivo..." => "Outras informações deste arquivo...",
// "Arquivos não publicados" => "Arquivos não publicados",
// "por" => "por",
// "baixe tudo" => "baixe tudo",
// "voto{if \$votes != 1}s{/if}" => "voto{if \$votes != 1}s{/if}",
// "Arquivos da Publicação" => "Arquivos da Publicação",
// "Descrição" => "Descrição",
// "Detalhes da Publicação" => "Detalhes da Publicação",
// "Comentários" => "Comentários",
// "enviar" => "enviar",
// "Faça o login para comentar!" => "Faça o login para comentar!",
// "Escolha uma licença" => "Escolha uma licença",
// "Agora você precisa escolher sob qual licença sua obra será publicada" => "Agora você precisa escolher sob qual licença sua obra será publicada",
// "As questões abaixo te ajudam nessa tarefa, mas se você tiver alguma dúvida, visite o FAQ sobre" => "As questões abaixo te ajudam nessa tarefa, mas se você tiver alguma dúvida, visite o FAQ sobre",
// "Direitos autorais e generosidade intelectual" => "Direitos autorais e generosidade intelectual",
// "Permitir o uso comercial de sua obra?" => "Permitir o uso comercial de sua obra?",
// "Não" => "Não",
// "Sim" => "Sim",
// "Permitir o uso de trechos de sua obra para a criação de obras derivadas (sampling, colagem etc.)?" => "Permitir o uso de trechos de sua obra para a criação de obras derivadas (sampling, colagem etc.)?",
// "Permitir modificações em sua obra?" => "Permitir modificações em sua obra?",
// "Sim, contanto que outros compartilhem pela mesma licença" => "Sim, contanto que outros compartilhem pela mesma licença",
// "Definir como licença " => "Definir como licença ",
// "padrão" => "padrão",
// "Você deve escolher uma licença!" => "Você deve escolher uma licença!",
// "Escolher" => "Escolher",
// "Cancelar" => "Cancelar",
// "Canais ao vivo" => "Canais ao vivo",
// "Descubra como usar os canais ao vivo do estudiolivre" => "Descubra como usar os canais ao vivo do estudiolivre",
// "Visitantes" => "Visitantes",
// "Recorde de Visitantes" => "Recorde de Visitantes",
// "BitRate" => "BitRate",
// "Frame rate" => "Frame rate",
// "Nada ao vivo no EL no momento" => "Nada ao vivo no EL no momento",
// "Mas se você estiver procurando alguma coisa para ver, ouvir ou ler, não deixe de apreciar a diversidade do " => "Mas se você estiver procurando alguma coisa para ver, ouvir ou ler, não deixe de apreciar a diversidade do ",
// "acervo" => "acervo",
// "Editando Canal..." => "Editando Canal...",
// "Nome completo" => "Nome completo",
// "Localização" => "Localização",
// "Selecione sua licença Padrão" => "Selecione sua licença Padrão",
// "Usuári@ sem Licença Padrão" => "Usuári@ sem Licença Padrão",
// "Contribuições Recentes" => "Contribuições Recentes",
// "Tags desse usuário" => "Tags desse usuário",
// "Membro desde" => "Membro desde",
// "Canais de transmissão ao vivo" => "Canais de transmissão ao vivo",
// "ponto de montagem" => "ponto de montagem",
// "Novo Canal" => "Novo Canal",
// "Criar novo canal" => "Criar novo canal",
// "Galeria pessoal" => "Galeria pessoal",
// "Você ainda não possui arquivos no acervo livre" => "Você ainda não possui arquivos no acervo livre",
// "Compartilhe" => "Compartilhe",
// "sua obra" => "sua obra",
// "Esse(a) usuári@ ainda não possui arquivos no acervo livre" => "Esse(a) usuári@ ainda não possui arquivos no acervo livre",
// "comentaram" => "comentaram",
// "Você ainda não possui blogs" => "Você ainda não possui blogs",
// "Crie</a> um blog ou veja a " => "Crie</a> um blog ou veja a ",
// "lista" => "lista",
// "dos existentes" => "dos existentes",
// "Esse(a) usuári@ ainda não possui posts em blogs" => "Esse(a) usuári@ ainda não possui posts em blogs",
// "Recados" => "Recados",
// "Você ainda não tem uma página wiki pessoal" => "Você ainda não tem uma página wiki pessoal",
// "Crie" => "Crie",
// "seu wiki" => "seu wiki",
// "Esse(a) usuári@ ainda não possui uma página wiki pessoal" => "Esse(a) usuári@ ainda não possui uma página wiki pessoal",
// "Marcando mensagem" => "Marcando mensagem",
// "como <b>lida</b>" => "como <b>lida</b>",
// "Seja @ primeir@ a enviar uma mensagem para esse(a) usuári@!" => "Seja @ primeir@ a enviar uma mensagem para esse(a) usuári@!",
// "Você não pode enviar recados pois não está logado no site" => "Você não pode enviar recados pois não está logado no site",
// "visualizações" => "visualizações",
// "link pro arquivo" => "link pro arquivo",
...
// "O seu navegador não suporta todos os recursos do Estúdio Livre" => "O seu navegador não suporta todos os recursos do Estúdio Livre",
// "http://br.mozdev.org/firefox/" => "http://br.mozdev.org/firefox/",
// "Instale o navegador Firefox agora" => "Instale o navegador Firefox agora",
...
// "Altura" => "Altura",
// "DPI" => "DPI",
// "Tipo do arquivo" => "Tipo do arquivo",
// "Tem audio" => "Tem audio",
// "Tem cor" => "Tem cor",
// "Acervo" => "Acervo",
// "Meus arquivos" => "Meus arquivos",
// "Publicar" => "Publicar",
// "Enviada às" => "Enviada às",
...
// "Adicionar" => "Adicionar",
// "de" => "de",
// "RSS Acervo Livre" => "RSS Acervo Livre",
// "Admin TikiWiki" => "Admin TikiWiki",
// "Bread Crumbs" => "Bread Crumbs",
// "Últimas Alterações" => "Últimas Alterações",
// "Modificação não comentada" => "Modificação não comentada",
...
// "outros" => "outros",
// "Usuári@s Online" => "Usuári@s Online",
// "Não há usuári@s online" => "Não há usuári@s online",
// "Novo bug" => "Novo bug",
...
// "links" => "links",
// "compartilhe sua obra" => "compartilhe sua obra",
// "Para compartilhar a sua obra no <b>Acervo Livre</b> é necessário se <a href=\"tiki-register.php\">cadastrar</a> no site." => "Para compartilhar a sua obra no <b>Acervo Livre</b> é necessário se <a href=\"tiki-register.php\">cadastrar</a> no site.",
// "Se for cadastrado, efetue o login" => "Se for cadastrado, efetue o login",
// "senha" => "senha",
// "recuperar" => "recuperar",
// "Se preferir" => "Se preferir",
// "leia mais" => "leia mais",
// "sobre o <b>Acervo Livre</b>" => "sobre o <b>Acervo Livre</b>",
// "canais ao vivo" => "canais ao vivo",
// "sobre o" => "sobre o",
...
// "Ítens com a tag" => "Ítens com a tag",
// "Posts em blog" => "Posts em blog",
// "resultado" => "resultado",
...
// "Note that plugin arguments can be closed in double quotes (&quot;); this allows them to contain , or = or &gt;." => "Note that plugin arguments can be closed in double quotes (&quot;); this allows them to contain , or = or &gt;.",
// "gerar" => "gerar",
// "nova" => "nova",
// "Edição da página" => "Edição da página",
// "Mais opções" => "Mais opções",
// "Escolha o idioma dessa página..." => "Escolha o idioma dessa página...",
...
// "Pequena" => "Pequena",
// "Grande" => "Grande",
// "É <b>recomendável</b> comentar as modificações realizadas. Assim todos podem saber qual modificação foi feita na página." => "É <b>recomendável</b> comentar as modificações realizadas. Assim todos podem saber qual modificação foi feita na página.",
// "Faça o comentário no campo abaixo" => "Faça o comentário no campo abaixo",
// "Aperte <b>control + enter</b> para salvar as modificações feitas na página." => "Aperte <b>control + enter</b> para salvar as modificações feitas na página.",
// "Busca nas últimas alterações" => "Busca nas últimas alterações",
// "Busca" => "Busca",
// "Modificações com texto" => "Modificações com texto",
// "<b>Ou</b> nos últimos" => "<b>Ou</b> nos últimos",
// "dias" => "dias",
// "para" => "para",
// "Veja todas as alterações" => "Veja todas as alterações",
// "<b>Atenção:</b> listando somente as modificações feitas no" => "<b>Atenção:</b> listando somente as modificações feitas no",
// "último" => "último",
// "Veja as alterações feitas em qualquer dia" => "Veja as alterações feitas em qualquer dia",
// "\$lastchanges[changes].action" => "\$lastchanges[changes].action",
// "Busca em blogs" => "Busca em blogs",
// "Lista de usuári@s" => "Lista de usuári@s",
// "Busca de usuári@s" => "Busca de usuári@s",
// "Veja" => "Veja",
// "a lista de todos os usuári@s" => "a lista de todos os usuári@s",
// "Para votar é necessário se " => "Para votar é necessário se ",
// "cadastrar" => "cadastrar",
// "no site" => "no site",
// "usuári@" => "usuári@",
// "da página" => "da página",
// "Não existe uma página chamada {\$words}, mas você pode" => "Não existe uma página chamada {\$words}, mas você pode",
// "criá-la" => "criá-la",
// "(a página será órfã)" => "(a página será órfã)",
// "Você pode colaborar criando a página" => "Você pode colaborar criando a página",
// "Essa página ainda não tem tags" => "Essa página ainda não tem tags",
// "páginas que citam esta:" => "páginas que citam esta:",
// "às" => "às",
// "tag" => "tag",
// "Buscar" => "Buscar",
// "sobre" => "sobre",
...
// "gráfico" => "gráfico",
// "vídeo" => "vídeo",
// "Usar 'ctrl-enter' para salvar a página sendo editada (pode tornar a edição mais lenta)" => "Usar 'ctrl-enter' para salvar a página sendo editada (pode tornar a edição mais lenta)",
// "Este post não tem tags" => "Este post não tem tags",
// "permalink" => "permalink",
// "comentar" => "comentar",
// "Última modificação" => "Última modificação",
// "Editar bug" => "Editar bug",
// "Usuário" => "Usuário",
// "Assista a esse vídeo" => "Assista a esse vídeo",
// "Ouça essa música" => "Ouça essa música",
// "Veja essa imagem" => "Veja essa imagem",
// "texto" => "texto",
// "last topics in this forum" => "last topics in this forum",
// "comentário" => "comentário",
// "streams" => "streams",
...
// "{\$tracker_info.name} - Tracker item" => "{\$tracker_info.name} - Tracker item",
// "{\$tracker_info.name} - Item" => "{\$tracker_info.name} - Item",
// "LastModif" => "LastModif",
// "Any" => "Any",
...
// "You do not have permission to admin the calendars." => "You do not have permission to admin the calendars.",
...
// "Created account %s <%s> for %s." => "Created account %s <%s> for %s.",
// "New %s created with %s %s (%s)." => "New %s created with %s %s (%s).",
// "real name" => "real name",
...
"Unknown user" => "Usuári@ desconhecido",
"You are not logged in and no user indicated" => "Você não está logado e nenhum usuári@ foi indicado",
"The user has chosen to make his information private" => "@ usuári@ preferiu manter sua informação sob sigilo",
...
"See other user's profile" => "Veja outro perfil de usuári@",
...
"Download other user's file" => "Baixar outro arquivo d@ usuári@",
...
"See other user's gallery" => "Veja outra galeria d@ usuári@",
"See other user's image" => "Veja outra imagem d@ usuári@",
"Have your gallery seen by other user" => "Mostre sua galeria para outr@s usuári@s",
"Have your image seen" => "Mostre sua imagem para outros",
"Create new blog" => "Criar novo blog",
"Post in a blog" => "Postar no blog",
"Read other user's blog" => "Ler o blog de outr@ usuári@",
...
"User information - Click for more info" => "Informação d@ usuári@ - Clique para saber mais",
...
"user selector" => "selecionador de usuári@",
"User Selector: use options for automatic field feeding : you can use 1 for author login or 2 for modificator login." => "Seleção d@ usuári@: use opções para preenchimento automático dos campos: você pode usar 1 para login do autor ou 2 para o login do modificador.",
"group selector" => "selecionador de grupo",
"Group Selector: use options for automatic field feeding : you can use 1 for group of creation and 2 for group where modification come from. The default group has to be set, or the first group that come is chosen for a user, or the default group is Registered." => "Seletor de Grupo: para preenchimento automático dos campos use as opções: você pode usar 1 para criar grupos e 2 para modificar grupos. O grupo padrão deve ser especificado, ou o primeiro grupo que vier será escolhido pel@ usuári@, ou o grupo padrçao será  Registrado.",
...
"Displays the user Avatar" => "Exibe a fotografia d@ usuári@",
"username" => "usuári@",
...
"Displays the number of registered users" => "Mostrar o número de usuári@s registrad@s",
...
"author" => "autor",
"stars" => "estrelas",
"user level" => "nível de usuári@",
"private message" => "mensagem particular",
"send email to user" => "enviar email ao usuári@",
"user online" => "usuári@ on-line",
"user offline" => "usuári@ offline",
"on" => "em",
"score" => "pontuação",
"Vote" => "Votar",
"Edit" => "Editar",
...
"Hi {\$mail_user} has sent you this link:" => "Olá! @ usuári@ {\$mail_user} enviou este link para você:",
"Blog post:" => "Mensagem de blog:",
"at:" => "em:",
...
"If you want to be a registered user in this site you will have to use the following link to login for the first time:" => "Se você deseja ser um usuári@ registrad@ neste site, utilize o seguinte link para logar-se pela primeira vez:",
...
"If you want people to be able to reply to you, you have to check <a href='tiki-user_preferences.php'>Allow messages from other users</a>" => "Para que as pessoas possam enviar mensagens para você e responder as mensagens que você enviar é necessário habilitar <a href='tiki-user_preferences.php'>Permitir mensagens de outr@s usuári@s</a>",
"To" => "Para",
...
"User processes" => "Processos de usuári@",
"User activities" => "Atividades d@ usuári@",
"User instances" => "Instâncias de usuári@s",
"FriendsMenu" => "Menu dos amigos",
"Community" => "Comunidade",
"User list" => "Lista de usuári@s",
"Friendship Network" => "Rede de amigos",
"WikiMenu" => "MenuWiki",
...
"Top Forum Posters" => "Usuári@s mais ativos no fórum",
...
"perms" => "permissões",
"users registered" => "usuári@s registrad@s",
"Avatar" => "Fotografia",
...
"User assigned modules" => "Módulos atribuídos pel@ usuári@",
"Position" => "Posição",
"Move" => "Mover",
"Delete" => "Apagar",
...
"Allow messages from other users" => "Permitir mensagens de outr@s usuári@s",
...
"Link to user information" => "Link para informações d@ usuári@",
"User avatar" => "Fotografia d@ usuári@",
...
"If you decide to store files in a directory you must ensure that the user cannot access directly to the directory." => "Se você decidir guardar arquivos em um diretório precisa ter certeza de que @s usuári@s não conseguem acessam diretamente o diretório escolhido.",
"You have two options to accomplish this:<br /><ul><li>Use a directory outside your document root, make sure your php script can read and write to that directory</li><li>Use a directory inside the document root and use .htaccess to prevent the user from listing the directory contents</li></ul>" => "Você tem duas opções:<br /><ul><li>Usar um diretório fora do documento root, para isso verifique se o seu script php pode ler e escrever nesse diretório</li><li>Usar um diretório dentro do documento root e usar .htaccess para prevenir que @s usuári@s possam listar o conteúdo do diretório</li></ul>",
...
"Contact user" => "Usuári@ para contato",
"Allow anonymous users to \"Contact Us\"" => "Permitir que usuári@s anônimos \"Contact Us\"",
...
"Only for users" => "Apenas para usuári@s",
"Users and admins" => "Usuári@s e administradores",
"Duration:" => "Duração:",
"day" => "dia",
"week" => "semana",
"month" => "mês",
...
"Generate User Map" => "Gerar mapa d@ usuári@",
"<b>Item</b>" => "<b>Ítem</b>",
"<b>Value</b>" => "<b>Valor</b>",
...
"Quota (Mb)" => "Cota (Mb)",
"Use database to store userfiles" => "Utilizar o banco de dados para armazenar arquivos d@s usuári@s",
"Use a directory to store userfiles" => "Utilizar um diretório para armazenar arquivos d@s usuári@s",
...
"User's Page" => "Página d@ Usuári@",
"UserPage prefix" => "Prefixo da página d@ usuári@ (UserPage)",
...
"Username regex matching" => "Identificador de usuári@ por expressão regular",
...
"Custom message to the user" => "Mensagem personalizada para @ usuári@",
"Rules" => "Regras",
"User/IP" => "Usuári@/IP",
"Sections" => "Seções",
...
"Active" => "Ativo",
"Users can vote for only one item from this chart per period" => "Usuári@s podem votar em um único item por período",
"Prevent users from voting for the same item more than once" => "Previne que usuári@s votem no mesmo item mais de uma vez",
"Users can suggest new items" => "Usuári@s podem sugerir itens",
"Auto validate user suggestions" => "Validades automaticamente sugestões de usuári@s",
...
"Use Cookies for unregistered users" => "Utilizar cookies para usuári@s não registrad@s",
"Users can vote again after" => "Usuári@s podem votar novamente",
...
"Section" => "Seção",
"Create new" => "Criar nova",
"Moderator user" => "Usuári@ moderador",
...
"User information display" => "Exibição de informações d@s usuári@s",
"avatar" => "fotografia",
"flag" => "marca",
...
"Only users with attach permission" => "Apenas usuári@s com permissão de anexar",
...
"Is repository visible to users" => "repositório visível para usuári@s",
...
"User preferences" => "Preferências d@ usuári@",
...
"User Modules" => "Módulos de Usuári@",
...
"Add user:" => "Adicionar usuári@:",
"Group users" => "Grupo de usuári@s",
...
"The user email will be refreshed at each newsletter sending" => "@ usuári@ de e-mail vai ser atualizado a cada newsletter que for enviada",
...
"Users can subscribe/unsubscribe to this list" => "Usuári@s podem inscrever/desinscrever nesta lista",
"Users can subscribe any email address" => "Usuári@s podem inscrever quaisquer endereços de e-mail",
...
"Event" => "Evento",
"A user registers" => "Um(a) usuári@ se registrou",
"A user submits an article" => "Um(a) usuári@ submeteu um artigo",
...
"The tracker needs a user field with the option 1" => "O acompanhamento precisa de um campo para @ usuári@ com a opção 1",
...
"comma separated usernames" => "usuári@s separad@s por vírgula",
"comma separated username:role" => "usuári@:perfil, separad@s por vírgula",
...
"Users in this channel" => "Usuári@s neste canal",
...
"Users have visited" => "Usuári@s visitaram",
"sites from the directory" => "sites do diretório",
"Users have searched" => "Usuári@s buscaram",
...
"Allow other user to post in this blog" => "Permitir a outr@s usuári@s escrever neste blog",
...
"Show user avatar" => "Mostrar fotografia d@s usuári@s",
...
"Gallery is visible to non-admin users?" => "Galeria visível para usuári@s não administradores?",
...
"Other users can upload files to this gallery" => "Outr@s usuári@s podem carregar arquivos nesta galeria",
...
"Map users to roles" => "Associar usuári@s a perfis",
"Map" => "Associar",
"Roles" => "Perfis",
"map" => "associar",
...
"Set next user" => "Definir próxim@ usuári@",
...
"activate" => "ativar",
"User Activities" => "Atividades de Usuári@",
"Galaxia User Activities" => "Atividades de Usuári@ do Galaxia",
"process" => "processo",
"user processes" => "processos de usuári@s",
"user activities" => "atividades de usuári@s",
"user instances" => "instâncias de usuári@s",
"Galaxia User Instances" => "Instâncias de Usuári@s do Galaxia",
"Inst Status" => "Estado da inst",
"Not defined" => "Não definido",
"No instances defined yet" => "Nenhuma instância definida ainda",
"Galaxia User Processes" => "Processos de Usuári@ do Galaxia",
...
"Create New FAQ:" => "Criar um novo FAQ:",
"Users can suggest questions" => "Usuári@s podem sugerir perguntas",
...
"Operators must be tiki users" => "Operadores devem ser usuári@s Tiki",
"set as operator" => "definir como operador",
"Chat started" => "Chat iniciado",
"User:" => "Usuári@:",
"Operator:" => "Operador:",
"Live support:User window" => "Suporte on-line:Janela d@ usuári@",
...
"User Calendar" => "Calendário d@ usuári@",
"User Calendar Doc tpl" => "documento do calendário d@ usuári@ tpl",
...
"User Calendar Doc" => "Documento do calendário d@ usuári@",
"User Calendar Preferences Doc tpl" => "Preferências do documento do calendário d@ usuári@ tpl",
...
"To install, remove or upgrade packages you need to give the apache user the right\nto write files in your web tree (you can use \"./fixperms.sh open\" to set it up). After installation you need to remove that\npermission (using \"./fixperms.sh fix\")." => "Para instalar, remover ou atualizar pacotes é necessário que @ usuári@ do Apache tenha permissão de escrita na árvore de arquivos da web (você pode usar \"./fixperms.sh open\" para fazer isso). Depois da instalação você deve remover essa permissão (usando \"./fixperms.sh fix\").",
...
"Quiz" => "Teste",
"Time" => "Tempo",
"User answers" => "Respostas d@ usuári@",
...
"User Stats" => "Estatísticas de usuári@s",
"User bookmarks" => "Bookmarks de usuári@s",
"Average bookmarks per user" => "Média de bookmarks por usuári@",
...
"If none of the above was selected the user theme is used" => "Se nenhum dos itens acima for selecionado, o tema d@ usuári@ é utilizado",
"Finally if the user didn't select a theme the default theme is used" => "Finalmente, se @ usuári@ não selecionou um tema o tema padrão é utilizado",
...
"User Assigned Modules" => "Módulos Atribuídos pel@ Usuári@",
"User Assigned Modules tpl" => "módulos associados pel@ usuári@ tpl",
"move to right column" => "mover para a coluna direita",
"move to left column" => "mover para a coluna esquerda",
"Column" => "Coluna",
"User Bookmarks tpl" => "Favoritos d@ usuári@ tpl",
...
"User information" => "Informação d@ Usuári@",
"private" => "privada",
"public" => "pública",
"Account Information" => "Conta",
"Email address" => "E-mail",
"User Tasks tpl" => "Tarefas d@ usuári@ tpl",
...
"You send this task to a other user" => "Você enviou essa tarefa para outr@ usuári@",
"Shared task" => "Tarefas compartilhadas",
"This task is public to a special group" => "Essa tarefa é pública para um grupo especial",
"accepted by task user and creator" => "aceito pel@ usuári@ e criador(a) da tarefa",
"accepted user and creator" => "aceit@ usuári@ e criador(a)",
"Task is accepted by user and creator" => "A tarefa foi aceito pel@ usuári@ e pel@ criador(a)",
"not accepted by one user" => "não aceito por um usuári@",
"not accepted user" => "usuári@ não aceit@",
"Task is rejected by one user" => "Tarefa rejeitada por um usuári@",
...
"waiting for other user" => "esperando por outr@ usuári@",
"Task is not accepted/rejected by other user" => "Tarefa não foi aceita/rejeitada por outr@ usuári@",
...
"User Watches tpl" => "Notificações d@ usuári@ tpl",
"Add Watch" => "Adicionar notificação",
"A user submits a blog post" => "Um(a) usuári@ enviou uma mensagem no blog",
"A user posts a forum thread" => "Um(a) usuári@ criou um novo assunto no fórum",
"A user posts a forum topic" => "Um(a) usuári@ enviou um novo tópico no fórum",
"A user edited a wiki page" => "Um(a) usuári@ editou uma página wiki",
"edit user files" => "editar arquivos d@ usuári@",
...
"User_versions_for" => "Versões_de_usuári@_para",
...
"User accounts" => "Contas de usuári@s",
"account" => "conta",
"View All" => "Ver Todas",
"Msg" => "Mnsg",
...
"User registration, login and authentication" => "Registrar usuári@, logar e autenticar",
...
"SQL injection by authenticated user" => "Injeção SQL para usuári@s autenticados",
"SQL injection by authenticated user with special privileges" => "Injeção SQL apenas para usuári@s autenticados e com privilégios especiais.",
"SQL injection without authentication" => "Injeção SQL sem autenticação",
"PHP command injection" => "Injeção de comando PHP",
"PHP command injection by authenticated user" => "Injeção de comando PHP para usuári@ autenticado",
"PHP command injection by authenticated user with special privileges" => "Injeção de comando PHP apenas para usuári@s autenticados e com privilégios especiais.",
...
"group <b>%s</b> set as the default group of user <b>%s</b>." => "grupo <b>%s</b> definido como grupo padrão d@ usuári@ <b>%s</b>.",
"User already exists" => "@ usuári@ já existe",
...
"User doesnt exist" => "@ usuári@ não existe",
...
"Invalid username" => "Usuári@ inválido",
...
"No user indicated" => "Nenhum usuári@ indicado",
...
"About" => "Sobre",
"You need to run setup.sh :<br />./setup.sh \$APACHEUSER all<br />Common Apache users are www-data, apache or nobody" => "Você precisa rodar o script setup.sh :<br />./setup.sh \$APACHEUSER all<br />Usuári@s comuns no apache são: www-data, apache ou nobody",
...
"You do not have permission to view other users data" => "Você não possui permissão para ver dados de outr@s usuári@s",
...
"Task accepted by creator" => "Tarefa aceita pel@ criador",
"Task accepted by task user" => "Tarefa aceita pel@ usuári@",
"Task NOT accepted by creator" => "Tarefa NÃO aceita pel@ criador",
"Task NOT accepted by task user" => "Tarefa NÃO aceita pel@ usuári@",
...
"NEW Task" => "Nova tarefa",
"Sorry you are not allowed to send tasks to other users, or the user is not allowed to receive tasks!" => "Desculpe mas você não tem permissão para enviar tarefas para outr@s usuári@s ou @s usuári@s não podem receber tarefas!",
...
"Non-existent user" => "Usuári@ inexistente",
