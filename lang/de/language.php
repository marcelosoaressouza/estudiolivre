...
"Please also see:" => "Siehe auch unter:",
...
"Please create a directory to hold your map files:" => "Bitte ein Verzeichnis f&uuml;r die Kartendaten anlegen:",
...
"Text area (that apply throughout many features)" => "Eingabefelder (an vielen Stellen zu finden)",
"Text area" => "Eingabefeld",
"Text Area" => "Eingabefeld",
"Right &amp; left boxes" => "Module in den Seitenbalken",
"Administer modules" => "Module verwalten",
"Use categories to regroup various Tiki objects." => "Benutze Kategorien um verschiedene Tiki-Objekte zu gruppieren.",
...
"I18n setup" => "I18n Einstellungen",
"Best Language" => "Sprache empfehlen",
"Errors Log file" => "Fehler-Logdatei",
"Refresh wiki search index now" => "Wiki-Suchindex jetzt aktualisieren",
"Refresh tracker search index now" =>  "Tracker-Suchindex jetzt aktualisieren",
"Post level trackback pings" => "Trackback Pings auf Beitragsebene erlauben",
"Print article" => "Artikel drucken",
"Users map" => "Benutzer-Karte",
"Categories path" => "Kategorie-Pfad",
"Regex search and replace" => "Regex Suchen und Ersetzen",
"History only for data, description, comment change" => "Historie nur f&uuml;r Daten-, Beschreibungs- und Kommentar&auml;nderungen",
"You need to set <a href=\"tiki-admin.php?page=general\">Sender Email</a>" => "<a href=\"tiki-admin.php?page=general\">eMail-Absender</a> mu&szlig; gesetzt sein",
"Help System" => "Hilfe-System",
"Please see the <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://doc.tikiwiki.org/tiki-index.php?page=Features\">evaluation of each feature</a> on Tiki's developer site." => "Siehe eine <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://doc.tikiwiki.org/tiki-index.php?page=Features\">Einsch&auml;tzung der Funktionen</a> auf der Tiki Entwicklerseite.",
"Nothing has changed" => "Keine &Auml;nderungen",
"You need to set a <a href=\"tiki-admin.php?page=gmap\">Google Maps API key</a>" => "Es mu&szlig; ein <a href=\"tiki-admin.php?page=gmap\">Google Maps API Schl&uuml;ssel</a> eingetragen werden",
"Exact&nbsp;match" => "Exakte&nbsp;Suche",
"any type" => "jeder Typ",
"Your time" => "Zeit Ihrer Zeitzone",
"Immediate feedback" => "Sofortiges Feedback",
"Show correct answers" => "Korrekte Antworten zeigen",
"Shuffle questions" => "zuf&auml;llige Reihenfolge der Fragen",
"Shuffle answers" => "zuf&auml;llige Reihenfolge der Antworten",
"Passing Percentage" => "Prozentangabe des Fortschritts",
"Create new Sheet" => "Neues Sheet erstellen",
"Available Sheets" => "Vorhandene Sheets",
"Show creation date when viewing tracker item?" => "Erstellungsdatum beim Betrachten anzeigen?",
"Show lastModif date when viewing tracker item?" => "Letztes &Auml;nderungsdatum beim Betrachten anzeigen?",
"Do not show empty fields in item view?" => "Leere Felder in der Ansicht verstecken?",
"Show these fields (ID comma separated) in a popup on item link when listing tracker items?" =>
"Diese Felder (kommagetrennte IDs) im Link-Popup in der Listenansicht anzeigen",
...
"Release check" => "Versions&uuml;berpr&uuml;fung",
"Check frequency" => "Intervall der &Uuml;berpr&uuml;fungen",
"Each day" => "T&auml;glich",
"Each week" => "W&ouml;chentlich",
"Each month" => "Monatlich",
"Release checks are made when you browse admin main page only" => "Versions&uuml;berpr&uuml;fungen werden nur beim Betrachten der Administrationsseiten gemacht",
"A new version of TikiWiki, <b>{\$tiki_release}</b>, is available.  You are currently running <b>{\$tiki_version}</b>. Please visit <a href=\"http://tikiwiki.org/Download\">http://tikiwiki.org/Download</a>." => "Eine neue Version von Tikiwiki, <b>{\$tiki_release}</b>, ist verf&uuml;gbar.  Sie ben&uuml;tzen im Moment die Version <b>{\$tiki_version}</b>. Besuchen sie bitte die Seite <a href=\"http://tikiwiki.org/Download\">http://tikiwiki.org/Download</a>.",
"###end###"=>"###end###");
?>
