...
"updated by the phpwiki import process" => "インポート・プロセスを利用してphpwikiをアップデートする",
"created from phpwiki import" => "phpwikiインポートで制作された",
"Your Tiki account information for" => "Tiki Account Info :: ",
"A password reminder email has been sent " => "パスワードが記入されたメールが送信されました",
"A new password has been sent " => "新しいパスワードが送信されました",
"Upload was not successful (maybe a duplicate file)" => "アップロードに失敗しました (重複のファイルの可能性あり)",
"Invalid password.  You current password is required to change your email address." => "パスワードが間違っています。パスワードを変更するには、メールアドレスが必要です。",
" new topic:" => " 新しいトピック:",
...
"ExtWikis" => "ExtWikis",
"assgn" => "assgn",
"save a custom copy" => "カスタムコピーを保存する",
...
"this post was reported" => "この投稿は報告されました",
"report this post" => "この投稿を報告する",
"checked" => "チェック",
"unchecked" => "チェック解除",
"someone from" => "。Tikiサイト「",
"Diff:" => "Diff:",
"The new page content is:" => "新しいページのコンテンツは:",
"More info about" => "詳細を見る",
"idle" => "idle",
"Wiki page" => "Wikiページ",
"pageviews" => "ページ観覧数",
...
"note: those parameters are exclusive" => "注意: そのパラメーターは限定されています",
...
"no description" => "説明文なし",
"Information:" => "インフォメーション:",
"Admin->Modules" => "管理->モデュール",
"Remind passwords by email" => "パスワードを忘れた場合、メールで通知",
"LDAP Host" => "LDAP Host",
"LDAP Port" => "LDAP Port",
...
"italics" => "イタリック",
"both" => "both",
"use ...page... to separate pages" => "ページを分ける際には ...page... を使用する",
"make_headings" => "make_headings",
"underlines text" => "下線",
"Simple box" => "Simple box",
"Center" => "中央揃え",
"Will display the text centered" => "中央揃えに表示する",
"Activs" => "Activs",
"Ins" => "Ins",
"time" => "time",
"Wiki quick help" => "Wikiクイック・ヘルプ",
"Actual_version" => "Actual_version",
"Diff to version" => "Diff to version",
"perm" => "perm",
"You do not have permission to write the template" => "このテンプレートを編集する権限はありません",
"You have to provide a name to the image" => "画像に名称が必要です",
...
"password for this account is" => "新しいパスワード：",
...
"Will display using the indicated HTML color" => "HTMLカラーを適用して表示されます",
"Quicklinks" => "クイックリンクス",
"Comparing versions" => "バージョンの比較",
"You have to create a gallery first!" => "先にギャラリーを作って下さい!",
...
"The text in RED is" => "本文の赤いものは",
"character(s) too long - please edit it." => "字数制限を超えています - 再編集してください。",
"Catalan_Countries" => "カタロニア地方の国",
"Kazakstan" => "カザフスタン",
"Kiribati" => "キリバス",
"Kuwait" => "クウェート",
"Latvia" => "ラトビア",
...
"Spain" => "スペイン",
"Sri_Lanka" => "スリランカ",
"St_Vincent_Grenadines" => "セントビンセント・グレナディーン",
"Surinam" => "スリナム",
"Sweden" => "スウェーデン",
"Switzerland" => "スイス",
"Taiwan" => "台湾",
...
"Polish" => "ポーランド語",
"Português" => "ポルトガル語",
"Brazilian Portuguese" => "ブラジル-ポルトガル語",
"Russian" => "ロシア語",
"Pijin Solomon" => "ピジン-ソロモン語",
"Slovak" => "スロバキア語",
"Serbian" => "セルビア語",
"Serbian Latin" => "ラテン-セルビア語",
"Swedish" => "スウェーデン語",
"Tuvaluan" => "ツバル語",
"Traditional Chinese" => "中国語（繁体字）",
"Ukrainian" => "ウクライナ語",
"This instance of activity is already complete" => "この動作はすでに完了しました",
...
" is interactive but has no role assigned" => " は接続中ですが、作業は指定されていません",
" is non-interactive and non-autorouted but has no role assigned" => " は非接続中で、作業も指定されていません",
" is standalone but has transitions" => " はスタンドアロンですが、接続できます",
...
"Process %d has been activated" => "プロセス %d が起動されました",
"Process %d has been deactivated" => "プロセス %d が終了されました",
"Process %s %s imported" => "プロセス %s %s インポートされました",
"Process %s removed" => "プロセス %s 削除されました",
"Process %s has been updated" => "プロセス %s は更新されました",
"Process %s has been created" => "プロセス %s は制作されました",
"Template %s not registered" => "テンプレート %s は登録されていません",
"Administration:" => "管理:",
...
"survey" => "サーベイ",
"wiki page" => "wikiページ",
"Cannot write to this file: " => "このファイルを編集できません: ",
"Use this thread to discuss the %s page." => "このスレッドで %s ページの話し合いをして下さい。.",
"Line:" => "ライン:",
"Lines:" => "ライン:",
"There was a problem with your upload." => "アップロードに問題が発生しました。",
"The file you are trying to upload is too big." => "アップロードしようとしているファイルのサイズが大き過ぎます。",
"The file you are trying to upload was only partially uploaded." => "アップロードしようとしたファイルの一部分しかアップロードできませんでした。",
"You must select a file for upload." => "アップロードするファイルを選んでください。",
// "No valid ogr2ogr executable" => "No valid ogr2ogr executable",
"Could not create \$tdo.mif in data directory" => "データディレクトリに \$tdo.mif を制作できませんでした",
"Could not create \$tdo.mid in data directory" => "データディレクトリに \$tdo.mid を制作できませんでした",
// "User Map Generated in:" => "User Map Generated in:",
// "Image Map Generated in:" => "Image Map Generated in:",
"File %s not found" => "ファイル %s が見つかりません",
"File %s is not a valid archive" => "ファイル %s は有効なアーカイブではありません",
"%s is an empty archive file" => "%s は空きのアーカイブ・ファイルです",
"Invalid remote file on url %s" => "url %s に無効なリモート・ファイル",
"Impossible to open %s : %s" => "%s : %s を開くことが不可能",
"section edit" => "部分編集",
"This poll is closed." => "このアンケートは終了しました。",
// "Forums last posts" => "Forums last posts",
"tikiwiki logo" => "tikiwiki ロゴ",
"See other user's profile" => "ほかのユーザーのプロフィールを見る",
"Have your profile seen" => "プロフィールを公開する",
"Make friends" => "友達をつくる",
"Receive message" => "メッセージ受信",
"Read an article" => "記事を読む",
"Publish an article" => "記事を編集する",
"Have your article read" => "記事を公表する",
"Create new file gallery" => "新しいファイル・ギャラリーを作成する",
"Upload new file to gallery" => "ギャラリーに新しいファイルをアップロードする",
"Download other user's file" => "ほかのユーザーのファイルをダウンロードする",
"Have your file downloaded" => "ファイルのダウンロード承認する",
"Create a new image gallery" => "新しい画像ギャラリーを作成する",
"Upload new image to gallery" => "画像ギャラリーに画像をアップロードする",
"See other user's gallery" => "ほかのユーザーのギャラリーを見る",
"See other user's image" => "ほかのユーザーの画像を見る",
"Have your gallery seen by other user" => "ほかのユーザーにギャラリーを公開する",
"Have your image seen" => "画像を公開する",
"Create new blog" => "新しいブログを作成する",
"Post in a blog" => "ブログに新しい記事を作成",
"Read other user's blog" => "ほかのユーザーのブログを読む",
"Have your blog read" => "ほかのユーザーにブログを公開する",
"Create a new wiki page" => "新しい wiki ページを作成する",
"Edit an existing page" => "現在のページを編集する",
"Trackeritem" => "トラッカー・アイテム",
"Tracker item" => "トラッカー・アイテム",
"The text is" => "文章は",
"Text cut here" => "ここの文をカット",
"Task" => "タスク",
"Start date:" => "開始日:",
"End date:" => "終了日:",
"Friend" => "友達",
...
"User information - Click for more info" => "ユーザー情報 - 詳細はクリック",
"More info about \$other_user" => "さらに詳しく \$other_user",
...
"An error occured in a database query!" => "データベース・クエリー にエラーが発生しました!",
// "img-g" => "img-g",
// "file-g" => "file-g",
// "arts" => "arts",
"Altering database table failed" => "データベース・テーブル変更に失敗しました",
"%d points" => "%d ポイント",
"Removed" => "削除",
"__WARNING__: No such module \$plugin! " => "__注意__: このモジュールは存在しません \$plugin! ",
"Create page:" => "ページを作成:",
"index" => "索引",
"show" => "表示",
"hide" => "隠す",
...
"Status:" => "ステータス:",
"(unchanged)" => "(変更なし)",
"Item Modification" => "アイテムの一部変更",
"Item creation" => "アイテム作成",
...
"Dropdown options: list of items separated with commas." => "ドロップダウン・オプション: 項目はコンマで区別する。",
...
"country selector" => "地域選択",
"Country Selector options: 1|2 where 1 show only country name and 2 show only country flag. By default show both country name and flag" => "地域選択オプション: 1|2 1 は国名表示のみ、 2 は国旗表示のみ。デフォルト設定は国名と国旗を表示",
...
"Old:" => "古い:",
"New:" => "新しい:",
"No extra information for that attached file. " => "添付ファイルの他の情報はありません",
"Include all post in a blog" => "すべての投稿をブログにまとめる",
"Lists files in a directory" => "すべてのファイルをディレクトリに表示する",
"could not be opened because it doesn't exist or permission was denied" => "存在しない、又は許可を得ていないため、開くことができませんでした",
...
"Missing url parameter for SNARF plugin." => "SNARF プラグインの url パラメーターが欠けています。",
"Displays browser client info" => "ブラウザー・クライアント情報を表示する",
...
"no such attachment on this page" => "そのような添付は存在しません",
"Displays an attachment or a list of them" => "添付、又は、添付のリストを表示する",
...
"Displays a SWF on the wiki page" => "wiki ページに SWF を表示する",
// "Formula" => "Formula",
// "No formula specified." => "No formula specified.",
"Impossible to render the graphic." => "画像を常時のるのは不可能です。",
"View graphic" => "画像を見る",
"Display wiki text if user is in one of listed groups" => "ユーザーがグループに載っている場合のみ wiki text を表示",
// "Runs a Java applet to access a local Jabber service" => "Runs a Java applet to access a local Jabber service",
"Displays a map" => "地図を表示",
"Displays an miniquiz" => "ミニ・クイズを表示",
"Displays object hit info by object and days" => "オブジェクトのヒット情報をオブジェクトと日数で表示",
...
"List wiki pages" => "wiki ページを一覧に表示する",
...
// "row2col1" => "row2col1",
// "row2col2" => "row2col2",
"Displays text in subscript." => "文章を下付きの文字として表示",
"Displays text between an html tag" => "文章を html タグの間に表示",
"Displays the thumbnail for an image" => "画像のかわりにサムネールを表示",
"Following mandatory fields are missing" => "次の必須項目が紛失しています",
"Following fields are incorrect" => "次の項目は間違っています",
// "Displays an input form for tracker submit" => "Displays an input form for tracker submit",
"You do not have permission to insert an item" => "アイテムを編集するを認められていません",
"Fields marked with a * are mandatory." => "* の印が付いてる項目は必須です。",
"All fields must be from the same tracker" => "すべての項目は同じトラッカーからのものでなければいけません",
...
"missing parameters" => "パラメーターが欠けています",
...
"Error in tracker ID" => "トラッカー ID にエラー",
"No field indicated" => "項目が選択されていません",
...
"End of debug output." => "デバッグ・アウトプットの終了",
...
"Please provide an Id" => "Id が必要です",
"no object here yet" => "まだ、オブジェクトはありません",
...
"new FAQs" => "新しい FAQ",
"new blogs" => "新しいブログ",
"new blog posts" => "新しいブログ投稿",
"new image galleries" => "新しい画像ギャラリー",
"new file galleries" => "新しいファイル・ギャラリー",
"new polls" => "新しいアンケート",
"new tracker items" => "新しいトラッカー・アイテム",
"New Tracker Items" => "新しいトラッカー・アイテム",
"The task title must have at least 3 characters" => "タスクの題名は３文字以上でないといけません",
...
"The registration mail can't be sent. Contact the administrator" => "登録通知が送れません。管理人に問い合わせてください。",
