...
"To display the objects you participate to:" => "Afficher les objets auquels vous avez participé :",
...
"One of the email addresses you typed is invalid" => "L'une des adresses courriel que vous avez tapé est invalide",
...
"Unable to send mail. User has not configured email" => "Impossible d'envoyer le courrier. L'utilisateur n'a pas configuré son adresse électronique",
...
"Invalid or unknown username" => "Nom d'utilisateur invalide ou inconnu",
...
"it is a \"custom module\" which includes menu ID " => "c'est un \"module fait sur mesure\" contenant le menu d'ID ",
...
"NOTE: Make sure to whitelist this domain to prevent<br />registration emails being canned by your spam filter!" => "Remarque: Soyez sûr de mettre ce domaine en liste blanche pour empêcher<br />que les emails d'enregistrement ne soient pas mis à part par le filtre de spam!",
...
"List of email addresses separated by commas" => "Liste des adresses électroniques séparées par une virgule",
...
"Users can opt-out internal messages" => "Les utilisateurs peuvent déselectionnés les messages internes",
...
"The passwords did not match" => "Les 2 mots de passe ne sont pas identiques",
"Tiki mail-in auto-reply" => "Réponse automatique du mail-in Tiki",
