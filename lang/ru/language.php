...
"Attention" => "Внимание",
"Apache has the right to write in your file tree, which enables the installation, removal or \nupgrade of packages. When you are done with those operations, think to fix those permissions back to a safe state (by using \n\"./fixperms.sh fix\" for example)." => "Apache имеет права на запись в ваше дерево файлов, которое нужно для установки, удаления или обновления пакетов. Когда вы закончите эти операции, установите безопасные привилегии (используя например, \n\"./fixperms.sh fix\").",
"all types" => "все типы",
"install" => "установить",
