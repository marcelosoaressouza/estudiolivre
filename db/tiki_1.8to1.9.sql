# $Header: /cvsroot/tikiwiki/tiki/db/tiki_1.8to1.9.sql,v 1.79.2.195 2007/09/12 12:59:05 marclaporte Exp $
...
ALTER TABLE `users_groups` CHANGE `groupName` `groupName` VARCHAR( 255 ) NOT NULL default '';
ALTER TABLE `users_groups` DROP PRIMARY KEY , ADD PRIMARY KEY ( `groupName` ( 30 ) );

ALTER TABLE `users_usergroups` CHANGE `groupName` `groupName` VARCHAR( 255 ) NOT NULL default '';
ALTER TABLE `users_usergroups` DROP PRIMARY KEY , ADD PRIMARY KEY ( `userId` , `groupName` ( 30 ) );


ALTER TABLE `users_grouppermissions` CHANGE `groupName` `groupName` VARCHAR( 255 ) NOT NULL default '';
ALTER TABLE `users_grouppermissions` DROP PRIMARY KEY , ADD PRIMARY KEY ( `groupName` ( 30 ), permName );

ALTER TABLE `users_objectpermissions` CHANGE `groupName` `groupName` VARCHAR( 255 ) NOT NULL default '';
...
ALTER TABLE `tiki_group_inclusion` CHANGE `groupName` `groupName` VARCHAR( 255 ) NOT NULL default '';
ALTER TABLE `tiki_group_inclusion` CHANGE `includeGroup` `includeGroup` VARCHAR( 255 ) NOT NULL default '';
...
ALTER TABLE `tiki_tracker_fields` ADD `isHidden` CHAR ( 1 ) DEFAULT 'n' NOT NULL ;
...
ALTER TABLE `tiki_tracker_fields` ADD `isMandatory` CHAR ( 1 ) DEFAULT 'n' NOT NULL ;
...
ALTER TABLE `tiki_article_types` CHANGE `show_size` `show_size` CHAR(1) default 'n';
...
ALTER TABLE `tiki_quicktags` ADD `tagcategory` VARCHAR( 255 ) AFTER `tagicon` ;
...
alter table `tiki_users_score` modify `expire` int(14) not null default '0';
...
ALTER TABLE tiki_link_cache DROP KEY url;
...
ALTER TABLE tiki_user_tasks MODIFY user varchar(200) NOT NULL DEFAULT '' AFTER last_version;
...
ALTER TABLE tiki_user_tasks ADD status char(1) default NULL AFTER created;
ALTER TABLE tiki_user_tasks ADD priority int(2) default NULL AFTER status;
ALTER TABLE tiki_user_tasks ADD completed int(14) default NULL AFTER priority;
ALTER TABLE tiki_user_tasks ADD percentage int(4) default NULL AFTER completed;
...
# 2005-06-14 rv540
alter table tiki_referer_stats change referer referer varchar(255) not null default '';
