<?php /* Smarty version 2.6.18, created on 2011-04-08 18:00:21
...
<div class="searchResultItem">
	<?php if ($this->_tpl_vars['feature_search_fulltext'] == 'y'): ?><?php if ($this->_tpl_vars['result']['relevance'] <= 0): ?><?php $this->assign('tiptext', 'Busca Simples'); ?><?php else: ?><?php $this->assign('tiptext', ((is_array($_tmp="Importancia: ")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['result']['relevance']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['result']['relevance']))); ?><?php endif; ?><?php endif; ?>
