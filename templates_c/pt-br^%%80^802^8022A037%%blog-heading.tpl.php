<?php /* Smarty version 2.6.18, created on 2011-06-05 20:36:32
         compiled from styles/geral/blog-heading.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'css', 'styles/geral/blog-heading.tpl', 1, false),array('modifier', 'date_format', 'styles/geral/blog-heading.tpl', 3, false),array('modifier', 'replace', 'styles/geral/blog-heading.tpl', 22, false),array('modifier', 'string_format', 'styles/geral/blog-heading.tpl', 26, false),)), $this); ?>
<?php echo smarty_function_css(array('extra' => 'list'), $this);?>

<div id="blogHead">
	<h1 onmouseover="tooltip('<b>Blog Criada por:</b> <?php echo $this->_tpl_vars['creator']; ?>
 <br><b> em :</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m/%y") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m/%y")); ?>
')" onmouseout="nd();">
...
.png');storeState('blogDescCont');">
			        Descrição<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 mensagens | <?php echo $this->_tpl_vars['hits']; ?>
 visitas | Atividade=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			Última modificação em: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>

			<?php if ($this->_tpl_vars['rss_blog'] == 'y'): ?>
				&nbsp;&nbsp;&nbsp;
				<a class="bloglink" href="tiki-blog_rss.php?blogId=<?php echo $this->_tpl_vars['blogId']; ?>
">
					<img src='styles/estudiolivre/iRss.png' alt='Fonte RSS' title='Fonte RSS' />
				</a>
			<?php endif; ?>
