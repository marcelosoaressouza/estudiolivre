...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Moderator-Aktionen</td>
					</tr>
					<tr>
						<td class="odd">
							<input type="submit" name="delsel" value="markierte l&ouml;schen" />
						</td>
					</tr>
					<tr>
						<td class="odd">
...
"><?php echo $this->_tpl_vars['topics'][$this->_sections['ix']['index']]['title']; ?>
							...
							<input type="submit" name="movesel" value="verschieben" />
						</td>
...
">
									gemeldet:<?php echo $this->_tpl_vars['reported']; ?>
...
">
								aufgelaufen:<?php echo $this->_tpl_vars['queued']; ?>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>antworten<?php else: ?>Antworten<?php endif; ?> unterhalb Ihres aktuellen Schwellenwerts
			<?php endif; ?>
	  		<div class="paginacao">
...
/img/iArrowGreyLeft.png">
				...
				Seite <?php echo $this->_tpl_vars['comments_actual_page']; ?>
