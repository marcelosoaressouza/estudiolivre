<?php /* Smarty version 2.6.18, created on 2011-04-12 18:46:38
...
" class="link">
	...
	<div id="edit">
		<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
			<a class="linkbut" title="Editar Foro" href="tiki-admin_forums.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
">Editar Foro</a><br />
		<?php endif; ?>
	</div>
...
/img/iWikiRemove.png" alt="Eliminar"/>
				...
				<?php if ($this->_tpl_vars['user'] && $this->_tpl_vars['feature_notepad'] == 'y' && $this->_tpl_vars['tiki_p_notepad'] == 'y'): ?>
					<a title="Salvar a bloc de notas" href="tiki-view_forum_thread.php?topics_offset=<?php echo $_REQUEST['topics_offset']; ?>
<?php echo $this->_tpl_vars['topics_sort_mode_param']; ?>
<?php echo $this->_tpl_vars['topics_threshold_param']; ?>
<?php echo $this->_tpl_vars['topics_find_param']; ?>
...
/img/iSave.png" alt="Guardar"/>
	...
	<div class="postbottom">
		posteado por:<i><?php echo ((is_array($_tmp=$this->_tpl_vars['thread_info']['userName'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
</i>
		en: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['thread_info']['commentDate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
...
">
					<img src="img/icons/attachment.gif" border="0" width="10" height= "13" alt='adjunto' />
...
">
		...
		<?php endif; ?>
		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
		lecturas: <i><?php echo $this->_tpl_vars['thread_info']['hits']; ?>
</i>
		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
...
unset($_smarty_tpl_vars);
 ...
 Comentarios por debajo de su umbral actual
		</small>
	<?php endif; ?>
</div>