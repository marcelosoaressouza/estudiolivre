...
<div id="blogHead">
	<h1 onmouseover="tooltip('<b>Blog Creado por:</b> <?php echo $this->_tpl_vars['creator']; ?>
 <br><b> en :</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m/%y") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m/%y")); ?>
')" onmouseout="nd();">
...
.png');storeState('blogDescCont');">
			        Descripción<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 posts | <?php echo $this->_tpl_vars['hits']; ?>
 visitas | Actividad=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			Última modificación: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>
...
&amp;watch_action=add">
						monitorizar este blog
					</a>
				<?php else: ?>
					<a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['blogId']; ?>
&amp;watch_event=blog_post&amp;watch_object=<?php echo $this->_tpl_vars['blogId']; ?>
&amp;watch_action=remove">
						dejar de monitorizar este blog
					</a>
				<?php endif; ?>
			<?php endif; ?>
		</h4>
