<?php /* Smarty version 2.6.18, created on 2011-04-14 10:12:30
...
" class="wiki"><?php echo $this->_tpl_vars['likepages'][$this->_sections['back']['index']]; ?>
	...
	<?php else: ?>
		Er zijn geen gelijkwaardige wiki pagina's aan '<?php echo $this->_tpl_vars['page']; ?>
'
			<br/><br/>
	<?php endif; ?>
...
" class="linkmenu">Maak deze pagina aan</a>
	(pagina zal verweesd worden)<br /><br/>
<?php endif; ?>
<a href="javascript:history.back()" class="linkmenu">Ga terug</a><br /><br />
<a href="<?php echo $this->_tpl_vars['tikiIndex']; ?>
" class="linkmenu">Terug naar startpagina</a>