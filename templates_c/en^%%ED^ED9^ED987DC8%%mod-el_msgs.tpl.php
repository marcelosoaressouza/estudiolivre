...
#messages" class="mod-el_msg-msg" onmouseover="tooltip('Sent at: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['mod_msg']['date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>');" onmouseout="nd();">
