<?php /* Smarty version 2.6.18, created on 2011-05-02 18:37:20
         compiled from styles/obscur/tiki-view_blog_post_item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'tiki_short_datetime', 'styles/obscur/tiki-view_blog_post_item.tpl', 32, false),array('modifier', 'cat', 'styles/obscur/tiki-view_blog_post_item.tpl', 65, false),array('modifier', 'date_format', 'styles/obscur/tiki-view_blog_post_item.tpl', 77, false),array('function', 'html_image', 'styles/obscur/tiki-view_blog_post_item.tpl', 55, false),array('block', 'tooltip', 'styles/obscur/tiki-view_blog_post_item.tpl', 65, false),)), $this); ?>
<div class="blogpost">
	<div class="posthead">
...
">
					<img src='img/icons2/nav_first.gif' border='0' alt='Primeira página' title='Primeira página' />
				</a>
...
">
					<img src='img/icons2/nav_dot_right.gif' border='0' alt='Página anterior' title='Página anterior' />
				</a>
		
				página: <?php echo $this->_tpl_vars['pagenum']; ?>
...
">
					<img src='img/icons2/nav_dot_left.gif' border='0' alt='Próxima página' title='Próxima página' />
				</a>
...
">
					<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_last.gif','border' => '0','alt' => 'Última página','title' => 'Última página'), $this);?>
...
"><?php echo $this->_tpl_vars['tag']; ?>
	...
	<div class="postbottom">
		enviada por:<i> <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['post']['user']; ?>
"><?php echo $this->_tpl_vars['post']['user']; ?>
</a></i>
		 
		<?php if ($this->_tpl_vars['use_title'] == 'y'): ?>
			 em: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['post']['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
		<?php endif; ?>
...
&amp;postId=<?php echo $this->_tpl_vars['post']['postId']; ?>
">
				ler mais (<?php echo $this->_tpl_vars['post']['pages']; ?>
 páginas)
				</a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
			<?php endif; ?>
...
) <?php if ($this->_tpl_vars['post']['comments'] == 1): ?>comentário<?php else: ?>comentários<?php endif; ?>
					</a>
				<?php endif; ?>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a class="link" href="tiki-view_blog_post.php?find=<?php echo $this->_tpl_vars['find']; ?>
