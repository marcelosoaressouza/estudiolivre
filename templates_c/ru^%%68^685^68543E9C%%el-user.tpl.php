      ...
      <div id="uContact" class="uContactInfoCont left">
        ...
        <?php if ($this->_tpl_vars['permission']): ?>
        	<?php $this->_tag_stack[] = array('tooltip', array('text' => "Clique para modificar o seu <b>site</b>")); $_block_repeat=true;smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		        <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'id' => 'site','class' => 'uContactItem','value' => $this->_tpl_vars['site'],'default' => "Сайт",'display' => 'block','truncate' => '30'), $this);?>
 ...
 ?>
	   			...
	   			<?php if ($this->_tpl_vars['permission']): ?>
					<div id="ajax-elIce" style="display:none;">
						...
						<input type="button" onClick="xajax_set_mount_point(document.getElementById('ajax-livePoint').value,document.getElementById('ajax-livePass').value)" value="Отправить"/><input type="button" onClick="flip('ajax-elIce')" value="Отмена"/>
						<br/>
