<?php /* Smarty version 2.6.18, created on 2011-04-12 08:45:56
...
">page id: <?php echo $this->_tpl_vars['page_id']; ?>
	...
	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(mellomlagret)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Neste side" 
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Neste side" title="Neste side" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Siste side" title="Siste side" /></a>
		</div>
	<?php endif; ?>
	</div> 
...
.
	...
	<p class="editdate">
	  ...
	  Siste endring: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y às %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%Y às %H:%M")); ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">For å redigere copyrightnotiser <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">klikk her</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">Innholdet på denne siden er lisensiert under vilkårene definert i <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
