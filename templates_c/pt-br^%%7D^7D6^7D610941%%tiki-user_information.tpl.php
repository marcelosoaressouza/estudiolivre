<?php /* Smarty version 2.6.18, created on 2011-04-05 09:25:20
...
">Informações do Usuário</a></h1>
<table >
<tr>
  <td valign="top">
  <div class="cbox">
  <div class="cbox-title">Informações do Usuário</div>
  <div class="cbox-data">
  <div class="simplebox">
  <table>
  <tr><td class="form">Usuári@:</td><td><?php echo $this->_tpl_vars['userinfo']['login']; ?>
...
"><IMG SRC="img/icons/config.gif" title="Alterar preferências do usuário" border="0" /> </a>  <?php endif; ?></td></tr>
<?php if ($this->_tpl_vars['feature_score'] == 'y'): ?>
  <tr><td class="form">Pontuação:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['score'])) ? $this->_run_mod_handler('star', true, $_tmp) : smarty_modifier_star($_tmp)); ?>
<?php echo $this->_tpl_vars['userinfo']['score']; ?>
</td></tr>
<?php endif; ?>
  <tr><td class="form">Último login:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['lastLogin'])) ? $this->_run_mod_handler('tiki_short_datetime', true, $_tmp) : smarty_modifier_tiki_short_datetime($_tmp)); ?>
</td></tr>
<?php if ($this->_tpl_vars['email_isPublic'] != 'n'): ?>  
  <tr><td class="form">E-mail:</td><td><?php echo $this->_tpl_vars['userinfo']['email']; ?>
</td></tr>
<?php endif; ?>  
  <tr><td class="form">País:</td><td><img alt="flag" src="img/flags/<?php echo $this->_tpl_vars['country']; ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td></tr>
  <?php if ($this->_tpl_vars['change_theme'] != 'n'): ?><tr><td class="form">Tema:</td><td><?php echo $this->_tpl_vars['user_style']; ?>
</td></tr><?php endif; ?>
  <?php if ($this->_tpl_vars['change_language'] == 'y'): ?><tr><td  class="form">Idioma:</td><td><?php echo $this->_tpl_vars['user_language']; ?>
</td></tr><?php endif; ?>
  <tr><td class="form">Nome completo:</td><td><?php echo $this->_tpl_vars['realName']; ?>
</td></tr>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td><?php echo $this->_tpl_vars['customfields'][$this->_sections['ir']['index']]['value']; ?>
  ...
  <tr><td class="form">Fotografia:</td><td><?php echo $this->_tpl_vars['avatar']; ?>
</td></tr>
  <tr><td class="form">Site pessoal ou institucional:</td><td><?php if ($this->_tpl_vars['homePage'] != ""): ?><a href="<?php echo $this->_tpl_vars['homePage']; ?>
" class="link" title="Página inicial do usuário"><?php echo $this->_tpl_vars['homePage']; ?>
</a><?php endif; ?></td></tr>
<?php if ($this->_tpl_vars['feature_wiki'] == 'y' && $this->_tpl_vars['feature_wiki_userpage'] == 'y'): ?>
  <tr><td class="form">Página Wiki Pessoal:</td><td>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['login'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
" title="Criar página">?</a>
<?php else: ?>&nbsp;<?php endif; ?>
</td></tr>
<?php endif; ?>
  <tr><td class="form">Fuso horário exibido:</td><td><?php echo $this->_tpl_vars['display_timezone']; ?>
</td></tr>
<?php if ($this->_tpl_vars['feature_friends'] == 'y' && $this->_tpl_vars['user'] != $this->_tpl_vars['userwatch'] && $this->_tpl_vars['user']): ?>
  ...
  <tr><td class="form">&nbsp;</td><td class="form">
    <img src="img/icons/ico_friend.gif" width="7" height="10" /> Esse usuário é seu amigo
  </td></tr>  
  <?php else: ?>
  <tr><td class="form">&nbsp;</td><td class="form">
...
">Solicitação de amizade desse usuário</a>
  </td></tr>  
  <?php endif; ?>
<?php endif; ?>
  </table>
...
<tr>
  <td valign="top">
  <div class="cbox">
  <div class="cbox-title">Envie-me uma mensagem</div>
  <div class="cbox-data">
  <div class="simplebox">
...
" />
  ...
  <tr>
    <td class="form">Prioridade:</td><td class="form">
    <select name="priority">
      <option value="1" <?php if ($this->_tpl_vars['priority'] == 1): ?>selected="selected"<?php endif; ?>>1 -Mínima-</option>
      <option value="2" <?php if ($this->_tpl_vars['priority'] == 2): ?>selected="selected"<?php endif; ?>>2 -Baixa-</option>
      <option value="3" <?php if ($this->_tpl_vars['priority'] == 3): ?>selected="selected"<?php endif; ?>>3 -Normal-</option>
      <option value="4" <?php if ($this->_tpl_vars['priority'] == 4): ?>selected="selected"<?php endif; ?>>4 -Alta-</option>
      <option value="5" <?php if ($this->_tpl_vars['priority'] == 5): ?>selected="selected"<?php endif; ?>>5 -Máxima-</option>
    </select>
    <input type="submit" name="send" value="enviar" />
    </td>
  </tr>
  <tr>
    <td class="form">Assunto:</td><td class="form"><input type="text" name="subject" value="" maxlength="255" style="width:100%;"/></td>
  </tr>
  <tr>
