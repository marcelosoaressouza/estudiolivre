<?php /* Smarty version 2.6.18, created on 2011-04-20 08:39:05
...
<h1><a href="tiki-galleries.php" class="pagetitle">Галереи</a>

      <?php if ($this->_tpl_vars['feature_help'] == 'y'): ?>
<a href="<?php echo $this->_tpl_vars['helpurl']; ?>
Image+Gallery" target="tikihelp" class="tikihelp" title="Фотогалерея">
<img src="img/icons/help.gif" border="0" height="16" width="16" alt='помощь' /></a><?php endif; ?>
...
<a href="tiki-admin.php?page=gal"><img src='img/icons/config.gif' border='0'  alt="настройка списка" title="настройка списка" /></a>
<?php endif; ?></h1>

<?php if ($this->_tpl_vars['tiki_p_create_galleries'] == 'y'): ?>
<?php if ($this->_tpl_vars['edit_mode'] != 'y' || $this->_tpl_vars['galleryId'] != 0): ?><div class="navbar"><a class="linkbut" href="tiki-galleries.php?edit_mode=1&amp;galleryId=0">создать новую галерею</a><?php if ($this->_tpl_vars['feature_gal_imgcache'] == 'y'): ?> <a class="linkbut" href="tiki-galleries.php?rebuild_imgcache=1&amp;galleryId=0">rebuild cache</a><?php endif; ?></div><?php endif; ?>
...
">Для этой галереи заданы индивидуальные права доступа</a>
<?php endif; ?>
...
" />
<table class="normal">
<tr><td class="formcolor">Имя:</td><td class="formcolor"><input type="text" name="name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"/></td></tr>
<tr><td class="formcolor">Описание:<br /><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<tr><td class="formcolor">Видят ли галерею не-администраторы?</td><td class="formcolor"><input type="checkbox" name="visible" <?php if ($this->_tpl_vars['visible'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
...
<?php endif; ?>
<tr><td class="formcolor">Строк на странице не более:</td><td class="formcolor"><input type="text" name="maxRows" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['maxRows'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></td></tr>
<tr><td class="formcolor">Картинок в строке не более:</td><td class="formcolor"><input type="text" name="rowImages" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['rowImages'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></td></tr>
<tr><td class="formcolor">Размер иконок X:</td><td class="formcolor"><input type="text" name="thumbSizeX" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['thumbSizeX'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></td></tr>
<tr><td class="formcolor">Размер иконок Y:</td><td class="formcolor"><input type="text" name="thumbSizeY" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['thumbSizeY'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></td></tr>
...
<input type="radio" name="sortdirection" value="desc" <?php if ($this->_tpl_vars['sortdirection'] == 'desc'): ?>checked="checked"<?php endif; ?> />убывание
<input type="radio" name="sortdirection" value="asc" <?php if ($this->_tpl_vars['sortdirection'] == 'asc'): ?>checked="checked"<?php endif; ?> />возрастание
</td></tr>
<tr><td class="formcolor">Fields to show during browsing the gallery:</td>
<td class="formcolor">
	<input type="checkbox" name="showname" value="y" <?php if ($this->_tpl_vars['showname'] == 'y'): ?>checked="checked"<?php endif; ?> />Имя<br />
	<input type="checkbox" name="showimageid" value="y" <?php if ($this->_tpl_vars['showimageid'] == 'y'): ?>checked="checked"<?php endif; ?> />Image ID<br />
	<input type="checkbox" name="showdescription" value="y" <?php if ($this->_tpl_vars['showdescription'] == 'y'): ?>checked="checked"<?php endif; ?> />Описание<br />
	<input type="checkbox" name="showcreated" value="y" <?php if ($this->_tpl_vars['showcreated'] == 'y'): ?>checked="checked"<?php endif; ?> />Дата создания<br />
	<input type="checkbox" name="showuser" value="y" <?php if ($this->_tpl_vars['showuser'] == 'y'): ?>checked="checked"<?php endif; ?> />Пользователь<br />
	<input type="checkbox" name="showhits" value="y" <?php if ($this->_tpl_vars['showhits'] == 'y'): ?>checked="checked"<?php endif; ?> />Запросы<br />
	<input type="checkbox" name="showxysize" value="y" <?php if ($this->_tpl_vars['showxysize'] == 'y'): ?>checked="checked"<?php endif; ?> />XY-Size<br />
	<input type="checkbox" name="showfilesize" value="y" <?php if ($this->_tpl_vars['showfilesize'] == 'y'): ?>checked="checked"<?php endif; ?> />Размер файла<br />
	<input type="checkbox" name="showfilename" value="y" <?php if ($this->_tpl_vars['showfilename'] == 'y'): ?>checked="checked"<?php endif; ?> />Имя файла<br />
</td></tr>
...
<tr><td class="formcolor">Родительская галерея:</td><td class="formcolor"><select name="parentgallery">
<option value="-1" <?php if ($this->_tpl_vars['parentgallery'] == -1): ?> selected="selected"<?php endif; ?>>нет</option>
...
<tr><td class="formcolor">Доступные масштабы:</td><td class="formcolor">
...
?>
Удалить:<input type="checkbox" name="removescale_<?php echo ((is_array($_tmp=$this->_tpl_vars['scaleinfo'][$this->_sections['scales']['index']]['scale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
...
<tr><td class="formcolor">Add scaled images with bounding box of square size:</td><td class="formcolor"><input type="text" name="scaleSize" /> пикселей</td></tr>
...
unset($_smarty_tpl_vars);
 ?>
<tr><td class="formcolor">Закачка изображений в галерею доступна и другим:</td><td class="formcolor"><input type="checkbox" name="public" <?php if ($this->_tpl_vars['public'] == 'y'): ?>checked="checked"<?php endif; ?>/></td></tr>
<tr><td class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" value="сохранить" name="edit" /></td></tr>
</table>
</form>
</div>
<br />
...
<div class="wikitext">
Вы можете получить доступ к галерее по следующему адресу: <a class="gallink" href="<?php echo $this->_tpl_vars['url']; ?>
...
<div class="navbar"><a class="linkbut" href="tiki-galleries.php?edit_mode=1&amp;galleryId=0">создать новую галерею</a></div>
<?php endif; ?>
...
<tr><td class="findtable">Найти</td>
   <td class="findtable">
...
<option value="topgal"<?php if ($this->_tpl_vars['filter'] == 'topgal'): ?> selected="selected"<?php endif; ?>>Топ</option>
<option value="parentgal"<?php if ($this->_tpl_vars['filter'] == 'parentgal'): ?> selected="selected"<?php endif; ?>>Родительская галерея</option>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'name_desc'): ?>name_asc<?php else: ?>name_desc<?php endif; ?>">Имя</a></td>
<td class="heading">Предок</td>
<?php endif; ?>
<?php if ($this->_tpl_vars['gal_list_description'] == 'y'): ?>
<td class="heading"><a class="tableheading" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'description_desc'): ?>description_asc<?php else: ?>description_desc<?php endif; ?>">Описание</a></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['gal_list_created'] == 'y'): ?>
<td class="heading"><a class="tableheading" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>created_asc<?php else: ?>created_desc<?php endif; ?>">Создано</a></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['gal_list_lastmodif'] == 'y'): ?>
<td class="heading"><a class="tableheading" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'lastModif_desc'): ?>lastModif_asc<?php else: ?>lastModif_desc<?php endif; ?>">Последние изменения</a></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['gal_list_user'] == 'y'): ?>
<td class="heading"><a class="tableheading" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">Пользователь</a></td>
<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'images_desc'): ?>images_asc<?php else: ?>images_desc<?php endif; ?>">Изображений</a></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['gal_list_visits'] == 'y'): ?>
<td style="text-align:right;"  class="heading"><a class="tableheading" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">Посещений</a></td>
<?php endif; ?>
<td  class="heading">Действия</td>
</tr>
...
"><?php echo $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['parentgalleryName']; ?>
  ...
  <?php if ($this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['parentgal'] == 'y'): ?><i>Предок</i><?php endif; ?>
  </td>
<?php endif; ?>
<?php if ($this->_tpl_vars['gal_list_description'] == 'y'): ?>
  <td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
...
" nowrap="nowrap">
  ...
  <?php if (( $this->_tpl_vars['tiki_p_admin'] == 'y' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual'] == 'n' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual_tiki_p_create_galleries'] == 'y' )): ?>
    <a class="gallink" title="правка" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
...
"><?php echo smarty_function_html_image(array('file' => 'img/icons/edit.gif','alt' => 'Правка','title' => 'Правка','border' => '0'), $this);?>
</a>
  <?php endif; ?>
  <?php endif; ?>
...
"><img src='img/icons2/upload.gif' border='0' height="16" width="16" alt='Закачать' title='Закачать' /></a>
...
"><img border='0' height="16" width="18" src='img/icons/ico_table.gif' title='Список' alt='Список' /></a>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
...
"><img src='img/icons/key_active.gif' alt='active perms' title='active perms' height="16" width="17" border='0' /></a>
	...
	<a class="gallink" href="tiki-objectpermissions.php?objectName=<?php echo ((is_array($_tmp=$this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;objectType=image+gallery&amp;permType=image+galleries&amp;objectId=<?php echo $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['galleryId']; ?>
"><img src='img/icons/key.gif' alt='права' title='права' height="16" width="17" border='0' /></a>
    <?php endif; ?>
  <?php endif; ?>
<?php if ($this->_tpl_vars['tiki_p_admin_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['user'] == $this->_tpl_vars['user'] )): ?>
  <?php if (( $this->_tpl_vars['tiki_p_admin'] == 'y' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual'] == 'n' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual_tiki_p_create_galleries'] == 'y' )): ?>
    &nbsp;&nbsp;<a class="gallink" title="удалить" href="tiki-galleries.php?offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php echo $this->_tpl_vars['sort_mode']; ?>
&amp;removegal=<?php echo $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['galleryId']; ?>
"><img src='img/icons2/delete.gif' height="16" width="16" border='0' alt='удалить' title='удалить' /></a>
  <?php endif; ?>
  <?php endif; ?>
