...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="drucken" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
">Seiten-ID: <?php echo $this->_tpl_vars['page_id']; ?>
</a></small>
	<?php endif; ?>
	<?php echo smarty_function_breadcrumbs(array('type' => 'desc','loc' => 'page','crumbs' => $this->_tpl_vars['crumbs']), $this);?>

	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(gecached)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Vorherige Seite" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="N&auml;chste Seite" 
...
" />
	      ...
	      <?php else: ?>
	      <input type="checkbox" name="add_child" /> neue Sub-Seite
	      <?php endif; ?>      
	      <input type="submit" name="insert_into_struct" value="Seite hinzuf&uuml;gen" />
	    </form>
	<?php endif; ?>
	  </td>
	</tr>
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Erste Seite" title="Erste Seite" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Vorherige Seite" title="Vorherige Seite" /></a>
	
			<small>Seite:<?php echo $this->_tpl_vars['pagenum']; ?>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="N&auml;chste Seite" title="N&auml;chste Seite" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Letzte Seite" title="Letzte Seite" /></a>
		</div>
	<?php endif; ?>
	</div> 
	...
	<p class="editdate">
	  Last edited by <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />                                         
	  Seite zuletzt ge&auml;ndert am <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
.
	</p>
	<?php elseif (isset ( $this->_tpl_vars['wiki_authors_style'] ) && $this->_tpl_vars['wiki_authors_style'] == 'collaborative'): ?>
	<p class="editdate">
	  Zu dieser Seite haben beigesteuert: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />
	  Seite zuletzt ge&auml;ndert am <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
 von <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
.
	</p>
...
</i>, von: <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
"><?php echo $this->_tpl_vars['lastUser']; ?>
</a>
	</p>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Zum Editieren der Copyright-Hinweise <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">hier klicken</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">Der Inhalt dieser Seite unterliegt folgenden Lizenzbestimmungen: <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    Das Originaldokument ist zu finden unter:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
