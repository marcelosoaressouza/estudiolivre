...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Действия модератора</td>
					</tr>
					<tr>
						<td class="odd">
							<input type="submit" name="delsel" value="удалить выбранные" />
						</td>
					</tr>
					<tr>
						<td class="odd">
...
"><?php echo $this->_tpl_vars['topics'][$this->_sections['ix']['index']]['title']; ?>
							...
							<input type="submit" name="movesel" value="переместить" />
						</td>
...
">
									reported:<?php echo $this->_tpl_vars['reported']; ?>
...
">
								queued:<?php echo $this->_tpl_vars['queued']; ?>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>ответить<?php else: ?>ответы<?php endif; ?> below your current threshold
			<?php endif; ?>
	  		<div class="paginacao">
...
/img/iArrowGreyLeft.png">
				...
				Страница <?php echo $this->_tpl_vars['comments_actual_page']; ?>
