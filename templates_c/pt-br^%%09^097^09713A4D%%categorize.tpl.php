<?php /* Smarty version 2.6.18, created on 2011-06-27 19:52:23
         compiled from styles/geral/categorize.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'styles/geral/categorize.tpl', 3, false),array('modifier', 'escape', 'styles/geral/categorize.tpl', 17, false),)), $this); ?>
...
/img/iArrowGreyRight.png">
	...
	<div id="categorizator" style="display:none;">
		<?php if ($this->_tpl_vars['feature_help'] == 'y'): ?>
			<!--div class="simplebox">Dica: segure o CTRL para selecionar mais de uma categoria ao mesmo tempo</div-->
		<?php endif; ?>
...
',<?php echo ((is_array($_tmp=$this->_tpl_vars['categories'][$this->_sections['ix']['index']]['categId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
			...
			<?php if ($this->_tpl_vars['feature_help'] == 'y'): ?>
			    <!--div class="simplebox">Dica: desmarque a caixa acima para deixar sem categoria essa página/objeto</div-->
			<?php endif; ?>
		<?php else: ?>
		   	Nenhuma categoria definida <br />
		<?php endif; ?>
		
	</div>
	<?php if ($this->_tpl_vars['tiki_p_admin_categories'] == 'y'): ?>
	<br clear="both">
			<a href="tiki-admin_categories.php" class="link">Administrar categorias</a>
	<?php endif; ?>
	<?php echo '
