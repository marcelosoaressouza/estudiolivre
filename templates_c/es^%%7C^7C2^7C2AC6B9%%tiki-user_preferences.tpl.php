...
">
			Preferencias del usuario: <?php echo $this->_tpl_vars['userwatch']; ?>
...
User+Preferences" target="tikihelp" class="tikihelp" title="Preferencias del usuario">
		<img src="img/icons/help.gif" border="0" height="16" width="16" alt='ayuda' /></a>
	<?php endif; ?>
	
	<?php if ($this->_tpl_vars['feature_view_tpl'] == 'y'): ?>
		<a href="tiki-edit_templates.php?template=tiki-user_preferences.tpl" target="tikihelp" class="tikihelp" title="Ver tpl: UserPreferences tpl">
		<img src="img/icons/info.gif" border="0" width="16" height="16" alt='editar plantilla' /></a>
	<?php endif; ?>
...
<div class="tabcontent" >
  ...
  <div class="cbox">
  <div class="cbox-title">Preferencias Generales</div>
  <div class="cbox-data">
...
"/> 
  ...
  <table class="admin">
  <tr><td class="form">Última conexión:</td><td class="form"><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['lastLogin'])) ? $this->_run_mod_handler('tiki_short_datetime', true, $_tmp) : smarty_modifier_tiki_short_datetime($_tmp)); ?>
</td></tr>
  <tr><td class="form">Es el correo público? (usa cifrado para prevenir spam)</td><td class="form">
...
<?php else: ?>
  No disponible - configure su correo debajo
<?php endif; ?>
  </td></tr>
  <tr><td class="form">Su lector de correo requiere un charset especial</td>
  <td class="form">
...
" <?php if ($this->_tpl_vars['style'] == $this->_tpl_vars['styles'][$this->_sections['ix']['index']]): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['styles'][$this->_sections['ix']['index']])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
  ...
  <tr><td  class="form">Lenguaje:</td></tr>
  <tr>
...
"
  ...
  <?php endif; ?>      
  <tr><td class="form">Cantidad de páginas visitadas a recordar:</td><td class="form">
  ...
  <tr><td class="form">Zona horaria a mostrar:</td>
  <td class="form">
  ...
  <tr><td class="form">Usar doble-clic para editar páginas:</td>
  <td class="form">
  ...
  <tr><td class="form">Mostrar info de usuario on mouseover:</td>
  <td class="form">
  ...
  <tr><td colspan="2" class="button"><input type="submit" name="prefs" value="Cambiar preferencias" /></td></tr>
  </table>
  </form>
  </div>
  </div>
  ...
  <div class="cbox">
  <div class="cbox-title">Clave</div>
  <div class="cbox-data">
  <?php if ($this->_tpl_vars['auth_method'] != 'cas' || ( $this->_tpl_vars['cas_skip_admin'] == 'y' && $this->_tpl_vars['user'] == 'admin' )): ?>
  <?php if ($this->_tpl_vars['change_password'] != 'n'): ?>Deje los campos "Nueva contraseña" y "Confirmar contraseña" en blanco para conservar la contraseña actual<?php endif; ?>
  <?php endif; ?>
  <form action="tiki-user_preferences.php" method="post">
  <input type="hidden" name="view_user" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['userwatch'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"/>
...
<?php if ($this->_tpl_vars['auth_method'] != 'cas' || ( $this->_tpl_vars['cas_skip_admin'] == 'y' && $this->_tpl_vars['user'] == 'admin' )): ?>
  ...
  <tr><td class="form">Nueva contraseña :</td><td class="form"><input type="password" name="pass1" /></td></tr>
  <tr><td class="form">Confirmar nueva contraseña:</td><td class="form"><input type="password" name="pass2" /></td></tr>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['tiki_p_admin'] != 'y' || $this->_tpl_vars['userwatch'] == $this->_tpl_vars['user']): ?>
    <tr><td class="form">Contraseña actual (requerido):</td><td class="form"><input type="password" name="pass" /></td></tr>
  <?php endif; ?>
<?php endif; ?>
  <tr><td colspan="2" class="button"><input type="submit" name="chgadmin" value="Cambiar información administrativa"/></td></tr>
  </table>
  </form>
  </div>
  </div>
...
<table class="admin">
<tr>
  <td class="form">Mensajes por página</td>
  <td class="form">
...
<tr>
  <td class="form">Envieme un correo por mensajes con prioridad mayor o igual a:</td>
  <td class="form">
    <select name="minPrio">
      <option value="1" <?php if ($this->_tpl_vars['minPrio'] == 1): ?>selected="selected"<?php endif; ?>>1 -Mínimo-</option>
      <option value="2" <?php if ($this->_tpl_vars['minPrio'] == 2): ?>selected="selected"<?php endif; ?>>2 -Bajo-</option>
      <option value="3" <?php if ($this->_tpl_vars['minPrio'] == 3): ?>selected="selected"<?php endif; ?>>3 -Normal-</option>
      <option value="4" <?php if ($this->_tpl_vars['minPrio'] == 4): ?>selected="selected"<?php endif; ?>>4 -Alto-</option>
      <option value="5" <?php if ($this->_tpl_vars['minPrio'] == 5): ?>selected="selected"<?php endif; ?>>5 -Superior-</option>
      <option value="6" <?php if ($this->_tpl_vars['minPrio'] == 6): ?>selected="selected"<?php endif; ?>>ning</option>
    </select>
  </td>
</tr>
<tr>
  <td class="form">Auto-archivar mensajes leídos luego de x días</td>
  <td class="form">
...
<tr>
  <td colspan="2" class="button"><input type="submit" name="messprefs" value="Cambiar preferencias"></td>
</tr>
</table>
</form>
</div>
...
<?php if ($this->_tpl_vars['feature_tasks'] == 'y' && $this->_tpl_vars['tiki_p_tasks'] == 'y'): ?>
  ...
  <div class="cbox">
  <div class="cbox-title">Tareas del usuario</div>
  <div class="cbox-data">
        <form action="tiki-user_preferences.php" method="post">
        <input type="hidden" name="view_user" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['userwatch'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"/>
<table class="admin">
<tr>
  <td class="form">Tareas por página</td>
  <td class="form">
...
<tr>
  <td colspan="2" class="button"><input type="submit" name="tasksprefs" value="Cambiar preferencias" ></td>
</tr>
</table>
</form>
  ...
  <div class="cbox">
  <div class="cbox-title"><a href="tiki-my_tiki.php">Mi Tiki</a></div>
  <div class="cbox-data">
...
<?php if ($this->_tpl_vars['feature_wiki'] == 'y'): ?>
<tr><td class="form">Mis páginas</td><td class="form"><input type="checkbox" name="mytiki_pages" <?php if ($this->_tpl_vars['mytiki_pages'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_blogs'] == 'y'): ?>
<tr><td class="form">Mis blogs</td><td class="form"><input type="checkbox" name="mytiki_blogs" <?php if ($this->_tpl_vars['mytiki_blogs'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
<?php endif; ?>



<?php if ($this->_tpl_vars['feature_messages'] == 'y' && $this->_tpl_vars['tiki_p_messages'] == 'y'): ?>
<tr><td class="form">Mis mensajes</td><td class="form"><input type="checkbox" name="mytiki_msgs" <?php if ($this->_tpl_vars['mytiki_msgs'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_tasks'] == 'y' && $this->_tpl_vars['tiki_p_tasks'] == 'y'): ?>
<tr><td class="form">Mis tareas</td><td class="form"><input type="checkbox" name="mytiki_tasks" <?php if ($this->_tpl_vars['mytiki_tasks'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_trackers'] == 'y'): ?>
<tr><td class="form">Mis items</td><td class="form"><input type="checkbox" name="mytiki_items" <?php if ($this->_tpl_vars['mytiki_items'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_workflow'] == 'y'): ?>
  <?php if ($this->_tpl_vars['tiki_p_use_workflow'] == 'y'): ?>
    <tr><td class="form">Mi workflow</td><td class="form"><input type="checkbox" name="mytiki_workflow" <?php if ($this->_tpl_vars['mytiki_workflow'] == 'y'): ?>checked="checked"<?php endif; ?> /></td></tr>
  <?php endif; ?>
<?php endif; ?>
<tr>
  <td colspan="2" class="button"><input type="submit" name="mytikiprefs" value="Cambiar preferencias" /--></td>
</tr>
</table>
