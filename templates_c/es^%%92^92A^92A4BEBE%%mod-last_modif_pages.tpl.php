...
<?php $this->_tag_stack[] = array('tikimodule', array('title' => "Últimas Alteraciones",'name' => 'last_modif_pages','flip' => $this->_tpl_vars['module_params']['flip'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
<?php else: ?><i>Modificación no comentada</i><?php endif; ?><br>editado por: <b><?php echo $this->_tpl_vars['modModifPage']['user']; ?>
</b>')" onMouseout="nd()"><?php echo $this->_tpl_vars['modModifPage']['pageName']; ?>
</a><br/>
	     	<?php endforeach; endif; unset($_from); ?>
	     	<div class="modViewAll"><a href="tiki-lastchanges.php?days=0">veer más</a></div>
