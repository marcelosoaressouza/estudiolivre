...
">
				...
				ページ: <?php echo $this->_tpl_vars['pagenum']; ?>
...
) <?php if ($this->_tpl_vars['post']['comments'] == 1): ?>コメント<?php else: ?>コメント<?php endif; ?>
					</a>
				<?php endif; ?>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a class="link" href="tiki-view_blog_post.php?find=<?php echo $this->_tpl_vars['find']; ?>
