<?php /* Smarty version 2.6.18, created on 2011-04-04 20:30:43
...
<div class="searchResultItem">
	<?php if ($this->_tpl_vars['feature_search_fulltext'] == 'y'): ?><?php if ($this->_tpl_vars['result']['relevance'] <= 0): ?><?php $this->assign('tiptext', 'Simple Search'); ?><?php else: ?><?php $this->assign('tiptext', ((is_array($_tmp="Relevance: ")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['result']['relevance']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['result']['relevance']))); ?><?php endif; ?><?php endif; ?>
