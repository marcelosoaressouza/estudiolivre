<?php /* Smarty version 2.6.18, created on 2011-06-05 20:34:09
         compiled from styles/geral/tiki-browse_freetags.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'css', 'styles/geral/tiki-browse_freetags.tpl', 1, false),array('function', 'cycle', 'styles/geral/tiki-browse_freetags.tpl', 37, false),array('function', 'el_gallery_item', 'styles/geral/tiki-browse_freetags.tpl', 41, false),array('function', 'el_wiki_item', 'styles/geral/tiki-browse_freetags.tpl', 46, false),array('block', 'tooltip', 'styles/geral/tiki-browse_freetags.tpl', 16, false),array('modifier', 'truncate', 'styles/geral/tiki-browse_freetags.tpl', 44, false),)), $this); ?>
...
&amp;type=wiki%20page" id="typeWikiPage">Páginas wiki</a></li>
	...
	<?php $this->_tag_stack[] = array('tooltip', array('name' => "browse-freetags-all",'text' => "Ver <strong>apenas</strong> <b>arquivos</b> com a tag")); $_block_repeat=true;smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>     
...
?>
    ...
    <?php elseif ($this->_tpl_vars['objects'][$this->_sections['ix']['index']]['type'] == 'blog'): ?>
		<?php echo $this->_tpl_vars['objects'][$this->_sections['ix']['index']]['itemId']; ?>
<br/>
			<a href="<?php echo $this->_tpl_vars['objects'][$this->_sections['ix']['index']]['href']; ?>
" class="catname"><?php echo ((is_array($_tmp=$this->_tpl_vars['objects'][$this->_sections['ix']['index']]['description'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 250) : smarty_modifier_truncate($_tmp, 250)); ?>
</a>
    <?php else: ?>
