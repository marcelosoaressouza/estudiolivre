...
" />
		...
		<div id="comButtons">
			...
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="cancelar" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	Use [http://www.foo.com] o [http://www.foo.com|descripción] para enlaces.<br />
	Etiquetas HTML no estan permitidos dentro de posts.<br />
