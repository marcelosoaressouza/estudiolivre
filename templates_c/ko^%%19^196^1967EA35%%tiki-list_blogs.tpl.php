<?php /* Smarty version 2.6.18, created on 2011-05-30 08:53:22
	...
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=blogs">
				<img src='img/icons/config.gif' border='0'  alt="나열 방식 변경" title="나열 방식 변경" />
			</a>
		<?php endif; ?>
	</h1>
...
">
									<img title='수정' alt='수정' src='img/icons/config.gif' />
								</a>
							</td>
						<?php endif; ?>
					<?php endif; ?>
...
">
									<img title='게시' alt='게시' src='img/icons/edit.gif' />
								</a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
...
&amp;objectType=blog&amp;permType=blogs&amp;objectId=<?php echo $this->_tpl_vars['listpages'][$this->_sections['changes']['index']]['blogId']; ?>
">
								<img title='권한' alt='권한' src='img/icons/key.gif' />
							</a>
							</td>
					    <?php endif; ?>
					<?php endif; ?>		
...
">
		                      	<img title='삭제' alt='삭제' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
