<?php /* Smarty version 2.6.18, created on 2011-04-04 17:13:08
...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="imprimer" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
">id page: <?php echo $this->_tpl_vars['page_id']; ?>
</a></small>
	<?php endif; ?>
	<?php echo smarty_function_breadcrumbs(array('type' => 'desc','loc' => 'page','crumbs' => $this->_tpl_vars['crumbs']), $this);?>

	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(dans l'antémémoire)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Page précédente" 
...
"><img src="img/icons2/nav_home.gif" border="0" height="11" width="13" alt="Page parente" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Page suivante" 
...
" />
	      ...
	      <?php endif; ?>      
	      <input type="submit" name="insert_into_struct" value="Ajouter des pages" />
	    </form>
	<?php endif; ?>
	  </td>
	</tr>
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Première page" title="Première page" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Page précédente" title="Page précédente" /></a>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Page suivante" title="Page suivante" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Dernière page" title="Dernière page" /></a>
		</div>
	<?php endif; ?>
	</div> 
	...
	<p class="editdate">
	  Dernièrement modifié par <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
...
?>
	   <?php if ($this->_sections['author']['first']): ?>, Basé sur le travail de
	   <?php else: ?>
	  ...
	  <?php endfor; endif; ?>.<br />                                         
	  Page modifiée dernièrement le <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
.
	</p>
	<?php elseif (isset ( $this->_tpl_vars['wiki_authors_style'] ) && $this->_tpl_vars['wiki_authors_style'] == 'collaborative'): ?>
	<p class="editdate">
	  Collaborateurs de cette page: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />
	  Page modifiée dernièrement le <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
 par <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
.
	</p>
	...
	<p class="editdate">
	  ...
	  Dernière modification: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y às %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%Y às %H:%M")); ?>
</i>, par: <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
"><?php echo $this->_tpl_vars['lastUser']; ?>
</a>
	</p>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Pour modifier les notices de copyright <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">cliquer ici</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">Le contenu de cette page est licencié sous les termes  <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    Le document d'origine est disponible à:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
