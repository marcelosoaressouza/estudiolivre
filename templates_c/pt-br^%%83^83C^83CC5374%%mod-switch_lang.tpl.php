<?php /* Smarty version 2.6.18, created on 2011-05-03 19:41:10
         compiled from modules/mod-switch_lang.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tikimodule', 'modules/mod-switch_lang.tpl', 3, false),array('modifier', 'escape', 'modules/mod-switch_lang.tpl', 9, false),)), $this); ?>


<?php $this->_tag_stack[] = array('tikimodule', array('title' => "Idioma: ".($this->_tpl_vars['language']),'name' => 'switch_lang','flip' => $this->_tpl_vars['module_params']['flip'],'decorations' => $this->_tpl_vars['module_params']['decorations'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
"
          <?php if ($this->_tpl_vars['language'] == $this->_tpl_vars['languages'][$this->_sections['ix']['index']]['value']): ?>selected="selected"<?php endif; ?>>
