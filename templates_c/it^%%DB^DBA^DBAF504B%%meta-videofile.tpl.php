<?php /* Smarty version 2.6.18, created on 2011-04-26 05:07:13
...
<?php if ($this->_tpl_vars['file']->duration || ( ! $this->_tpl_vars['file']->duration && $this->_tpl_vars['permission'] )): ?>
	<span class="fInfo">Duração:</span> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['file']->duration,'id' => 'duration','default' => "",'display' => 'inline','file' => $this->_tpl_vars['viewFile']), $this);?>
 s
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php endif; ?>

<?php if ($this->_tpl_vars['file']->width || ( ! $this->_tpl_vars['file']->width && $this->_tpl_vars['permission'] )): ?>
	<span class="fInfo">Largura:</span> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'id' => 'width','value' => $this->_tpl_vars['file']->width,'default' => "",'display' => 'inline','file' => $this->_tpl_vars['viewFile']), $this);?>
 px
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php endif; ?>

<?php if ($this->_tpl_vars['file']->height || ( ! $this->_tpl_vars['file']->height && $this->_tpl_vars['permission'] )): ?>
	<span class="fInfo">Altura:</span> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'id' => 'height','value' => $this->_tpl_vars['file']->height,'default' => "",'display' => 'inline','file' => $this->_tpl_vars['viewFile']), $this);?>
 px
<?php endif; ?>
...
<?php if ($this->_tpl_vars['permission']): ?>
 ...
 <span class="fInfo">Tem audio</span>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
