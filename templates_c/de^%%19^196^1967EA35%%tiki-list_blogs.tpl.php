<?php /* Smarty version 2.6.18, created on 2011-06-14 06:00:12
	...
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=blogs">
				<img src='img/icons/config.gif' border='0'  alt="Liste konfigurieren" title="Liste konfigurieren" />
			</a>
		<?php endif; ?>
	</h1>
...
">
									<img title='bearbeiten' alt='bearbeiten' src='img/icons/config.gif' />
								</a>
							</td>
						<?php endif; ?>
					<?php endif; ?>
...
">
									<img title='Eintrag' alt='Eintrag' src='img/icons/edit.gif' />
								</a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
...
&amp;objectType=blog&amp;permType=blogs&amp;objectId=<?php echo $this->_tpl_vars['listpages'][$this->_sections['changes']['index']]['blogId']; ?>
">
								<img title='Berecht.' alt='Berecht.' src='img/icons/key.gif' />
							</a>
							</td>
					    <?php endif; ?>
					<?php endif; ?>		
...
">
		                      	<img title='entfernen' alt='entfernen' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
...
/img/iArrowGreyLeft.png">
		...
		Seite <?php echo $this->_tpl_vars['actual_page']; ?>
