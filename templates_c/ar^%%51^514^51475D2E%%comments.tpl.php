...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>reply<?php else: ?>replies<?php endif; ?> below your current threshold
			<?php endif; ?>
	  		<div class="paginacao">
...
/img/iArrowGreyLeft.png">
				...
				الصفحه <?php echo $this->_tpl_vars['comments_actual_page']; ?>
