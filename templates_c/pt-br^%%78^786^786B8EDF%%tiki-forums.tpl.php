<?php /* Smarty version 2.6.18, created on 2011-04-04 17:12:36
...
<div id="forum">
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=forums" title="Configurar/Opções">
				<?php echo smarty_function_html_image(array('file' => 'img/icons/config.gif','border' => '0','alt' => "Configurar/Opções"), $this);?>
...
">
				...
				<?php if (( $this->_tpl_vars['tiki_p_admin'] == 'y' ) || ( ( $this->_tpl_vars['channels'][$this->_sections['user']['index']]['individual'] == 'n' ) && ( $this->_tpl_vars['tiki_p_admin_forum'] == 'y' ) ) || ( $this->_tpl_vars['channels'][$this->_sections['user']['index']]['individual_tiki_p_admin_forum'] == 'y' )): ?>
					<a class="admlink" title="configurar fórum" href="tiki-admin_forums.php?forumId=<?php echo $this->_tpl_vars['channels'][$this->_sections['user']['index']]['forumId']; ?>
">
						<img src="img/icons/config.gif" border="0" width="16" height="16" alt='Configurar/Opções' />
					</a>
				<?php endif; ?>
