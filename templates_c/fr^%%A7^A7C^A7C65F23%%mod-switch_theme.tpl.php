<?php /* Smarty version 2.6.18, created on 2011-04-19 20:37:43
         compiled from styles/bolha/modules/mod-switch_theme.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tikimodule', 'styles/bolha/modules/mod-switch_theme.tpl', 3, false),array('modifier', 'replace', 'styles/bolha/modules/mod-switch_theme.tpl', 7, false),array('modifier', 'escape', 'styles/bolha/modules/mod-switch_theme.tpl', 7, false),)), $this); ?>
<?php if ($this->_tpl_vars['change_theme'] != 'n' || $this->_tpl_vars['user'] == ''): ?>
	
	<?php $this->_tag_stack[] = array('tikimodule', array('title' => 'Modifier Style','name' => 'switch_theme','flip' => $this->_tpl_vars['module_params']['flip'],'decorations' => $this->_tpl_vars['module_params']['decorations'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
