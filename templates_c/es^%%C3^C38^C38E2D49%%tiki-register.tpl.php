<?php /* Smarty version 2.6.18, created on 2011-06-18 03:36:36
...
<h2>Registarse como un nuevo usuario</h2>
<br />
<?php if ($this->_tpl_vars['showmsg'] == 'y'): ?>
<?php echo $this->_tpl_vars['msg']; ?>

<?php elseif ($this->_tpl_vars['notrecognized'] == 'y'): ?>
Su correo no puede ser validado; asegúrese que su correo es correcto y pulse en registrarse.<br />
...
<small>Su código de registro:</small>
<img src="tiki-random_num_img.php" alt='Imágen al azar'/>
<br />
<?php endif; ?>
<form action="tiki-register.php" method="post"> <br />
<table class="normal">
<tr><td class="formcolor">Usuario:</td><td class="formcolor"><input type="text" name="name" /></td></tr>
<?php if ($this->_tpl_vars['useRegisterPasscode'] == 'y'): ?>
<tr><td class="formcolor">Código para registrarse (no su contraseña de usuario):</td><td class="formcolor"><input type="password" name="passcode" /></td></tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['rnd_num_reg'] == 'y'): ?>
...
<tr><td class="formcolor">Clave:</td><td class="formcolor"><input id='pass1' type="password" name="pass" /></td></tr>

<tr><td class="formcolor">Repetir contraseña:</td><td class="formcolor"><input id='pass2' type="password" name="passAgain" /></td></tr>

<tr><td class="formcolor">Correo:</td><td class="formcolor"><input type="text" name="email" />
<?php if ($this->_tpl_vars['validateUsers'] == 'y' && $this->_tpl_vars['validateEmail'] != 'y'): ?><br />Un correo válido es obligatorio para registrarse.<br /><br />
...
<tr><td  class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" name="register" value="registrarse" /></td></tr>

</table>
</form>
<br />
<table class="normal">
<tr><td class="formcolor"><a class="link" href="javascript:genPass('genepass','pass1','pass2');">Generar una contraseña</a></td>
