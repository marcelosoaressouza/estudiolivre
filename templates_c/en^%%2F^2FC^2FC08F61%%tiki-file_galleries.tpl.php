<?php /* Smarty version 2.6.18, created on 2011-06-21 07:52:37
...
File+Gallery" target="tikihelp" class="tikihelp" title="File Galleries">
...
<a href="tiki-admin.php?page=fgal"><img src='img/icons/config.gif' border='0'  alt="configure listing" title="configure listing" /></a>
<?php endif; ?>
</h1>
...
<a class="linkbut" href="tiki-file_galleries.php?edit_mode=1&amp;galleryId=0">create new gallery</a>
<?php endif; ?>
...
">There are individual permissions set for this file gallery</a>
<?php endif; ?>
...
"/></td></tr>
<tr><td class="formcolor">Description:</td><td class="formcolor"><textarea rows="5" cols="40" name="description"><?php echo ((is_array($_tmp=$this->_tpl_vars['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td></tr>
...
<tr>
	<td class="formcolor">Listing configuration</td>
	<td class="formcolor">
		<table >
			<tr>
				<td class="formcolor">icon</td>
				<td class="formcolor">id</td>
				<td class="formcolor">name</td>
				<td class="formcolor">size</td>
				<td class="formcolor">description</td>
				<td class="formcolor">created</td>
			...
			<tr>
				...
				<td class="formcolor">
					<select name="show_name">
						...
						<option value="n" <?php if ($this->_tpl_vars['show_name'] == 'n'): ?>selected="selected"<?php endif; ?>>Name</option>
...
unset($_smarty_tpl_vars);
 ?>
<tr><td class="formcolor">Other users can upload files to this gallery:</td><td class="formcolor"><input type="checkbox" name="public" <?php if ($this->_tpl_vars['public'] == 'y'): ?>checked="checked"<?php endif; ?>/></td></tr>
...
<div class="wikitext">
You can access the file gallery using the following URL: <a class="fgallink" href="<?php echo $this->_tpl_vars['url']; ?>
...
<?php if ($this->_tpl_vars['tiki_p_create_file_galleries'] == 'y'): ?>
<a class="linkbut" href="tiki-file_galleries.php?edit_mode=1&amp;galleryId=0">create new gallery</a><br /><br />
<?php endif; ?>
<div style="text-align: center">
...
<?php if ($this->_tpl_vars['fgal_list_files'] == 'y'): ?>	
	<?php $this->assign('cntcol', $this->_tpl_vars['cntcol']+1); ?>
	<td style="text-align:right;" class="heading">Files</td>
<?php endif; ?>
...
"><img src="img/icons/config.gif" border="0" width="16" height="16" alt='edit' title='edit' /></a>
		<?php endif; ?>
	<?php endif; ?>
...
"><img src='img/icons2/upload.gif' border='0' alt='Upload' title='Upload' /></a>
			<?php endif; ?>
		<?php endif; ?>
	<?php endif; ?>
...
"><img src='img/icons/key_active.gif' alt='active perms' title='active perms' border='0' /></a>
		...
		<a class="fgallink" href="tiki-objectpermissions.php?objectName=<?php echo ((is_array($_tmp=$this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;objectType=file+gallery&amp;permType=file+galleries&amp;objectId=<?php echo $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['id']; ?>
"><img src='img/icons/key.gif' alt='perms' title='perms' border='0' /></a>
	    <?php endif; ?>
	<?php endif; ?>
<?php if ($this->_tpl_vars['tiki_p_admin_file_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['user'] == $this->_tpl_vars['user'] )): ?>
                <?php if (( $this->_tpl_vars['tiki_p_admin'] == 'y' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual'] == 'n' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual_tiki_p_create_file_galleries'] == 'y' )): ?>
...
"><img src='img/icons2/delete.gif' border='0' alt='delete' title='delete' /></a>
                <?php endif; ?>
        <?php endif; ?>
