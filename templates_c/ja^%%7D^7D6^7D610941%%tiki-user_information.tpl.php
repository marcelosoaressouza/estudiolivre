<?php /* Smarty version 2.6.18, created on 2011-04-27 01:59:40
...
<tr>
  <td valign="top">
  <div class="cbox">
  <div class="cbox-title">ユーザー情報</div>
  <div class="cbox-data">
  <div class="simplebox">
  <table>
  <tr><td class="form">ユーザー:</td><td><?php echo $this->_tpl_vars['userinfo']['login']; ?>
...
<?php if ($this->_tpl_vars['feature_score'] == 'y'): ?>
  <tr><td class="form">点数:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['score'])) ? $this->_run_mod_handler('star', true, $_tmp) : smarty_modifier_star($_tmp)); ?>
<?php echo $this->_tpl_vars['userinfo']['score']; ?>
</td></tr>
<?php endif; ?>
  <tr><td class="form">最終ログイン日時:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['lastLogin'])) ? $this->_run_mod_handler('tiki_short_datetime', true, $_tmp) : smarty_modifier_tiki_short_datetime($_tmp)); ?>
</td></tr>
<?php if ($this->_tpl_vars['email_isPublic'] != 'n'): ?>  
  <tr><td class="form">メールアドレス:</td><td><?php echo $this->_tpl_vars['userinfo']['email']; ?>
</td></tr>
<?php endif; ?>  
  <tr><td class="form">国:</td><td><img alt="flag" src="img/flags/<?php echo $this->_tpl_vars['country']; ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td></tr>
  <?php if ($this->_tpl_vars['change_theme'] != 'n'): ?><tr><td class="form">テーマ:</td><td><?php echo $this->_tpl_vars['user_style']; ?>
</td></tr><?php endif; ?>
  <?php if ($this->_tpl_vars['change_language'] == 'y'): ?><tr><td  class="form">言語:</td><td><?php echo $this->_tpl_vars['user_language']; ?>
</td></tr><?php endif; ?>
  <tr><td class="form">本名:</td><td><?php echo $this->_tpl_vars['realName']; ?>
</td></tr>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:</td><td><?php echo $this->_tpl_vars['customfields'][$this->_sections['ir']['index']]['value']; ?>
  ...
  <tr><td class="form">アバター:</td><td><?php echo $this->_tpl_vars['avatar']; ?>
</td></tr>
  <tr><td class="form">Homepage:</td><td><?php if ($this->_tpl_vars['homePage'] != ""): ?><a href="<?php echo $this->_tpl_vars['homePage']; ?>
" class="link" title="Users HomePage"><?php echo $this->_tpl_vars['homePage']; ?>
</a><?php endif; ?></td></tr>
<?php if ($this->_tpl_vars['feature_wiki'] == 'y' && $this->_tpl_vars['feature_wiki_userpage'] == 'y'): ?>
  <tr><td class="form">個人のWikiページ:</td><td>
...
<?php endif; ?>
  <tr><td class="form">表示する時間帯:</td><td><?php echo $this->_tpl_vars['display_timezone']; ?>
</td></tr>
...
<tr>
  <td valign="top">
  <div class="cbox">
  <div class="cbox-title">私にメッセージを送る</div>
  <div class="cbox-data">
  <div class="simplebox">
...
" />
  ...
  <tr>
    <td class="form">重要度:</td><td class="form">
    <select name="priority">
      <option value="1" <?php if ($this->_tpl_vars['priority'] == 1): ?>selected="selected"<?php endif; ?>>1 -とても低い-</option>
      <option value="2" <?php if ($this->_tpl_vars['priority'] == 2): ?>selected="selected"<?php endif; ?>>2 -低い-</option>
      <option value="3" <?php if ($this->_tpl_vars['priority'] == 3): ?>selected="selected"<?php endif; ?>>3 -普通-</option>
      <option value="4" <?php if ($this->_tpl_vars['priority'] == 4): ?>selected="selected"<?php endif; ?>>4 -高い-</option>
      <option value="5" <?php if ($this->_tpl_vars['priority'] == 5): ?>selected="selected"<?php endif; ?>>5 -とても高い-</option>
    </select>
    <input type="submit" name="send" value="送信" />
    </td>
  </tr>
  <tr>
    <td class="form">題:</td><td class="form"><input type="text" name="subject" value="" maxlength="255" style="width:100%;"/></td>
  </tr>
  <tr>
