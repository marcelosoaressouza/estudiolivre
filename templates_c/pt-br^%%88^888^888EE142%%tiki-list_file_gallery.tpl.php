<?php /* Smarty version 2.6.18, created on 2011-04-04 18:20:40
...
">Listando a galeria: <?php echo $this->_tpl_vars['name']; ?>
</a></h1>

<table><tr>
<td style="vertical-align:top;">

<a href="tiki-file_galleries.php" class="linkbut" title="listar galerias">listar galerias</a>
...
" class="linkbut">carregar um arquivo</a>
<?php endif; ?>
...
<h2>Editar um arquivo usando esta forma</h2>
<div  align="center">
...
" />
<table class="normal">
<tr><td class="formcolor">Nome do arquivo:</td><td class="formcolor"><?php echo ((is_array($_tmp=$this->_tpl_vars['filename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td></tr>
<tr><td class="formcolor">Nome:</td><td class="formcolor"><input type="text" name="fname" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fname'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"/></td></tr>
<tr><td class="formcolor">Descrição:</td><td class="formcolor"><textarea rows="5" cols="40" name="fdescription"><?php echo ((is_array($_tmp=$this->_tpl_vars['fdescription'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td></tr>
<tr><td class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" value="editar" name="edit" /></td></tr>
</table>
</form>
</div>
<br />
...
&amp;watch_action=add"><?php echo smarty_function_html_image(array('file' => 'img/icons/icon_watch.png','border' => '0','alt' => 'monitorar essa galeria','title' => 'monitorar essa galeria'), $this);?>
</a>
		<?php else: ?>
			<a href="tiki-list_file_gallery.php?galleryId=<?php echo ((is_array($_tmp=$this->_tpl_vars['galleryId'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;galleryName=<?php echo ((is_array($_tmp=$this->_tpl_vars['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;watch_event=file_gallery_changed&amp;watch_object=<?php echo ((is_array($_tmp=$this->_tpl_vars['galleryId'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;watch_action=remove"><?php echo smarty_function_html_image(array('file' => 'img/icons/icon_unwatch.png','border' => '0','alt' => 'parar de monitorar essa galeria','title' => 'parar de monitorar essa galeria'), $this);?>
</a>
		<?php endif; ?>
	<?php endif; ?>  
...
<tr>	
	...
	<input type="image" name="movesel" src="img/icons/topic_move.gif" alt="mover" title="mover os arquivos selecionados" />
	<input type="image" name="delsel" src="img/icons/topic_delete.gif" alt="apagar" title="apagar os arquivos selecionados" />
...
<?php if ($this->_tpl_vars['gal_info']['show_icon'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-list_file_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filetype_desc'): ?>filetype_asc<?php else: ?>filetype_desc<?php endif; ?>">Tipo</a></td>
<?php endif; ?>
...
<td class="heading"><a class="tableheading" href="tiki-list_file_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filename_desc'): ?>filename_asc<?php else: ?>filename_desc<?php endif; ?>">Nome do arquivo</a></td>
<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>created_asc<?php else: ?>created_desc<?php endif; ?>">Criado em</a></td>
	<td  class="heading"><a class="tableheading" href="tiki-list_file_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">Criador</a></td>
<?php endif; ?>
...
"><img src='img/icons/edit.gif' border='0' alt="editar" title="editar" /></a>
