...
" />
		...
		<?php endif; ?>
		<div id="comButtons">
			<input type="submit" name="comments_previewComment" value="предпросмотр"/>
			<input type="submit" name="comments_postComment" value="Новое сообщение"/>
			
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="отмена" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	Используйте [http://www.foo.com] или [http://www.foo.com|описание] для ссылок.<br />
