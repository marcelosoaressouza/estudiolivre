<?php /* Smarty version 2.6.18, created on 2011-04-17 16:23:44
...
"><?php echo $this->_tpl_vars['arquivo']->user; ?>
		...
		<b>en:</b> <i><?php echo ((is_array($_tmp=$this->_tpl_vars['arquivo']->publishDate)) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</i><br/>
