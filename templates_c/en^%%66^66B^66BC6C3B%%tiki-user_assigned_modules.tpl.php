<?php /* Smarty version 2.6.18, created on 2011-06-06 12:50:48
...
<a class="linkbut" href="tiki-user_assigned_modules.php?recreate=1">Restore defaults</a><br /><br />

<div class="tabcontent">
	<div class="cbox-title">User assigned modules</div>
</div>
<div id="editMods">
	<table  class="normal">
		<tr>
...
"><img src='img/icons2/delete.gif' border='0' alt='unassign' title='unassign' /></a> 
				  <?php endif; ?>
				</td>
			</tr>
		<?php endfor; endif; ?>
...
<div class="tabcontent">
	<div class="cbox-title">Assign module</div>
</div>
		<table class="normal">
			<tr>
				<td class="formcolor">Module:</td>
				<td class="formcolor">
					<select name="module">
						<?php unset($this->_sections['ix']);
$this->_sections['ix']['name'] = 'ix';
...
"><?php echo $this->_tpl_vars['assignables'][$this->_sections['ix']['index']]['name']; ?>
			...
			<tr>
				<td class="formcolor">Position:</td>
				<td class="formcolor">
					<select name="order">
						<?php unset($this->_sections['ix']);
$this->_sections['ix']['name'] = 'ix';
...
"><?php echo $this->_tpl_vars['orders'][$this->_sections['ix']['index']]; ?>
			...
			<tr>
				...
				<td class="formcolor"><input type="submit" name="assign" value="assign" /></td>
			</tr>
		</table>
	</form>
<?php endif; ?>
