...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Azioni Moderatore</td>
					</tr>
					<tr>
						<td class="odd">
...
"><?php echo $this->_tpl_vars['topics'][$this->_sections['ix']['index']]['title']; ?>
							...
							<input type="submit" name="movesel" value="sposta" />
						</td>
...
">
									segnalati:<?php echo $this->_tpl_vars['reported']; ?>
...
">
								accodati:<?php echo $this->_tpl_vars['queued']; ?>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>rispondi<?php else: ?>repliche<?php endif; ?> below your current threshold
			<?php endif; ?>
	  		<div class="paginacao">
