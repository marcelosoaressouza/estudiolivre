<?php /* Smarty version 2.6.18, created on 2011-04-25 09:03:24
         compiled from styles/geral/head.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'breadcrumbs', 'styles/geral/head.tpl', 34, false),array('modifier', 'escape', 'styles/geral/head.tpl', 38, false),array('modifier', 'replace', 'styles/geral/head.tpl', 51, false),)), $this); ?>
<!-- head.tpl begin -->
...
" />
	  <?php endif; ?>
		...
		<script>preloadImgsNow('<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
');</script>
