<?php /* Smarty version 2.6.18, created on 2011-04-04 17:55:45
...
.
	...
	<p class="editdate">
	  ...
	  Last modification: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y at %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%Y at %H:%M")); ?>
