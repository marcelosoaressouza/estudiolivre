<?php /* Smarty version 2.6.18, created on 2011-06-08 09:41:38
...
<h2>Зареєструвати як нового користувача</h2>
<br />
<?php if ($this->_tpl_vars['showmsg'] == 'y'): ?>
<?php echo $this->_tpl_vars['msg']; ?>

<?php elseif ($this->_tpl_vars['notrecognized'] == 'y'): ?>
Адресу Вашої електронної пошти неможливо перевірити. Будь ласка, переконайтесь, що її вказано вірно натисніть на посилання реєстрації нижче.<br />
...
<small>Ваш реєстраційний код:</small>
<img src="tiki-random_num_img.php" alt='Випадкове зображення'/>
<br />
<?php endif; ?>
<form action="tiki-register.php" method="post"> <br />
<table class="normal">
<tr><td class="formcolor">Ім'я користувача:</td><td class="formcolor"><input type="text" name="name" /></td></tr>
<?php if ($this->_tpl_vars['useRegisterPasscode'] == 'y'): ?>
<tr><td class="formcolor">Пароль для реєстрації (не пароль користувача):</td><td class="formcolor"><input type="password" name="passcode" /></td></tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['rnd_num_reg'] == 'y'): ?>
<tr><td class="formcolor">Реєстраційний код:</td>
...
<tr><td class="formcolor">Пароль ще раз:</td><td class="formcolor"><input id='pass2' type="password" name="passAgain" /></td></tr>

<tr><td class="formcolor">Ел. пошта:</td><td class="formcolor"><input type="text" name="email" />
...
<tr><td  class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" name="register" value="зареєструвати" /></td></tr>

</table>
</form>
<br />
<table class="normal">
<tr><td class="formcolor"><a class="link" href="javascript:genPass('genepass','pass1','pass2');">Сгенерувати пароль</a></td>
