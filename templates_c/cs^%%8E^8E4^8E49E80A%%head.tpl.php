...
" />
	  <?php if ($this->_tpl_vars['feature_wiki'] == 'y' && $this->_tpl_vars['rss_wiki'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS pro Wiki" href="tiki-wiki_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_blogs'] == 'y' && $this->_tpl_vars['rss_blogs'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Blogy" href="tiki-blogs_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_articles'] == 'y' && $this->_tpl_vars['rss_articles'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Články" href="tiki-articles_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_galleries'] == 'y' && $this->_tpl_vars['rss_image_galleries'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Galerie obrázků" href="tiki-image_galleries_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_file_galleries'] == 'y' && $this->_tpl_vars['rss_file_galleries'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Kolekce souborů" href="tiki-file_galleries_rss.php?<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_forums'] == 'y' && $this->_tpl_vars['rss_forums'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Fóra" href="tiki-forums_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_maps'] == 'y' && $this->_tpl_vars['rss_mapfiles'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Mapy" href="tiki-map_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_directory'] == 'y' && $this->_tpl_vars['rss_directories'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Katalogy odkazů" href="tiki-directories_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
