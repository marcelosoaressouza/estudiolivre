<?php /* Smarty version 2.6.18, created on 2011-06-08 12:03:37
...
<small>あなたの登録コード:</small>
<img src="tiki-random_num_img.php" alt='Random Image'/>
<br />
<?php endif; ?>
<form action="tiki-register.php" method="post"> <br />
<table class="normal">
<tr><td class="formcolor">ユーザー名:</td><td class="formcolor"><input type="text" name="name" /></td></tr>
<?php if ($this->_tpl_vars['useRegisterPasscode'] == 'y'): ?>
<tr><td class="formcolor">登録パスコード（ユーザー・パスワードと違う）:</td><td class="formcolor"><input type="password" name="passcode" /></td></tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['rnd_num_reg'] == 'y'): ?>
<tr><td class="formcolor">登録コード:</td>
<td class="formcolor"><input type="text" maxlength="8" size="8" name="regcode" /></td></tr>
<?php endif; ?>

<tr><td class="formcolor">パスワード:</td><td class="formcolor"><input id='pass1' type="password" name="pass" /></td></tr>

<tr><td class="formcolor">パスワード(再入力):</td><td class="formcolor"><input id='pass2' type="password" name="passAgain" /></td></tr>

<tr><td class="formcolor">メールアドレス:</td><td class="formcolor"><input type="text" name="email" />
...
<tr><td  class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" name="register" value="新規登録" /></td></tr>

</table>
</form>
<br />
<table class="normal">
<tr><td class="formcolor"><a class="link" href="javascript:genPass('genepass','pass1','pass2');">パスワードの自動生成</a></td>
