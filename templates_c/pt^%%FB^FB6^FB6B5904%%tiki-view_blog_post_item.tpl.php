<?php /* Smarty version 2.6.18, created on 2011-04-05 04:50:33
...
"><?php echo $this->_tpl_vars['post']['user']; ?>
		...
		<?php if ($this->_tpl_vars['use_title'] == 'y'): ?>
			 ligado: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['post']['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
		<?php endif; ?>
