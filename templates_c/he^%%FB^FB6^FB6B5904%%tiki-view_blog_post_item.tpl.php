...
">
				...
				שם עמוד: <?php echo $this->_tpl_vars['pagenum']; ?>
...
"><?php echo $this->_tpl_vars['post']['user']; ?>
		...
		<?php if ($this->_tpl_vars['use_title'] == 'y'): ?>
			 בתאריך: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['post']['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
		<?php endif; ?>
...
) <?php if ($this->_tpl_vars['post']['comments'] == 1): ?>הערה<?php else: ?>הערות<?php endif; ?>
					</a>
				<?php endif; ?>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a class="link" href="tiki-view_blog_post.php?find=<?php echo $this->_tpl_vars['find']; ?>
