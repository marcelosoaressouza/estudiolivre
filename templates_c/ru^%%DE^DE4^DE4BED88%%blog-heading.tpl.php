...
<div id="blogHead">
	<h1 onmouseover="tooltip('<b>Блог Создано:</b> <?php echo $this->_tpl_vars['creator']; ?>
...
')" onmouseout="nd();">
		Блог: <a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['id']; ?>
...
.png');storeState('blogDescCont');">
			        Описание<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 сообщений | <?php echo $this->_tpl_vars['hits']; ?>
 посещений | Активность=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			Последние изменения: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>
