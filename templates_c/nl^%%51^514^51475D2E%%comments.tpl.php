...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Moderator acties</td>
					</tr>
					<tr>
						<td class="odd">
							<input type="submit" name="delsel" value="verwijder geselecteerde" />
						</td>
					</tr>
					<tr>
						<td class="odd">
							Verplaats naar onderwerp:
...
"><?php echo $this->_tpl_vars['topics'][$this->_sections['ix']['index']]['title']; ?>
							...
							<input type="submit" name="movesel" value="verplaatsen" />
						</td>
...
">
									gemelde:<?php echo $this->_tpl_vars['reported']; ?>
...
">
								in wachtrij geplaatste:<?php echo $this->_tpl_vars['queued']; ?>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>beantwoorden<?php else: ?>antwoorden<?php endif; ?> beneden de huidige limiet
			<?php endif; ?>
	  		<div class="paginacao">
...
/img/iArrowGreyLeft.png">
				...
				Pagina <?php echo $this->_tpl_vars['comments_actual_page']; ?>
