<?php /* Smarty version 2.6.18, created on 2011-04-05 00:18:31
...
<div id="blogHead">
	<h1 onmouseover="tooltip('<b>ブログ 製作者:</b> <?php echo $this->_tpl_vars['creator']; ?>
...
')" onmouseout="nd();">
		ブログ: <a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['id']; ?>
...
.png');storeState('blogDescCont');">
			        説明<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 ポスト数 | <?php echo $this->_tpl_vars['hits']; ?>
 閲覧数 | Activity=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			最終変更日時: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>
