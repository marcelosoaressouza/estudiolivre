<?php /* Smarty version 2.6.18, created on 2011-04-04 20:07:49
...
<div id='forumpost' <?php if (( $this->_tpl_vars['comment_preview'] != 'y' && $this->_tpl_vars['openpost'] != 'y' )): ?>style="display:none"<?php endif; ?>>
  ...
  <?php if ($this->_tpl_vars['comments_threadId'] > 0): ?>
    <h1>Editing comment: <?php echo ((is_array($_tmp=$this->_tpl_vars['comment_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</h1> 
    <?php endif; ?>
...
" />
      ...
      Title: <input type="text" name="comments_title" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['comment_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
	  Type: 
...
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
      ...
      <br>
      <input type="submit" name="comments_previewComment" value="preview"/>
      <input type="submit" name="comments_postComment" value="post"/>
      <input type="button" name="comments_postComment" value="cancel" onclick="window.location='tiki-view_forum.php?forumId=<?php echo ((is_array($_tmp=$this->_tpl_vars['forumId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
'"/>
    
    
    </form>
<br />
  <b>Posting comments:</b>
  <br />
  Use [http://www.foo.com] or [http://www.foo.com|description] for links<br />
  HTML tags are not allowed inside comments<br />
</div>
<br />
<?php endif; ?>
...
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'type_desc'): ?>type_asc<?php else: ?>type_desc<?php endif; ?>">type</a></td>
  
  <td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'title_desc'): ?>title_asc<?php else: ?>title_desc<?php endif; ?>">title</a></td>
...
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">reads</a></td>
  <?php endif; ?>
...
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'userName_desc'): ?>userName_asc<?php else: ?>userName_desc<?php endif; ?>" title="sort by">author</a></td>
  <?php endif; ?>
</tr>
...
"
     class="admlink"><?php echo smarty_function_html_image(array('file' => 'img/icons/edit.gif','border' => '0','alt' => 'edit','title' => 'edit'), $this);?>
</a>
   <?php endif; ?>
  <?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
...
&amp;comments_maxComments=<?php echo $this->_tpl_vars['comments_maxComments']; ?>
"
     class="admlink"><img src="img/icons2/delete.gif" border="0" width="16" height="16"  alt='remove' title='remove' /></a>
  <?php endif; ?>
...
<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
	...
	<tr>	
		...
		<input type="image" name="movesel" src="img/icons/topic_move.gif" border='0' alt='move' title='move selected topics' />
		<input type="image" name="unlocksel" src="img/icons/topic_unlock.gif" border='0' alt='unlock' title='unlock selected topics' />
		<input type="image" name="locksel" src="img/icons/topic_lock.gif" border='0' alt='lock' title='lock selected topics' />
		<input type="image" name="delsel" src="img/icons/topic_delete.gif" border='0' alt='delete' title='delete selected topics' />
...
<?php if ($this->_tpl_vars['forum_info']['forum_last_n'] > 0): ?>
	...
	<table class="normal">
	<tr>
	 	<td class="heading">Last <?php echo $this->_tpl_vars['forum_info']['forum_last_n']; ?>
...
" />
    ...
    <select name="time_control" onchange="javascript:document.getElementById('time_control').submit();">
    	<option value="" <?php if ($_REQUEST['time_control'] == ''): ?>selected="selected"<?php endif; ?>>All posts</option>
