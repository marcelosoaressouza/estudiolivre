<?php /* Smarty version 2.6.18, created on 2011-06-01 17:21:20
...
<table class="normal">
<tr><td class="formcolor">Username:</td><td class="formcolor"><input type="text" name="name" /></td></tr>
...
<tr><td class="formcolor">Password:</td><td class="formcolor"><input id='pass1' type="password" name="pass" /></td></tr>

<tr><td class="formcolor">Repeat password:</td><td class="formcolor"><input id='pass2' type="password" name="passAgain" /></td></tr>
...
<tr><td  class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" name="register" value="register" /></td></tr>

</table>
</form>
<br />
<table class="normal">
<tr><td class="formcolor"><a class="link" href="javascript:genPass('genepass','pass1','pass2');">Generate a password</a></td>
