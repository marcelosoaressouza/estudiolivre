<?php /* Smarty version 2.6.18, created on 2011-06-08 09:43:08
         compiled from styles/bolha/tiki-edit_help_tool.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'styles/bolha/tiki-edit_help_tool.tpl', 10, false),array('modifier', 'cat', 'styles/bolha/tiki-edit_help_tool.tpl', 24, false),array('modifier', 'default', 'styles/bolha/tiki-edit_help_tool.tpl', 24, false),array('function', 'cycle', 'styles/bolha/tiki-edit_help_tool.tpl', 24, false),array('block', 'tr', 'styles/bolha/tiki-edit_help_tool.tpl', 26, false),)), $this); ?>
<div class="quicktag">
	<?php echo '
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>' border='0' />
				...
				<?php endfor; endif; ?>
					<a title="спеціальні символи" class="link" href="#" onclick="javascript:window.open('tiki-special_chars.php?area_name=<?php echo $this->_tpl_vars['area_name']; ?>
','','menubar=no,width=252,height=25');">
					<img src='images/ed_charmap.gif' alt='спеціальні символи' title='спеціальні символи' border='0' /></a>
		</div>
