      		...
      		<div id="precisaLogar" class="none" style="width:200px;padding:5px">
      			...
      			Se for cadastrado, efetue o login:<br>
					    ...
					    <form id="uLoginBox" action="tiki-login.php" method="post">
					      ...
					      <input class="uText" type="text" name="user" id="login-user" size="12" value="utilisateur" onFocus="this.value=''"/>
					      senha:<input class="uText" type="<?php if ($this->_tpl_vars['isIE']): ?>password<?php else: ?>text<?php endif; ?>" name="pass" id="login-pass" size="<?php if ($this->_tpl_vars['isIE']): ?>8<?php else: ?>10<?php endif; ?>" <?php if (! $this->_tpl_vars['isIE']): ?>value="mot de passe" onFocus="this.value='';this.type='password'"<?php endif; ?>/>
...
/img/iLogin.png" />      
					      <div id="uLoginOptions">
					        <a href="tiki-remind_password.php">&raquo; recuperar mot de passe</a><br>
					      </div>
					   </form>
