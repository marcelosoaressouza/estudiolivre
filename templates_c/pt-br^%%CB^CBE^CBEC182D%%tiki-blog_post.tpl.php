<?php /* Smarty version 2.6.18, created on 2011-06-23 10:51:33
         compiled from styles/obscur/tiki-blog_post.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'popup_init', 'styles/obscur/tiki-blog_post.tpl', 1, false),array('modifier', 'escape', 'styles/obscur/tiki-blog_post.tpl', 42, false),)), $this); ?>
	...
	<div id="blogPostPrev">
		<h3>
			<span class="pointer" onclick="javascript:flip('postPrevCont');toggleImage(document.getElementById('TArrowBlogPr'),'iArrowGreyRight.png');">
				<img id="TArrowBlogPr" src="styles/estudiolivre/iArrowGreyDown.png" />Pré-visualização
			</span>
		</h3>
