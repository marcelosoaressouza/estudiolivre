<?php /* Smarty version 2.6.18, created on 2011-04-05 22:44:31
...
">画像の閲覧: <span class="noslideshow"><?php echo $this->_tpl_vars['name']; ?>
...
"
		class="gallink"<?php if ($this->_tpl_vars['imageId'] == $this->_tpl_vars['firstId']): ?> style="display: none;"<?php endif; ?>><?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_first.gif','border' => 'none','alt' => '最初の画像','title' => '最初の画像'), $this);?>
</a>
...
" class="gallink"><?php echo smarty_function_html_image(array('file' => 'img/icons/zoom-.gif','border' => 'none','alt' => '小さく','title' => '小さく'), $this);?>
</a>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['resultscale']): ?>
	  <a href="<?php echo $this->_tpl_vars['url_base']; ?>
<?php echo $this->_tpl_vars['imageId']; ?>
&amp;scalesize=0" class="gallink"><?php echo smarty_function_html_image(array('file' => 'img/icons/zoom_equal.gif','border' => 'none','alt' => '元のサイズ','title' => '元のサイズ'), $this);?>
</a>
	<?php endif; ?>
...
" class="gallink"><?php echo smarty_function_html_image(array('file' => 'img/icons/zoom+.gif','border' => 'none','alt' => '大きく','title' => '大きく'), $this);?>
</a>
	<?php endif; ?>
...
<?php echo $this->_tpl_vars['same_scale']; ?>
"
    	class="gallink" style="padding-right:6px;<?php if (! $this->_tpl_vars['previmg']): ?> display: none;<?php endif; ?>">    	<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_dot_right.gif','border' => 'none','alt' => '前の画像','title' => '前の画像'), $this);?>
</a>
 ...
 class="gallink">
        <?php echo smarty_function_html_image(array('file' => 'img/icons2/admin_unhide.gif','border' => 'none','alt' => 'ポップアップ ウィンドウ','title' => 'ポップアップ ウィンドウ'), $this);?>
</a>
	<?php endif; ?>
...
<?php echo $this->_tpl_vars['same_scale']; ?>
"
    	class="gallink" style="padding-left:6px;<?php if (! $this->_tpl_vars['nextimg']): ?> display: none;<?php endif; ?>">    	<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_dot_left.gif','border' => 'none','alt' => '次の画像','title' => '次の画像'), $this);?>
</a>
...
<?php echo $this->_tpl_vars['same_scale']; ?>
"
		class="gallink"<?php if ($this->_tpl_vars['imageId'] == $this->_tpl_vars['lastId']): ?> style="display: none;"<?php endif; ?>><?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_last.gif','border' => 'none','alt' => '最後の画像','title' => '最後の画像'), $this);?>
</a>    
  </div>
...
<?php if ($this->_tpl_vars['popup'] == ""): ?>
  ...
  <table class="normal noslideshow">
	<tr><td class="odd">画像名:</td><td class="odd"><?php echo $this->_tpl_vars['name']; ?>
</td></tr>
	<tr><td class="even">作成日:</td><td class="even"><?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
</td></tr>
...
<?php else: ?>元のサイズ<?php endif; ?></td></tr>
	<tr><td class="odd">ヒット数:</td><td class="odd"><?php echo $this->_tpl_vars['hits']; ?>
</td></tr>
	<tr><td class="even">説明:</td><td class="even"><?php echo $this->_tpl_vars['description']; ?>
</td></tr>
	<?php if ($this->_tpl_vars['feature_maps'] == 'y'): ?>
  	...
  	<?php endif; ?>
	<tr><td class="odd">著者:</td><td class="odd"><?php echo $this->_tpl_vars['image_user']; ?>
</td></tr>
	<?php if ($this->_tpl_vars['tiki_p_admin_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['user'] == $this->_tpl_vars['owner'] )): ?>
	  <tr><td class="even">画像の移動:</td><td class="odd">
...
" <?php if ($this->_tpl_vars['galleries'][$this->_sections['idx']['index']]['id'] == $this->_tpl_vars['galleryId']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['galleries'][$this->_sections['idx']['index']]['name']; ?>
		...
		<input type="submit" name="move_image" value="移動" />
	  </form>
	  </td></tr>
	<?php endif; ?>
  </table>
