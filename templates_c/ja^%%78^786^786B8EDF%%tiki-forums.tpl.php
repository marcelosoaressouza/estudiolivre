<?php /* Smarty version 2.6.18, created on 2011-04-15 15:36:32
...
<div id="forum">
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=forums" title="Configure/Options">
				<?php echo smarty_function_html_image(array('file' => 'img/icons/config.gif','border' => '0','alt' => "Configure/Options"), $this);?>
...
">
						<img src="img/icons/config.gif" border="0" width="16" height="16" alt='Configure/Options' />
					</a>
				<?php endif; ?>
