<?php /* Smarty version 2.6.18, created on 2011-04-05 09:44:26
...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="vytiskni" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
">id stránky: <?php echo $this->_tpl_vars['page_id']; ?>
</a></small>
	<?php endif; ?>
	<?php echo smarty_function_breadcrumbs(array('type' => 'desc','loc' => 'page','crumbs' => $this->_tpl_vars['crumbs']), $this);?>

	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(v keši)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Předchozí stránka" 
...
"><img src="img/icons2/nav_home.gif" border="0" height="11" width="13" alt="Nadřazená stránka" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Další stránka" 
...
" />
	      ...
	      <?php else: ?>
	      <input type="checkbox" name="add_child" /> Potomek
	      <?php endif; ?>      
	      <input type="submit" name="insert_into_struct" value="Přidat stránku" />
	    </form>
	<?php endif; ?>
	  </td>
	</tr>
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="První stránka" title="První stránka" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Předchozí stránka" title="Předchozí stránka" /></a>
	
			<small>stránka:<?php echo $this->_tpl_vars['pagenum']; ?>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Další stránka" title="Další stránka" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Poslední stránka" title="Poslední stránka" /></a>
		</div>
	<?php endif; ?>
	</div> 
	...
	<p class="editdate">
	  Naposledy upravil(a) <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
...
?>
	   <?php if ($this->_sections['author']['first']): ?>, založeno na práci uživatele
	   <?php else: ?>
	  ...
	  <?php endfor; endif; ?>.<br />                                         
	  Stránka byla naposledy změněna v(e) <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
.
	</p>
	<?php elseif (isset ( $this->_tpl_vars['wiki_authors_style'] ) && $this->_tpl_vars['wiki_authors_style'] == 'collaborative'): ?>
	<p class="editdate">
	  Přispěvovatelé této stránky: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />
	  Stránka byla naposledy změněna v(e) <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
 uživatelem: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
.
	</p>
...
</i>, uživatelem:: <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
"><?php echo $this->_tpl_vars['lastUser']; ?>
</a>
	</p>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Upravit upozornění o copyrightu <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">klikněte zde</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">Obsah této stránky smí být šířen podle pravidel licence <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    Původní dokument je k dispozici na:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
