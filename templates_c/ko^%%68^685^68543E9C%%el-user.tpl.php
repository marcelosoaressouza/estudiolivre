<?php /* Smarty version 2.6.18, created on 2011-04-05 10:55:34
 ...
 ?>
	   			...
	   			<?php if ($this->_tpl_vars['permission']): ?>
					<div id="ajax-elIce" style="display:none;">
						...
						<input type="button" onClick="xajax_set_mount_point(document.getElementById('ajax-livePoint').value,document.getElementById('ajax-livePass').value)" value="제출"/><input type="button" onClick="flip('ajax-elIce')" value="취소"/>
						<br/>
