<?php /* Smarty version 2.6.18, created on 2011-05-31 15:34:33
...
">
					<img src='img/icons2/nav_first.gif' border='0' alt='První stránka' title='První stránka' />
				</a>
...
">
					<img src='img/icons2/nav_dot_right.gif' border='0' alt='Předchozí stránka' title='Předchozí stránka' />
				</a>
		
				stránka: <?php echo $this->_tpl_vars['pagenum']; ?>
...
">
					<img src='img/icons2/nav_dot_left.gif' border='0' alt='Další stránka' title='Další stránka' />
				</a>
...
">
					<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_last.gif','border' => '0','alt' => 'Poslední stránka','title' => 'Poslední stránka'), $this);?>
...
&type=blog post"><?php echo $this->_tpl_vars['tag']; ?>
	...
	<div class="postbottom">
		zaslal(/a):<i> <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['post']['user']; ?>
"><?php echo $this->_tpl_vars['post']['user']; ?>
</a></i>
		 
		<?php if ($this->_tpl_vars['use_title'] == 'y'): ?>
			 v(e): <i><?php echo ((is_array($_tmp=$this->_tpl_vars['post']['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
		<?php endif; ?>
...
&amp;postId=<?php echo $this->_tpl_vars['post']['postId']; ?>
">
				Číst více (<?php echo $this->_tpl_vars['post']['pages']; ?>
 stránky)
				</a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
			<?php endif; ?>
...
) <?php if ($this->_tpl_vars['post']['comments'] == 1): ?>komentář<?php else: ?>komentáře(/ů)<?php endif; ?>
					</a>
				<?php endif; ?>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a class="link" href="tiki-view_blog_post.php?find=<?php echo $this->_tpl_vars['find']; ?>
			...
			<?php if ($this->_tpl_vars['feature_blogposts_comments'] == 'y' && $this->_tpl_vars['blog_data']['allow_comments'] == 'y' && ( ( $this->_tpl_vars['tiki_p_read_comments'] == 'y' && $this->_tpl_vars['comments_cant'] != 0 ) || $this->_tpl_vars['tiki_p_post_comments'] == 'y' || $this->_tpl_vars['tiki_p_edit_comments'] == 'y' )): ?>
				...
				<a href="#comments" onclick="javascript:flip('comzone<?php if ($this->_tpl_vars['comments_show'] == 'y'): ?>open<?php endif; ?>');" class="linkbut">
					<?php if ($this->_tpl_vars['comments_cant'] == 1): ?>
						<span class="highlight">1 komentář</span>
					<?php else: ?>
