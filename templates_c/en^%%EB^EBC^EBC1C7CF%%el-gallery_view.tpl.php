...
<div id="info">
	<div id="author">
		<b>author:</b> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'id' => 'author','value' => $this->_tpl_vars['arquivo']->author,'default' => 'Autor da Obra','display' => 'inline'), $this);?>
<br/>
		<b>by:</b> <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['arquivo']->user; ?>
"><?php echo $this->_tpl_vars['arquivo']->user; ?>
</a>
		<b>on:</b> <i><?php echo ((is_array($_tmp=$this->_tpl_vars['arquivo']->publishDate)) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
</i><br/>
...
/img/iArrowGreyDown.png">
					<h1>Comments (<span id="ajax-commentCount"><?php echo $this->_tpl_vars['comments']; ?>
</span>)</h1>
				</span>
			</div>
...
unset($_smarty_tpl_vars);
 ?>
			...
			<div id="aCommentSend" style="display:block">
				...
				<div id="uMsgSend">
					<input type="submit" value="send" label="enviar" id="uMsgSendSubmit" onClick="xajax_comment(document.getElementById('uMsgSendInput').value);" />
