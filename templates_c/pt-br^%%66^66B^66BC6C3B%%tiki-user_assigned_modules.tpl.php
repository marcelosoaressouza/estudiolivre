<?php /* Smarty version 2.6.18, created on 2011-04-08 19:39:12
...
<a class="linkbut" href="tiki-user_assigned_modules.php?recreate=1">Restaurar padrões</a><br /><br />

<div class="tabcontent">
	<div class="cbox-title">Módulos atribuídos pel@ usuári@</div>
</div>
<div id="editMods">
	<table  class="normal">
		<tr>
...
"><img src='img/icons2/down.gif' alt='descer' title='descer' border='0' /></a>
				</td>
...
"><img src='img/icons2/delete.gif' border='0' alt='não atribuir mais' title='não atribuir mais' /></a> 
				  <?php endif; ?>
				</td>
			</tr>
		<?php endfor; endif; ?>
...
<div class="tabcontent">
	<div class="cbox-title">Definir módulo</div>
</div>
		<table class="normal">
			<tr>
...
"><?php echo $this->_tpl_vars['orders'][$this->_sections['ix']['index']]; ?>
			...
			<tr>
				...
				<td class="formcolor"><input type="submit" name="assign" value="atribuir" /></td>
			</tr>
		</table>
	</form>
<?php endif; ?>
