...
<?php $this->_tag_stack[] = array('tikimodule', array('title' => 'Acervo','name' => 'el_gallery','flip' => $this->_tpl_vars['module_params']['flip'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
#gallery">Meus arquivos</a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><br>
	    	<?php $this->_tag_stack[] = array('tooltip', array('text' => "Publique <b>sua obra</b> no Estúdio Livre!")); $_block_repeat=true;smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><a href="el-gallery_upload.php">Publicar</a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
	    </div>
	   <?php if (! preg_match ( "/el-gallery_upload.php/" , $this->_tpl_vars['current_location'] ) && sizeof ( $this->_tpl_vars['pendingUploadFiles'] ) > 0): ?>
  	    <hr>
	 		<span style="text-align:left">Arquivos não publicados:</span><br/>
