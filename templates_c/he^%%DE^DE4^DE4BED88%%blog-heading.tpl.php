<?php /* Smarty version 2.6.18, created on 2011-06-12 07:41:32
...
<div id="blogHead">
	<h1 onmouseover="tooltip('<b>בלוג נוצר על ידי:</b> <?php echo $this->_tpl_vars['creator']; ?>
 <br><b> בתאריך :</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m/%y") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m/%y")); ?>
')" onmouseout="nd();">
		בלוג: <a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['id']; ?>
...
.png');storeState('blogDescCont');">
			        תאור<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 הודעות | <?php echo $this->_tpl_vars['hits']; ?>
 כניסות | פעילות=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			תאריך שינוי אחרון: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>
