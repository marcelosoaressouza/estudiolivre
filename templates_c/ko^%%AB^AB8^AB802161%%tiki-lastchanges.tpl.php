<?php /* Smarty version 2.6.18, created on 2011-05-30 22:06:25
...
<div id="listLastChanges">
	<h1>
		...
		<?php else: ?> 
			최신 변경들 &nbsp;&nbsp;&nbsp; <a href="tiki-wiki_rss.php?ver=2"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iRss.png"></a>
		<?php endif; ?>
	</h1>
