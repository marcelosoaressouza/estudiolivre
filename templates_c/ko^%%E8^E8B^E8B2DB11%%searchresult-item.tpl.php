<?php /* Smarty version 2.6.18, created on 2011-04-06 23:18:35
...
<div class="searchResultItem">
	...
	<?php $this->_tag_stack[] = array('tooltip', array('text' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tiptext'])) ? $this->_run_mod_handler('cat', true, $_tmp, " - 조회수: ") : smarty_modifier_cat($_tmp, " - 조회수: ")))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['result']['hits']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['result']['hits'])))); $_block_repeat=true;smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
