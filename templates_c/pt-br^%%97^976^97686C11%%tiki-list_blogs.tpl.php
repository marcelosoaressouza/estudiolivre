<?php /* Smarty version 2.6.18, created on 2011-06-23 10:47:17
         compiled from styles/obscur/tiki-list_blogs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'styles/obscur/tiki-list_blogs.tpl', 80, false),array('block', 'tooltip', 'styles/obscur/tiki-list_blogs.tpl', 85, false),array('modifier', 'cat', 'styles/obscur/tiki-list_blogs.tpl', 85, false),array('modifier', 'regex_replace', 'styles/obscur/tiki-list_blogs.tpl', 85, false),array('modifier', 'truncate', 'styles/obscur/tiki-list_blogs.tpl', 91, false),array('modifier', 'userlink', 'styles/obscur/tiki-list_blogs.tpl', 104, false),array('modifier', 'avatarize', 'styles/obscur/tiki-list_blogs.tpl', 108, false),array('modifier', 'date_format', 'styles/obscur/tiki-list_blogs.tpl', 123, false),array('modifier', 'escape', 'styles/obscur/tiki-list_blogs.tpl', 167, false),array('modifier', 'times', 'styles/obscur/tiki-list_blogs.tpl', 216, false),)), $this); ?>
<div id="blogs">
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=blogs">
				<img src='img/icons/config.gif' border='0'  alt="configurar a listagem" title="configurar a listagem" />
			</a>
		<?php endif; ?>
	</h1>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'title_desc'): ?>title_asc<?php else: ?>title_desc<?php endif; ?>">
						<img src="styles/estudiolivre/sort<?php if ($this->_tpl_vars['sort_mode'] == 'title_desc'): ?>ArrowUp<?php elseif ($this->_tpl_vars['sort_mode'] == 'title_asc'): ?>ArrowDown<?php else: ?>GreyArrowDown<?php endif; ?>.png">
					</a>Título
				</td>
			<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">
						<img src="styles/estudiolivre/sort<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>ArrowUp<?php elseif ($this->_tpl_vars['sort_mode'] == 'user_asc'): ?>ArrowDown<?php else: ?>GreyArrowDown<?php endif; ?>.png">
					</a>Usuári@
				</td>
			<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>created_asc<?php else: ?>created_desc<?php endif; ?>">
						<img src="styles/estudiolivre/sort<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>ArrowUp<?php elseif ($this->_tpl_vars['sort_mode'] == 'created_asc'): ?>ArrowDown<?php else: ?>GreyArrowDown<?php endif; ?>.png">
					</a>Criado em
				</td>
			<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'lastModif_desc'): ?>lastModif_asc<?php else: ?>lastModif_desc<?php endif; ?>">
						<img src="styles/estudiolivre/sort<?php if ($this->_tpl_vars['sort_mode'] == 'lastModif_desc'): ?>ArrowUp<?php elseif ($this->_tpl_vars['sort_mode'] == 'lastModif_asc'): ?>ArrowDown<?php else: ?>GreyArrowDown<?php endif; ?>.png">
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'posts_desc'): ?>posts_asc<?php else: ?>posts_desc<?php endif; ?>">
						<img src="styles/estudiolivre/sort<?php if ($this->_tpl_vars['sort_mode'] == 'posts_desc'): ?>ArrowUp<?php elseif ($this->_tpl_vars['sort_mode'] == 'posts_asc'): ?>ArrowDown<?php else: ?>GreyArrowDown<?php endif; ?>.png">
					</a>Mensagens
				</td>
			<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">
						<img src="styles/estudiolivre/sort<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>ArrowUp<?php elseif ($this->_tpl_vars['sort_mode'] == 'hits_asc'): ?>ArrowDown<?php else: ?>GreyArrowDown<?php endif; ?>.png">
					</a>Visitas
				</td>
			<?php endif; ?>
...
">
								<img title='editar' alt='editar' src='img/icons/config.gif' />
							</a>
						<?php endif; ?>
					<?php endif; ?>
...
">
									<img title='enviar' alt='enviar' src='img/icons/edit.gif' />
								</a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
...
">
								<img title='permissões ativas' alt='permissões ativas' src='img/icons/key_active.gif' />
							</a>
							</td>
					    <?php else: ?>
					    	<td>
...
&amp;objectType=blog&amp;permType=blogs&amp;objectId=<?php echo $this->_tpl_vars['listpages'][$this->_sections['changes']['index']]['blogId']; ?>
">
								<img title='permissões' alt='permissões' src='img/icons/key.gif' />
							</a>
							</td>
					    <?php endif; ?>
					<?php endif; ?>		
...
">
		                      	<img title='remover' alt='remover' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
