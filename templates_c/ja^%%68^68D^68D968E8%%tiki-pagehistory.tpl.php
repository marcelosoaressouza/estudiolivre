<?php /* Smarty version 2.6.18, created on 2011-04-04 18:25:07
...
<?php endif; ?>" title="履歴">履歴: <?php echo $this->_tpl_vars['page']; ?>
</a></h1>
...
" class="linkbut" title="表示">View page</a></div>
...
" title="ロールバック">rollback to this version</a></div>
<?php endif; ?>
...
" title="表示"><?php echo $this->_tpl_vars['old']['version']; ?>
</a><?php if ($this->_tpl_vars['old']['version'] == $this->_tpl_vars['info']['version']): ?> (現在)</a><?php endif; ?></b></th>
  <th colspan="2"><b>Version: <a href="tiki-pagehistory.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;preview=<?php echo $this->_tpl_vars['new']['version']; ?>
" title="表示"><?php echo $this->_tpl_vars['new']['version']; ?>
<?php if ($this->_tpl_vars['new']['version'] == $this->_tpl_vars['info']['version']): ?> (現在)</a><?php endif; ?></b></th>
</tr>
<tr>
...
<?php else: ?>Versions are identical</td></tr></table><?php endif; ?>
<?php endif; ?>
<br />

<?php if (( ! isset ( $this->_tpl_vars['noHistory'] ) )): ?>                                              
<?php if ($this->_tpl_vars['preview'] || $this->_tpl_vars['source'] || $this->_tpl_vars['diff_style']): ?><h2>履歴</h2><?php endif; ?>
...
<tr>
<?php if ($this->_tpl_vars['tiki_p_remove'] == 'y'): ?><th class="heading"><input type="submit" name="delete" value="削除" /></th><?php endif; ?>
<th class="heading">日付</th>
<th class="heading">ユーザー</th>
<?php if ($this->_tpl_vars['feature_wiki_history_ip'] != 'n'): ?><th class="heading">Ip</th><?php endif; ?>
<th class="heading">コメント</th>
<th class="heading">バージョン</th>
<th class="heading">操作</th>
<?php if ($this->_tpl_vars['default_wiki_diff_style'] != 'old' && $this->_tpl_vars['history']): ?>
<th class="heading" colspan="2">
<input type="submit" name="compare" value="比較" /><br />
</th>
<?php endif; ?>
</tr>
<tr>
...
<?php if ($this->_tpl_vars['default_wiki_diff_style'] != 'old' && $this->_tpl_vars['history']): ?>
<td class="odd button"><input type="radio" name="oldver" value="0" title="比較" <?php if ($this->_tpl_vars['old']['version'] == $this->_tpl_vars['info']['version']): ?>checked="checked"<?php endif; ?> /></td>
<td class="odd button"><input type="radio" name="newver" value="0" title="比較" <?php if ($this->_tpl_vars['new']['version'] == $this->_tpl_vars['info']['version'] || ! $this->_tpl_vars['diff_style']): ?>checked="checked"<?php endif; ?>  /></td>
<?php endif; ?>
</tr>
...
&amp;diff_style=sideview" title="比較">c</a>
&nbsp;<a class="link" href="tiki-pagehistory.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;diff2=<?php echo $this->_tpl_vars['history'][$this->_sections['hist']['index']]['version']; ?>
&amp;diff_style=unidiff" title="違い">d</a>
<?php endif; ?>
