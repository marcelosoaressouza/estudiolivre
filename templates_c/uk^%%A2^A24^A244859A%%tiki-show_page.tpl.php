<?php /* Smarty version 2.6.18, created on 2011-04-04 20:09:17
...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="друк" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
">page id: <?php echo $this->_tpl_vars['page_id']; ?>
	...
	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(кешовано)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Попередня стор" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Наступна стор" 
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Перша стор" title="Перша стор" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Попередня стор" title="Попередня стор" /></a>
	
			<small>стор.:<?php echo $this->_tpl_vars['pagenum']; ?>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Наступна стор" title="Наступна стор" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Остання стор" title="Остання стор" /></a>
		</div>
	<?php endif; ?>
	</div> 
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Щоб редагувати запис авторських прав <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">натисніть тут</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">Вміст цієї сторінки підлягає ліцензуванню на умовах  <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    Оригінал документу знаходиться на:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
