<?php /* Smarty version 2.6.18, created on 2011-04-06 01:25:47
...
<h5>
  <?php if ($this->_tpl_vars['tiki_p_forum_post_topic'] == 'y'): ?>
	<span class="pointer" onclick="flip('forumpost');"/>새 글 쓰기</span>
  	&nbsp;|&nbsp;
  <?php endif; ?>
...
&amp;watch_action=add"><img border='0' alt='monitor this forum' src='img/icons/icon_watch.png' /></a>
	<?php else: ?>
		<a href="tiki-view_forum.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
&amp;watch_event=forum_post_topic&amp;watch_object=<?php echo $this->_tpl_vars['forumId']; ?>
&amp;watch_action=remove"><img border='0' alt='stop monitoring this forum' src='img/icons/icon_unwatch.png' /></a>
	<?php endif; ?>
<?php endif; ?>
...
<div id='forumpost' <?php if (( $this->_tpl_vars['comment_preview'] != 'y' && $this->_tpl_vars['openpost'] != 'y' )): ?>style="display:none"<?php endif; ?>>
	<?php if ($this->_tpl_vars['comment_preview'] == 'y'): ?>
		...
		<div class="forumpost">
			...
			<div class="postbottom">
				게시자: <?php echo $this->_tpl_vars['user']; ?>
  ...
  <br /><br />
  <div class="commentsedithelp"><br /><b>You have to enter a title and text!</b><br /><br />
  </div>
  <br />
  <?php endif; ?>
  ...
  <?php if ($this->_tpl_vars['comments_threadId'] > 0): ?>
    <h1>댓글 수정: <?php echo ((is_array($_tmp=$this->_tpl_vars['comment_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</h1> 
    <?php endif; ?>
...
" />
      ...
      제목: <input type="text" name="comments_title" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['comment_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
	  종류: 
	  	<select name="comment_topictype">
	      <option value="n" <?php if ($this->_tpl_vars['comment_topictype'] == 'n'): ?>selected="selected"<?php endif; ?>>보통</option>
	      <?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
		      ...
		      <option value="l" <?php if ($this->_tpl_vars['comment_topictype'] == 'l'): ?>selected="selected"<?php endif; ?>>잠김</option>
	      <?php endif; ?>
	   </select>
...
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
      ...
      <br>
      <input type="submit" name="comments_previewComment" value="미리보기"/>
      <input type="submit" name="comments_postComment" value="게시"/>
      <input type="button" name="comments_postComment" value="취소" onclick="window.location='tiki-view_forum.php?forumId=<?php echo ((is_array($_tmp=$this->_tpl_vars['forumId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
'"/>
...
<br />
  <b>게시에 대한 설명:</b>
  <br />
  URL 링크사용법: [http://www.foo.com] 혹은 [http://www.foo.com|description] <br />
  댓글에서는 HTML문법이 지원되지 않습니다<br />
</div>
<br />
<?php endif; ?>
...
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'type_desc'): ?>type_asc<?php else: ?>type_desc<?php endif; ?>">종류</a></td>
  
  <td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'title_desc'): ?>title_asc<?php else: ?>title_desc<?php endif; ?>">제목</a></td>
  <?php if ($this->_tpl_vars['forum_info']['topics_list_replies'] == 'y'): ?>
  	<td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'replies_desc'): ?>replies_asc<?php else: ?>replies_desc<?php endif; ?>">답변</a></td>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['forum_info']['topics_list_reads'] == 'y'): ?>
  	<td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">읽음</a></td>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['forum_info']['topics_list_lastpost'] == 'y'): ?>
  	<td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'lastPost_desc'): ?>lastPost_asc<?php else: ?>lastPost_desc<?php endif; ?>">마지막 게시물</a></td>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['forum_info']['topics_list_author'] == 'y'): ?>
  	<td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'userName_desc'): ?>userName_asc<?php else: ?>userName_desc<?php endif; ?>" title="sort by">글쓴이</a></td>
  <?php endif; ?>
</tr>
...
"
     class="admlink"><?php echo smarty_function_html_image(array('file' => 'img/icons/edit.gif','border' => '0','alt' => '수정','title' => '수정'), $this);?>
</a>
   <?php endif; ?>
  <?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
...
&amp;comments_maxComments=<?php echo $this->_tpl_vars['comments_maxComments']; ?>
"
     class="admlink"><img src="img/icons2/delete.gif" border="0" width="16" height="16"  alt='삭제' title='삭제' /></a>
  <?php endif; ?>
...
<?php endfor; else: ?>
<tr>
	<td class="odd" colspan="8">표시할 글이 없습니다</td>
</tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
	<tr>
	...
	<tr>
		<td class="heading" colspan='18'>중재자 기능들</td>
	</tr>
	<tr>	
		<td class="odd" colspan="3">
		<input type="image" name="movesel" src="img/icons/topic_move.gif" border='0' alt='이동' title='move selected topics' />
		<input type="image" name="unlocksel" src="img/icons/topic_unlock.gif" border='0' alt='잠금해제' title='선택된 글들의 잠금 해제' />
		<input type="image" name="locksel" src="img/icons/topic_lock.gif" border='0' alt='잠금' title='선택된 글들을 잠금' />
		<input type="image" name="delsel" src="img/icons/topic_delete.gif" border='0' alt='삭제' title='delete selected topics' />
...
">요청된 메시지들:<?php echo $this->_tpl_vars['queued']; ?>
</a></small>
		</td>
	</tr>
...
"><?php echo $this->_tpl_vars['all_forums'][$this->_sections['ix']['index']]['name']; ?>
		...
		<input type='submit' name='movesel' value='이동' />
...
/img/iArrowGreyLeft.png">
			...
			페이지 <?php echo $this->_tpl_vars['comments_actual_page']; ?>
...
<?php if ($this->_tpl_vars['forum_info']['forum_last_n'] > 0): ?>
	...
	<table class="normal">
	<tr>
	 	<td class="heading">마지막 <?php echo $this->_tpl_vars['forum_info']['forum_last_n']; ?>
 topics in this forum</td>
	 	<?php unset($this->_sections['ix']);
$this->_sections['ix']['name'] = 'ix';
...
" />
    <input type="hidden" name="forumId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['forumId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
    <small>게시물 표시 옵션:</small>
    <select name="time_control" onchange="javascript:document.getElementById('time_control').submit();">
    	<option value="" <?php if ($_REQUEST['time_control'] == ''): ?>selected="selected"<?php endif; ?>>모든 게시물</option>
    	<option value="3600" <?php if ($_REQUEST['time_control'] == 3600): ?>selected="selected"<?php endif; ?>>마지막 1시간</option>
    	<option value="86400" <?php if ($_REQUEST['time_control'] == 86400): ?>selected="selected"<?php endif; ?>>마지막 24시간</option>
    	<option value="172800" <?php if ($_REQUEST['time_control'] == 172800): ?>selected="selected"<?php endif; ?>>마지막 48시간</option>
    </select>
</form>
</td>
