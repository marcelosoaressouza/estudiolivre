<?php /* Smarty version 2.6.18, created on 2011-05-02 18:35:42
         compiled from styles/obscur/modules/mod-user_blogs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tikimodule', 'styles/obscur/modules/mod-user_blogs.tpl', 5, false),array('modifier', 'truncate', 'styles/obscur/modules/mod-user_blogs.tpl', 7, false),)), $this); ?>


<?php if ($this->_tpl_vars['user']): ?>
    <?php if ($this->_tpl_vars['feature_blogs'] == 'y'): ?>
		<?php $this->_tag_stack[] = array('tikimodule', array('title' => 'Meus Blogs','name' => 'user_blogs','flip' => $this->_tpl_vars['module_params']['flip'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
