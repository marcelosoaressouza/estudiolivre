<?php /* Smarty version 2.6.18, created on 2011-04-08 19:28:54
...
" class="wiki"><?php echo $this->_tpl_vars['likepages'][$this->_sections['back']['index']]; ?>
	...
	<?php else: ?>
		No hay páginas wiki similares a '<?php echo $this->_tpl_vars['page']; ?>
'
			<br/><br/>
	<?php endif; ?>
...
" class="linkmenu">Crear ésta página</a>
	(la página quedará huérfana)<br /><br/>
<?php endif; ?>
<a href="javascript:history.back()" class="linkmenu">Atras</a><br /><br />
<a href="<?php echo $this->_tpl_vars['tikiIndex']; ?>
" class="linkmenu">Volver al inicio</a>