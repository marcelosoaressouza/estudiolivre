...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Moderator actions</td>
					</tr>
					<tr>
						<td class="odd">
...
"><?php echo $this->_tpl_vars['topics'][$this->_sections['ix']['index']]['title']; ?>
							...
							<input type="submit" name="movesel" value="הזזה" />
						</td>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>מענה<?php else: ?>תגובות<?php endif; ?> below your current threshold
			<?php endif; ?>
	  		<div class="paginacao">
...
/img/iArrowGreyLeft.png">
				...
				עמוד <?php echo $this->_tpl_vars['comments_actual_page']; ?>
