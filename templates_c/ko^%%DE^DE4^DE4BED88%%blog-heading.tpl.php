<?php /* Smarty version 2.6.18, created on 2011-04-05 20:49:11
...
<div id="blogHead">
	<h1 onmouseover="tooltip('<b>블로그 생성자:</b> <?php echo $this->_tpl_vars['creator']; ?>
 <br><b> on :</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m/%y") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m/%y")); ?>
')" onmouseout="nd();">
		블로그: <a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['id']; ?>
...
.png');storeState('blogDescCont');">
			        설명<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 게시수 | <?php echo $this->_tpl_vars['hits']; ?>
 방문수 | Activity=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			최종 수정: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>

			<?php if ($this->_tpl_vars['rss_blog'] == 'y'): ?>
				&nbsp;&nbsp;&nbsp;
				<a class="bloglink" href="tiki-blog_rss.php?blogId=<?php echo $this->_tpl_vars['blogId']; ?>
">
					<img src='styles/estudiolivre/iRss.png' alt='RSS 피드' title='RSS 피드' />
				</a>
			<?php endif; ?>
