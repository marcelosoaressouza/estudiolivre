<?php /* Smarty version 2.6.18, created on 2011-04-05 03:54:17
...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="печать" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
">page id: <?php echo $this->_tpl_vars['page_id']; ?>
	...
	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(из кэша)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Предыдущая страница" 
...
"><img src="img/icons2/nav_home.gif" border="0" height="11" width="13" alt="Родительская страница" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Следующая страница" 
...
" />
	      ...
	      <?php else: ?>
	      <input type="checkbox" name="add_child" /> Потомок
	      <?php endif; ?>      
	      <input type="submit" name="insert_into_struct" value="Добавить страницу" />
	    </form>
	<?php endif; ?>
	  </td>
	</tr>
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Первая страница" title="Первая страница" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Предыдущая страница" title="Предыдущая страница" /></a>
	
			<small>стр.:<?php echo $this->_tpl_vars['pagenum']; ?>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Следующая страница" title="Следующая страница" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Последняя страница" title="Последняя страница" /></a>
		</div>
	<?php endif; ?>
	</div> 
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />                                         
	  Последнее изменение старницы <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
.
	</p>
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />
	  Последнее изменение старницы <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
 автор <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
.
	</p>
...
</i>, автор: <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
"><?php echo $this->_tpl_vars['lastUser']; ?>
</a>
	</p>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Для редактирования авторских прав <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">нажмите здесь</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    Оригинал доступен с:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
