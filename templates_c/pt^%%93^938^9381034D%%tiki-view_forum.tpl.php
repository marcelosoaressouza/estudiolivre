<?php /* Smarty version 2.6.18, created on 2011-05-13 12:53:29
...
&amp;watch_action=add"><img border='0' alt='monitorizar este fórum' src='img/icons/icon_watch.png' /></a>
	<?php else: ?>
		<a href="tiki-view_forum.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
&amp;watch_event=forum_post_topic&amp;watch_object=<?php echo $this->_tpl_vars['forumId']; ?>
&amp;watch_action=remove"><img border='0' alt='para de monitorizar este fórum' src='img/icons/icon_unwatch.png' /></a>
	<?php endif; ?>
<?php endif; ?>
...
<div id='forumpost' <?php if (( $this->_tpl_vars['comment_preview'] != 'y' && $this->_tpl_vars['openpost'] != 'y' )): ?>style="display:none"<?php endif; ?>>
  ...
  <br /><br />
  <div class="commentsedithelp"><br /><b>Tem que introduzir um título e um texto!</b><br /><br />
  </div>
  <br />
  <?php endif; ?>
  ...
  <?php if ($this->_tpl_vars['comments_threadId'] > 0): ?>
    <h1>A editar comentário: <?php echo ((is_array($_tmp=$this->_tpl_vars['comment_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</h1> 
    <?php endif; ?>
...
<br />
  <b>Publicar comentários:</b>
  <br />
  Usar [http://www.foo.com] ou [http://www.foo.com|description] para hiperligações<br />
  Tags HTML não são permitidos dentro dos comentários<br />
</div>
<br />
<?php endif; ?>
...
<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
	...
	<tr>
		<td class="heading" colspan='18'>acções de moderador</td>
	</tr>
	<tr>	
		<td class="odd" colspan="3">
		<input type="image" name="movesel" src="img/icons/topic_move.gif" border='0' alt='mover' title='mover os tópicos selecionados' />
		<input type="image" name="unlocksel" src="img/icons/topic_unlock.gif" border='0' alt='desbloquear' title='desbloquear os tópicos selecionados' />
		<input type="image" name="locksel" src="img/icons/topic_lock.gif" border='0' alt='bloquear' title='bloquear os tópicos selecionados' />
		<input type="image" name="delsel" src="img/icons/topic_delete.gif" border='0' alt='apagar' title='eliminar os tópicos selecionados' />
		<input type="image" name="splitsel" src="img/icons/topic_split.gif" border='0' alt='fundir' title='fundir os tópicos selecionados' />
		</td>
...
">mensagens assinaladas:<?php echo $this->_tpl_vars['reported']; ?>
</a></small><br />
		<?php endif; ?>
		<small><a class="link" href="tiki-forum_queue.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
">mensagens em fila:<?php echo $this->_tpl_vars['queued']; ?>
</a></small>
		</td>
	</tr>
...
"><?php echo $this->_tpl_vars['comments_coms'][$this->_sections['ix']['index']]['title']; ?>
		...
		<input type="submit" name="mergesel" value="fundir" />
		</td>
	</tr>
	<?php endif; ?>
...
" />
    <input type="hidden" name="forumId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['forumId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
    <small>Exibir publicações:</small>
...
<small>Saltar para o fórum:</small>
