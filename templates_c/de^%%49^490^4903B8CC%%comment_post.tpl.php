...
" />
		...
		<?php endif; ?>
		<div id="comButtons">
			<input type="submit" name="comments_previewComment" value="Vorschau"/>
			<input type="submit" name="comments_postComment" value="Eintrag"/>
			
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="abbrechen" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	Benutze [http://www.foo.com] oder [http://www.foo.com|Beschreibung] f&uuml;r Links.<br />
	HTML-Tags sind in Posts nicht erlaubt.<br />
