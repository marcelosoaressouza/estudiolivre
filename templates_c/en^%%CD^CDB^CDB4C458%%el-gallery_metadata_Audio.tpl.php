<?php /* Smarty version 2.6.18, created on 2011-04-04 17:43:27
...
<?php if ($this->_tpl_vars['arquivo']->typeOfAudio || ( ! $this->_tpl_vars['arquivo']->typeOfAudio && $this->_tpl_vars['permission'] )): ?>
	<div class="gUpMoreOptionsItem"><div class="gUpMoreOptionsName">Audio Type:</div> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['arquivo']->typeOfAudio,'id' => 'typeOfAudio','default' => "",'display' => 'inline'), $this);?>
</div>
<?php endif; ?>

<?php if ($this->_tpl_vars['arquivo']->genre || ( ! $this->_tpl_vars['arquivo']->genre && $this->_tpl_vars['permission'] )): ?>
<div class="gUpMoreOptionsItem"><div class="gUpMoreOptionsName">Genre:</div> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['arquivo']->genre,'id' => 'genre','default' => "",'display' => 'inline'), $this);?>
</div>
<?php endif; ?>

<?php if ($this->_tpl_vars['arquivo']->album || ( ! $this->_tpl_vars['arquivo']->album && $this->_tpl_vars['permission'] )): ?>
<div class="gUpMoreOptionsItem"><div class="gUpMoreOptionsName">Album:</div> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['arquivo']->album,'id' => 'album','default' => "",'display' => 'inline'), $this);?>
</div>
<?php endif; ?>
...
<div class="gUpMoreOptionsItemSingle"><div class="gUpMoreOptionsName">Technical Info:</div></div>
