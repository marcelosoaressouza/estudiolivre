...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="印刷" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
">page id: <?php echo $this->_tpl_vars['page_id']; ?>
	...
	<?php if ($this->_tpl_vars['cached_page'] == 'y'): ?><small>(キャッシュされた)</small><?php endif; ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Previous page" title="Previous page" /></a>
			...
			<small>ページ:<?php echo $this->_tpl_vars['pagenum']; ?>
...
">ここをクリック</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">The
content on this page is licensed under the terms of the <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
available at:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
