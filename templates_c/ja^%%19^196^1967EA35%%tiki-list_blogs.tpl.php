<?php /* Smarty version 2.6.18, created on 2011-04-11 10:37:30
	...
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=blogs">
				<img src='img/icons/config.gif' border='0'  alt="この機能の一般管理パネル" title="この機能の一般管理パネル" />
			</a>
		<?php endif; ?>
	</h1>
...
">
									<img title='管理・編集' alt='管理・編集' src='img/icons/config.gif' />
								</a>
							</td>
						<?php endif; ?>
					<?php endif; ?>
...
">
									<img title='ポスト' alt='ポスト' src='img/icons/edit.gif' />
								</a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
...
&amp;objectType=blog&amp;permType=blogs&amp;objectId=<?php echo $this->_tpl_vars['listpages'][$this->_sections['changes']['index']]['blogId']; ?>
">
								<img title='権限' alt='権限' src='img/icons/key.gif' />
							</a>
							</td>
					    <?php endif; ?>
					<?php endif; ?>		
...
">
		                      	<img title='削除' alt='削除' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
