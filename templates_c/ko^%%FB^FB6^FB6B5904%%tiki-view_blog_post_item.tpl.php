...
">
					<img src='img/icons2/nav_first.gif' border='0' alt='처음 페이지' title='처음 페이지' />
				</a>
...
">
					<img src='img/icons2/nav_dot_right.gif' border='0' alt='이전 페이지' title='이전 페이지' />
				</a>
...
">
					<img src='img/icons2/nav_dot_left.gif' border='0' alt='다음 페이지' title='다음 페이지' />
				</a>
...
">
					<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_last.gif','border' => '0','alt' => '마지막 페이지','title' => '마지막 페이지'), $this);?>
...
&type=blog post"><?php echo $this->_tpl_vars['tag']; ?>
	...
	<div class="postbottom">
		게시자:<i> <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['post']['user']; ?>
"><?php echo $this->_tpl_vars['post']['user']; ?>
</a></i>
		 
		<?php if ($this->_tpl_vars['use_title'] == 'y'): ?>
			 게시일: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['post']['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
		<?php endif; ?>
...
) <?php if ($this->_tpl_vars['post']['comments'] == 1): ?>댓글<?php else: ?>댓글<?php endif; ?>
					</a>
				<?php endif; ?>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a class="link" href="tiki-view_blog_post.php?find=<?php echo $this->_tpl_vars['find']; ?>
			...
			<?php if ($this->_tpl_vars['feature_blogposts_comments'] == 'y' && $this->_tpl_vars['blog_data']['allow_comments'] == 'y' && ( ( $this->_tpl_vars['tiki_p_read_comments'] == 'y' && $this->_tpl_vars['comments_cant'] != 0 ) || $this->_tpl_vars['tiki_p_post_comments'] == 'y' || $this->_tpl_vars['tiki_p_edit_comments'] == 'y' )): ?>
				...
				<a href="#comments" onclick="javascript:flip('comzone<?php if ($this->_tpl_vars['comments_show'] == 'y'): ?>open<?php endif; ?>');" class="linkbut">
					<?php if ($this->_tpl_vars['comments_cant'] == 1): ?>
						<span class="highlight">댓글 1개</span>
					<?php else: ?>
