...
<?php if ($this->_tpl_vars['words']): ?>
	<?php if (! ( $this->_tpl_vars['searchNoResults'] )): ?>
		<?php if ($this->_tpl_vars['results']): ?>
			Encontado "<?php echo $this->_tpl_vars['words']; ?>
" en <?php echo $this->_tpl_vars['cant_results']; ?>
...
unset($_smarty_tpl_vars);
 ?>
			...
			<div id="searchNoResults">
				No se encontraron páginas para el criterio de búsqueda<br />
