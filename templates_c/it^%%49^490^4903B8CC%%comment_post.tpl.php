...
" />
		...
		<?php endif; ?>
		<div id="comButtons">
			<input type="submit" name="comments_previewComment" value="anteprima"/>
			<input type="submit" name="comments_postComment" value="invia"/>
			
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="annulla" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	Usa [http://www.foo.com] o [http://www.foo.com|descrizione] per links.<br />
