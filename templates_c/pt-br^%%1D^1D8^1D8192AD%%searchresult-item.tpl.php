<?php /* Smarty version 2.6.18, created on 2011-05-02 18:36:50
         compiled from styles/obscur/searchresult-item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'styles/obscur/searchresult-item.tpl', 2, false),array('modifier', 'strip_tags', 'styles/obscur/searchresult-item.tpl', 5, false),array('block', 'tooltip', 'styles/obscur/searchresult-item.tpl', 3, false),)), $this); ?>
<div class="searchResultItem">
	...
	<?php $this->_tag_stack[] = array('tooltip', array('text' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tiptext'])) ? $this->_run_mod_handler('cat', true, $_tmp, " - Visitas: ") : smarty_modifier_cat($_tmp, " - Visitas: ")))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['result']['hits']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['result']['hits'])))); $_block_repeat=true;smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
