<?php /* Smarty version 2.6.18, created on 2011-04-10 03:17:36
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><br />
	...
	<center>
		<input type="submit" name="pollVote" value="投票" />
	</center>
</form>
	<?php else: ?>
</form>
<center>
	<input type="submit" onclick="showLightbox('precisaLogar'); return false;" value="投票" />
</center>
...
">View Results</a><br />
	(投票: <?php echo $this->_tpl_vars['menu_info']['votes']; ?>
)
...
&amp;comzone=show#comments">コメント: <?php echo $this->_tpl_vars['comments']; ?>
</a>)<?php endif; ?>
</center>
