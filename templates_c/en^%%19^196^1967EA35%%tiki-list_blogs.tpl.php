<?php /* Smarty version 2.6.18, created on 2011-04-04 18:42:21
...
">
									<img title='edit' alt='edit' src='img/icons/config.gif' />
								</a>
							</td>
						<?php endif; ?>
					<?php endif; ?>
...
">
		                      	<img title='remove' alt='remove' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
