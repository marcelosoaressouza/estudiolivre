...
<?php if ($this->_tpl_vars['user']): ?>
    <?php if ($this->_tpl_vars['feature_blogs'] == 'y'): ?>
		<?php $this->_tag_stack[] = array('tikimodule', array('title' => 'Mes blogues','name' => 'user_blogs','flip' => $this->_tpl_vars['module_params']['flip'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
