...
<?php $this->_tag_stack[] = array('tikimodule', array('title' => "Usuari@s En Línea (".($this->_tpl_vars['numberOfUsers']).")",'name' => 'who_is_there','flip' => $this->_tpl_vars['module_params']['flip'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
