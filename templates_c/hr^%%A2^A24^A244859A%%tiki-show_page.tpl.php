<?php /* Smarty version 2.6.18, created on 2011-05-12 04:19:54
...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="ispis" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Prethodna stranica" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Slijedeća stranica" 
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Prva stranica" title="Prva stranica" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Prethodna stranica" title="Prethodna stranica" /></a>
	
			<small>stranica:<?php echo $this->_tpl_vars['pagenum']; ?>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Slijedeća stranica" title="Slijedeća stranica" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Zadnja stranica" title="Zadnja stranica" /></a>
		</div>
	<?php endif; ?>
	</div> 
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />
	  Page last modified on <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
 od <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
.
	</p>
...
</i>, od: <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
"><?php echo $this->_tpl_vars['lastUser']; ?>
</a>
	</p>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Da se izmijene podaci o autorskim pravima <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">klikni ovdje</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">Sadržaj ove stranice je licenciran po uslovima od <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    Originalan dokument možete naći na:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
