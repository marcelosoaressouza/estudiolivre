<?php /* Smarty version 2.6.18, created on 2011-04-10 18:09:28
...
<h5>
  <?php if ($this->_tpl_vars['tiki_p_forum_post_topic'] == 'y'): ?>
	<span class="pointer" onclick="flip('forumpost');"/>nuevo tópico</span>
  	&nbsp;|&nbsp;
  <?php endif; ?>
...
&amp;watch_action=add"><img border='0' alt='monitorizar este foro' src='img/icons/icon_watch.png' /></a>
	<?php else: ?>
		<a href="tiki-view_forum.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
&amp;watch_event=forum_post_topic&amp;watch_object=<?php echo $this->_tpl_vars['forumId']; ?>
&amp;watch_action=remove"><img border='0' alt='dejar de monitorizar este foro' src='img/icons/icon_unwatch.png' /></a>
	<?php endif; ?>
<?php endif; ?>

<?php if ($this->_tpl_vars['unread'] > 0): ?>
	<a class='link' href='messu-mailbox.php'>Tiene <?php echo $this->_tpl_vars['unread']; ?>
 mensajes privados no leídos<br /></a>
<?php endif; ?>

<?php if ($this->_tpl_vars['was_queued'] == 'y'): ?>
<div class="wikitext">
<small>Su mensaje ha quedado en cola para aprobación, el mensaje será posteado luego que
 un moderador lo apruebe.</small>
</div>
<?php endif; ?>
...
<div id='forumpost' <?php if (( $this->_tpl_vars['comment_preview'] != 'y' && $this->_tpl_vars['openpost'] != 'y' )): ?>style="display:none"<?php endif; ?>>
	<?php if ($this->_tpl_vars['comment_preview'] == 'y'): ?>
		...
		<div class="forumpost">
			...
			<div class="postbottom">
				posteado por: <?php echo $this->_tpl_vars['user']; ?>
  ...
  <br /><br />
  <div class="commentsedithelp"><br /><b>Debe entrar un título y texto!</b><br /><br />
  </div>
  <br />
  <?php endif; ?>
  ...
  <?php if ($this->_tpl_vars['comments_threadId'] > 0): ?>
    <h1>Editando mensaje: <?php echo ((is_array($_tmp=$this->_tpl_vars['comment_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</h1> 
    <?php endif; ?>
...
" />
	  Tipo: 
	      ...
	      <?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
		      <option value="a" <?php if ($this->_tpl_vars['comment_topictype'] == 'a'): ?>selected="selected"<?php endif; ?>>anuncio</option>
		      ...
		      <option value="l" <?php if ($this->_tpl_vars['comment_topictype'] == 'l'): ?>selected="selected"<?php endif; ?>>bloqueado</option>
	      <?php endif; ?>
	   </select>
...
unset($_smarty_tpl_vars);
 ?>
	<?php endif; ?>
      ...
      <br>
      <input type="submit" name="comments_previewComment" value="vista previa"/>
      <input type="submit" name="comments_postComment" value="post"/>
...
<br />
  <b>Postear comentarios:</b>
  <br />
  Use [http://www.foo.com] o [http://www.foo.com|description] para enlaces<br />
  No se admite HTML en los comentarios<br />
</div>
<br />
<?php endif; ?>
...
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'replies_desc'): ?>replies_asc<?php else: ?>replies_desc<?php endif; ?>">respuestas</a></td>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['forum_info']['topics_list_reads'] == 'y'): ?>
  	<td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">lecturas</a></td>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['forum_info']['topics_list_lastpost'] == 'y'): ?>
  	<td class="heading"><a class="tableheading" href="tiki-view_forum.php?comments_threshold=<?php echo $this->_tpl_vars['comments_threshold']; ?>
&amp;forumId=<?php echo $this->_tpl_vars['forum_info']['forumId']; ?>
&amp;comments_offset=<?php echo $this->_tpl_vars['comments_offset']; ?>
&amp;comments_sort_mode=<?php if ($this->_tpl_vars['comments_sort_mode'] == 'lastPost_desc'): ?>lastPost_asc<?php else: ?>lastPost_desc<?php endif; ?>">último mensaje</a></td>
  <?php endif; ?>
...
&amp;comments_maxComments=<?php echo $this->_tpl_vars['comments_maxComments']; ?>
"
     class="admlink"><img src="img/icons2/delete.gif" border="0" width="16" height="16"  alt='eliminar' title='eliminar' /></a>
  <?php endif; ?>
...
<?php endfor; else: ?>
<tr>
	<td class="odd" colspan="8">Sin tópico aún</td>
</tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
	<tr>
	...
	<tr>
		<td class="heading" colspan='18'>acciones de moderador</td>
	</tr>
	<tr>	
		<td class="odd" colspan="3">
		<input type="image" name="movesel" src="img/icons/topic_move.gif" border='0' alt='mover' title='mover tópicos seleccionados' />
		<input type="image" name="unlocksel" src="img/icons/topic_unlock.gif" border='0' alt='desbloquear' title='desbloquear tópicos seleccionados' />
		<input type="image" name="locksel" src="img/icons/topic_lock.gif" border='0' alt='desbloquear' title='bloquear tópicos seleccionados' />
		<input type="image" name="delsel" src="img/icons/topic_delete.gif" border='0' alt='eliminar' title='borrar tópicos seleccionados' />
		<input type="image" name="splitsel" src="img/icons/topic_split.gif" border='0' alt='combinar' title='combinar tópicos seleccionados' />
		</td>
...
">mensajes reportados:<?php echo $this->_tpl_vars['reported']; ?>
</a></small><br />
		<?php endif; ?>
		<small><a class="link" href="tiki-forum_queue.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
">mensajes en cola:<?php echo $this->_tpl_vars['queued']; ?>
</a></small>
		</td>
	</tr>
...
"><?php echo $this->_tpl_vars['comments_coms'][$this->_sections['ix']['index']]['title']; ?>
		...
		<input type="submit" name="mergesel" value="combinar" />
		</td>
	</tr>
	<?php endif; ?>
...
<?php if ($this->_tpl_vars['forum_info']['forum_last_n'] > 0): ?>
	...
	<table class="normal">
	<tr>
	 	<td class="heading">Último <?php echo $this->_tpl_vars['forum_info']['forum_last_n']; ?>
 tópicos de este foro</td>
	 	<?php unset($this->_sections['ix']);
$this->_sections['ix']['name'] = 'ix';
...
" />
    <input type="hidden" name="forumId" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['forumId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
    <small>Mostrar posts:</small>
    <select name="time_control" onchange="javascript:document.getElementById('time_control').submit();">
    	<option value="" <?php if ($_REQUEST['time_control'] == ''): ?>selected="selected"<?php endif; ?>>Todos los posts</option>
