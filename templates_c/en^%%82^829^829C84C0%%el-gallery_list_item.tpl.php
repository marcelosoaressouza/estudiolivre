<?php /* Smarty version 2.6.18, created on 2011-04-04 17:14:33
...
.png">
 ...
 voto<?php if (( $this->_tpl_vars['ratings'] > 1 || $this->_tpl_vars['ratings'] < 1 )): ?>s<?php endif; ?><br>Rating - go to the file\'s page to vote')"
...
">
	...
	<div class="listInfo">
		...
		<h4>
			<div class="asRow">
				<span class="lef">
					author: <em><?php echo $this->_tpl_vars['arquivo']->author; ?>
</em>
				</span>
				<span class="mid">
					sent by: <em><a href="el-user.php?view_user=<?php echo $this->_tpl_vars['arquivo']->user; ?>
"><?php echo $this->_tpl_vars['arquivo']->user; ?>
</a></em>
					<br />
					on: <em><?php echo ((is_array($_tmp=$this->_tpl_vars['arquivo']->publishDate)) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y") : smarty_modifier_date_format($_tmp, "%d/%m/%y")); ?>
</em>
				</span>
				<span class="rig">
					type: <em><?php $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo $this->_tpl_vars['arquivo']->type; ?>
...
">
		...
		<h4>
			<div class="asRow">
				<span class="lef">
					downloaded: <em><?php echo $this->_tpl_vars['file']->downloads; ?>
 <?php if ($this->_tpl_vars['file']->downloads == 1): ?>time<?php else: ?>times<?php endif; ?></em>
					<?php if ($this->_tpl_vars['tooltipText']): ?>
						<br />
						streamed: <em><?php echo $this->_tpl_vars['file']->streams; ?>
 <?php if ($this->_tpl_vars['file']->streams == 1): ?>time<?php else: ?>times<?php endif; ?></em>
					<?php endif; ?>
				</span>
				<span class="mid">
					comments:
