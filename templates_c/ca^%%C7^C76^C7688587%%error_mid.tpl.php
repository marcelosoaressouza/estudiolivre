<?php /* Smarty version 2.6.18, created on 2011-04-18 07:09:12
...
" class="wiki"><?php echo $this->_tpl_vars['likepages'][$this->_sections['back']['index']]; ?>
	...
	<?php else: ?>
		No hi ha pàgines wiki similars a '<?php echo $this->_tpl_vars['page']; ?>
'
			<br/><br/>
	<?php endif; ?>
...
" class="linkmenu">Crear aquest pàgina</a>
	(page will be orphaned)<br /><br/>
<?php endif; ?>
<a href="javascript:history.back()" class="linkmenu">Tornar Enrera</a><br /><br />
<a href="<?php echo $this->_tpl_vars['tikiIndex']; ?>
" class="linkmenu">Torna a la pàgina d'inici</a>