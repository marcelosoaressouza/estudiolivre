<?php /* Smarty version 2.6.18, created on 2011-07-03 16:44:11
...
<h2>Registrar-se como novo utilizador</h2>
<br />
...
<table class="normal">
<tr><td class="formcolor">Utilizador:</td><td class="formcolor"><input type="text" name="name" /></td></tr>
<?php if ($this->_tpl_vars['useRegisterPasscode'] == 'y'): ?>
<tr><td class="formcolor">Código para registro (não é sua palavra-passe pessoal):</td><td class="formcolor"><input type="password" name="passcode" /></td></tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['rnd_num_reg'] == 'y'): ?>
...
<tr><td class="formcolor">Confirmação de palavra-passe:</td><td class="formcolor"><input id='pass2' type="password" name="passAgain" /></td></tr>
...
<br />
<table class="normal">
<tr><td class="formcolor"><a class="link" href="javascript:genPass('genepass','pass1','pass2');">Gerar uma palavra-passe</a></td>
