...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Ações de moderador</td>
					</tr>
					<tr>
						<td class="odd">
							<input type="submit" name="delsel" value="apagar selecionados" />
						</td>
					</tr>
					<tr>
						<td class="odd">
...
">
									enviadas:<?php echo $this->_tpl_vars['reported']; ?>
...
">
								pendentes:<?php echo $this->_tpl_vars['queued']; ?>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>responder<?php else: ?>respostas<?php endif; ?> abaixo seu limite atual
			<?php endif; ?>
	  		<div class="paginacao">
