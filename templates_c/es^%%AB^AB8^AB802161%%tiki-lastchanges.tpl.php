<?php /* Smarty version 2.6.18, created on 2011-05-03 12:31:35
...
<div id="listLastChanges">
	<h1>
		...
		<?php else: ?> 
			Últimas modificaciones &nbsp;&nbsp;&nbsp; <a href="tiki-wiki_rss.php?ver=2"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iRss.png"></a>
		<?php endif; ?>
	</h1>
...
" title="confirmar restablecimiento de página">
						b</a>&nbsp;
					<?php endif; ?>
					<a class="link" href="tiki-pagehistory.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['lastchanges'][$this->_sections['changes']['index']]['pageName'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
