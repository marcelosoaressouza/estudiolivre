...
" />
    	<?php endfor; endif; ?>
  		...
  		<?php if ($this->_tpl_vars['parent_coms']): ?>
				Responder para a mensagem principal
		<?php else: ?>
				<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
					Responder
				<?php endif; ?>
...
');"/>
	...
	Usar [http://www.foo.com] ou [http://www.foo.com|descrição] para links.<br />
	Tags HTML não são permitidos dentro de mensagens.<br />
