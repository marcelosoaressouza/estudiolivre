<?php /* Smarty version 2.6.18, created on 2011-04-05 07:55:17
...
" class="link">
	...
	<div id="edit">
		<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
			<a class="linkbut" title="Edit Forum" href="tiki-admin_forums.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
">Edit Forum</a><br />
		<?php endif; ?>
	</div>
...
"
					class="admlink">
						<img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiRemove.png" alt="Remove"/>
					</a>
				<?php endif; ?>     
...
">
						<img src='img/icons2/delete.gif' border='0' alt='remove' title='remove' />
					</a>					
				<?php endif; ?>
				<br />
			<?php endfor; endif; ?>
		<?php endif; ?>
		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
		reads: <i><?php echo $this->_tpl_vars['thread_info']['hits']; ?>
</i>
		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
		<?php if ($this->_tpl_vars['tiki_p_forum_post'] == 'y'): ?>
			<a class="linkbut" href="#form" onclick="flip('comzone')">reply</a>
		<?php endif; ?>
	</div>
