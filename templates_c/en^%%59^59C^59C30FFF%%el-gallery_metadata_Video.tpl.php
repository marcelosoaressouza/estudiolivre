...
<div class="gUpMoreOptionsItem"><div class="gUpMoreOptionsName">Video Language:</div> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['arquivo']->language,'id' => 'language','default' => "",'display' => 'inline'), $this);?>
</div>
<?php endif; ?>
...
<div class="gUpMoreOptionsName">Subtitle Language:</div> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['arquivo']->subtitleLanguage,'id' => 'subtitleLanguage','default' => "",'display' => 'inline'), $this);?>
</div>
<br/>
<?php endif; ?>
