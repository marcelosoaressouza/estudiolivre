<?php /* Smarty version 2.6.18, created on 2011-04-05 19:20:56
...
">Просмотр изображения: <span class="noslideshow"><?php echo $this->_tpl_vars['name']; ?>
...
" style="float: left;">вернуться в галерею</a>
...
" style="float: right;">редактировать изображение</a>
    <?php endif; ?>
  </p>
<?php endif; ?>
...
"
		class="gallink"<?php if ($this->_tpl_vars['imageId'] == $this->_tpl_vars['firstId']): ?> style="display: none;"<?php endif; ?>><?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_first.gif','border' => 'none','alt' => 'первая картинка','title' => 'первая картинка'), $this);?>
</a>
...
" class="gallink"><?php echo smarty_function_html_image(array('file' => 'img/icons/zoom-.gif','border' => 'none','alt' => 'меньше','title' => 'меньше'), $this);?>
</a>
	<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['resultscale']): ?>
	  <a href="<?php echo $this->_tpl_vars['url_base']; ?>
<?php echo $this->_tpl_vars['imageId']; ?>
&amp;scalesize=0" class="gallink"><?php echo smarty_function_html_image(array('file' => 'img/icons/zoom_equal.gif','border' => 'none','alt' => 'оригинальный размер','title' => 'оригинальный размер'), $this);?>
</a>
	<?php endif; ?>
...
" class="gallink"><?php echo smarty_function_html_image(array('file' => 'img/icons/zoom+.gif','border' => 'none','alt' => 'больше','title' => 'больше'), $this);?>
</a>
	<?php endif; ?>
...
<?php echo $this->_tpl_vars['same_scale']; ?>
"
    	class="gallink" style="padding-right:6px;<?php if (! $this->_tpl_vars['previmg']): ?> display: none;<?php endif; ?>">    	<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_dot_right.gif','border' => 'none','alt' => 'пред. картинка','title' => 'пред. картинка'), $this);?>
</a>
 ...
 class="gallink">
        <?php echo smarty_function_html_image(array('file' => 'img/icons2/admin_unhide.gif','border' => 'none','alt' => 'Всплывающее окно','title' => 'всплывающее окно'), $this);?>
</a>
	<?php endif; ?>
...
<?php echo $this->_tpl_vars['same_scale']; ?>
"
    	class="gallink" style="padding-left:6px;<?php if (! $this->_tpl_vars['nextimg']): ?> display: none;<?php endif; ?>">    	<?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_dot_left.gif','border' => 'none','alt' => 'след. картинка','title' => 'след. картинка'), $this);?>
</a>
...
<?php echo $this->_tpl_vars['same_scale']; ?>
"
		class="gallink"<?php if ($this->_tpl_vars['imageId'] == $this->_tpl_vars['lastId']): ?> style="display: none;"<?php endif; ?>><?php echo smarty_function_html_image(array('file' => 'img/icons2/nav_last.gif','border' => 'none','alt' => 'последняя картинка','title' => 'последняя картинка'), $this);?>
</a>    
  </div>
  ...
  <div class="slideshow" style="display: none;" align="center">
	...
	<a href="javascript:thepix.toggle('stop')"><?php echo smarty_function_html_image(array('file' => 'img/icons2/admin_delete.gif','border' => 'none','alt' => 'остановить','title' => 'остановить'), $this);?>
</a>
...
<?php if ($this->_tpl_vars['popup'] == ""): ?>
  ...
  <table class="normal noslideshow">
	<tr><td class="odd">Название:</td><td class="odd"><?php echo $this->_tpl_vars['name']; ?>
</td></tr>
	<tr><td class="even">Создано:</td><td class="even"><?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
</td></tr>
	<tr><td class="odd">Размер картинки:</td><td class="odd"><?php echo $this->_tpl_vars['xsize']; ?>
...
<?php else: ?>оригинальный размер<?php endif; ?></td></tr>
	<tr><td class="odd">Запросы:</td><td class="odd"><?php echo $this->_tpl_vars['hits']; ?>
</td></tr>
	<tr><td class="even">Описание:</td><td class="even"><?php echo $this->_tpl_vars['description']; ?>
</td></tr>
	<?php if ($this->_tpl_vars['feature_maps'] == 'y'): ?>
  	...
  	<?php endif; ?>
	<tr><td class="odd">Автор:</td><td class="odd"><?php echo $this->_tpl_vars['image_user']; ?>
</td></tr>
	<?php if ($this->_tpl_vars['tiki_p_admin_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['user'] == $this->_tpl_vars['owner'] )): ?>
	  <tr><td class="even">Переместить изображение:</td><td class="odd">
...
" <?php if ($this->_tpl_vars['galleries'][$this->_sections['idx']['index']]['id'] == $this->_tpl_vars['galleryId']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['galleries'][$this->_sections['idx']['index']]['name']; ?>
		...
		<input type="submit" name="move_image" value="переместить" />
	  </form>
	  </td></tr>
	<?php endif; ?>
  </table>
  ...
  <tr>
  	<td class="even">
  	<small>
    Вы сможете увидеть это изображение, используя:<br /><br />
