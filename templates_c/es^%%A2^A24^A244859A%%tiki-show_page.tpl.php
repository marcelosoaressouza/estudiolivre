<?php /* Smarty version 2.6.18, created on 2011-04-05 00:20:10
...
">id de página: <?php echo $this->_tpl_vars['page_id']; ?>
</a></small>
	<?php endif; ?>
...
"><img src="img/icons2/nav_home.gif" border="0" height="11" width="13" alt="Página superior" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Siguiente página" 
...
" />
	      ...
	      <?php else: ?>
	      <input type="checkbox" name="add_child" /> Hijo
	      <?php endif; ?>      
	      <input type="submit" name="insert_into_struct" value="Añadir Página" />
	    </form>
	<?php endif; ?>
	  </td>
	</tr>
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Primer página" title="Primer página" /></a>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Siguiente página" title="Siguiente página" /></a>
...
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Última página" title="Última página" /></a>
	...
	<p class="editdate">
	  Ultima edición por <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
...
?>
	   <?php if ($this->_sections['author']['first']): ?>, basado en trabajo de
	   <?php else: ?>
	  ...
	  <?php endfor; endif; ?>.<br />                                         
	  Página última modificacion en <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
.
	</p>
	<?php elseif (isset ( $this->_tpl_vars['wiki_authors_style'] ) && $this->_tpl_vars['wiki_authors_style'] == 'collaborative'): ?>
	<p class="editdate">
	  Contribuyentes a esta página: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
	...
	<?php if ($this->_tpl_vars['wiki_feature_copyrights'] == 'y' && $this->_tpl_vars['wikiLicensePage']): ?>
	  <?php if ($this->_tpl_vars['wikiLicensePage'] == $this->_tpl_vars['page']): ?>
	    <?php if ($this->_tpl_vars['tiki_p_edit_copyrights'] == 'y'): ?>
	      <p class="editdate">Para editar los avisos de copyright <a href="copyrights.php?page=<?php echo $this->_tpl_vars['copyrightpage']; ?>
">haga click acá</a>.</p>
	    <?php endif; ?>
	  <?php else: ?>
	    <p class="editdate">El contenido de esta página esta licenciado bajo los términos del <a href="tiki-index.php?page=<?php echo $this->_tpl_vars['wikiLicensePage']; ?>
...
"><?php echo $this->_tpl_vars['wikiLicensePage']; ?>
	...
	<?php if ($this->_tpl_vars['print_page'] == 'y'): ?>
	  <div class="printFooter" align="center">
	  	<p>
		    El documento original está disponible en:<br><b><?php echo $this->_tpl_vars['urlprefix']; ?>
