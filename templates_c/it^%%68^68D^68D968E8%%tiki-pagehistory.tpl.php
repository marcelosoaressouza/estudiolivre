<?php /* Smarty version 2.6.18, created on 2011-04-25 09:35:47
...
<?php endif; ?>" title="versioni">Versioni: <?php echo $this->_tpl_vars['page']; ?>
</a></h1>
...
" class="linkbut" title="mostra">Visualizza pagina</a></div>
...
" title="mostra"><?php echo $this->_tpl_vars['old']['version']; ?>
</a><?php if ($this->_tpl_vars['old']['version'] == $this->_tpl_vars['info']['version']): ?> (corrente)</a><?php endif; ?></b></th>
  <th colspan="2"><b>Version: <a href="tiki-pagehistory.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;preview=<?php echo $this->_tpl_vars['new']['version']; ?>
" title="mostra"><?php echo $this->_tpl_vars['new']['version']; ?>
<?php if ($this->_tpl_vars['new']['version'] == $this->_tpl_vars['info']['version']): ?> (corrente)</a><?php endif; ?></b></th>
</tr>
<tr>
...
<?php if ($this->_tpl_vars['preview'] || $this->_tpl_vars['source'] || $this->_tpl_vars['diff_style']): ?><h2>Versioni</h2><?php endif; ?>
...
<?php if ($this->_tpl_vars['default_wiki_diff_style'] != 'old' && $this->_tpl_vars['history']): ?>
<td class="odd button"><input type="radio" name="oldver" value="0" title="confronta" <?php if ($this->_tpl_vars['old']['version'] == $this->_tpl_vars['info']['version']): ?>checked="checked"<?php endif; ?> /></td>
<td class="odd button"><input type="radio" name="newver" value="0" title="confronta" <?php if ($this->_tpl_vars['new']['version'] == $this->_tpl_vars['info']['version'] || ! $this->_tpl_vars['diff_style']): ?>checked="checked"<?php endif; ?>  /></td>
<?php endif; ?>
</tr>
...
&amp;diff_style=sideview" title="confronta">c</a>
&nbsp;<a class="link" href="tiki-pagehistory.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;diff2=<?php echo $this->_tpl_vars['history'][$this->_sections['hist']['index']]['version']; ?>
