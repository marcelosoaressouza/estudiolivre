...
" />
			<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y' && $this->_tpl_vars['forum_mode'] == 'y'): ?>
				<table class="normal">
					<tr>
						<td colspan="3" class="heading">Acciones de moderador</td>
					</tr>
					<tr>
						<td class="odd">
							<input type="submit" name="delsel" value="borrar seleccionados" />
						</td>
					</tr>
					<tr>
						<td class="odd">
...
">
									reportado:<?php echo $this->_tpl_vars['reported']; ?>
...
">
								en cola:<?php echo $this->_tpl_vars['queued']; ?>
...
&nbsp;<?php if ($this->_tpl_vars['comments_below'] == 1): ?>responder<?php else: ?>respuestas<?php endif; ?> por debajo de su umbral actual
			<?php endif; ?>
	  		<div class="paginacao">
