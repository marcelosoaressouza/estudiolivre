...
" />
		...
		<div id="comButtons">
			...
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="취소" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	URL 링크사용법: [http://www.foo.com] 혹은 [http://www.foo.com|설명] .<br />
	HTML문법은 사용될 수 없습니다.<br />
