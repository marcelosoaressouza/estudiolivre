...
);setTimeout('nd();',2000);tooltip('Marking message <?php echo $this->_tpl_vars['msg']['msgId']; ?>
 as <b>read</b>');"
		<?php endif; ?>
	>
...
<?php endforeach; else: ?>
Be the first to send a message to this user!<br/>
<?php endif; unset($_from); ?>

<div id="uMsgSend">
<?php if ($this->_tpl_vars['user']): ?>
	<form onSubmit="sendMsg(); return false;">
		<input type="submit" name="" value="send" label="enviar" id="uMsgSendSubmit" onClick="sendMsg()">
	   	<input type="text" id="uMsgSendInput">
	</form>
<?php else: ?>
	You can't send messages because you are not logged in.
<?php endif; ?>
</div>