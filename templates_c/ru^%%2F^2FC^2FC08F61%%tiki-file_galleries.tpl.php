<?php /* Smarty version 2.6.18, created on 2011-05-04 06:11:42
...
File+Gallery" target="tikihelp" class="tikihelp" title="Файловые Галереи">
<img src="img/icons/help.gif" border="0" height="16" width="16" alt='помощь' /></a>
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_view_tpl'] == 'y' && $this->_tpl_vars['tiki_p_view_templates'] == 'y'): ?>
<a href="tiki-edit_templates.php?template=tiki-file_galleries.tpl" target="tikihelp" class="tikihelp" title="View tpl: File Galleries tpl">
<img src="img/icons/info.gif" border="0" width="16" height="16" alt='редактировать шаблон' /></a>
<?php endif; ?>

<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
<a href="tiki-admin.php?page=fgal"><img src='img/icons/config.gif' border='0'  alt="настройка списка" title="настройка списка" /></a>
<?php endif; ?>
</h1>
...
<h3>Create a file gallery</h3>
<?php else: ?>
<h3>Edit this file gallery: <?php echo $this->_tpl_vars['name']; ?>
</h3>
<a class="linkbut" href="tiki-file_galleries.php?edit_mode=1&amp;galleryId=0">создать новую галерею</a>
<?php endif; ?>
...
">Для этой файловой галереи заданы индивидуальные права доступа</a>
<?php endif; ?>
...
"/></td></tr>
<tr><td class="formcolor">Описание:</td><td class="formcolor"><textarea rows="5" cols="40" name="description"><?php echo ((is_array($_tmp=$this->_tpl_vars['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td></tr>
<!--<tr><td>Тема:</td><td><select name="theme">
...
<tr>
	<td class="formcolor">Настройка листинга</td>
	<td class="formcolor">
		<table >
			<tr>
				<td class="formcolor">icon</td>
				<td class="formcolor">id</td>
				<td class="formcolor">имя</td>
				<td class="formcolor">размер</td>
				<td class="formcolor">описание</td>
				<td class="formcolor">создано</td>
				<td class="formcolor">загрузки</td>
			</tr>
			<tr>
				...
				<td class="formcolor">
					<select name="show_name">
						<option value="a" <?php if ($this->_tpl_vars['show_name'] == 'a'): ?>selected="selected"<?php endif; ?>>Имя-Имя файла</option>
						<option value="n" <?php if ($this->_tpl_vars['show_name'] == 'n'): ?>selected="selected"<?php endif; ?>>Имя</option>
						<option value="f" <?php if ($this->_tpl_vars['show_name'] == 'f'): ?>selected="selected"<?php endif; ?>>Только имя файла</option>
					</select>
				</td>
...
<tr>
	<td class="formcolor">Максимальный размер описаний на экране</td>
...
unset($_smarty_tpl_vars);
 ?>
<tr><td class="formcolor">Другие пользователи могут пополнять галерею:</td><td class="formcolor"><input type="checkbox" name="public" <?php if ($this->_tpl_vars['public'] == 'y'): ?>checked="checked"<?php endif; ?>/></td></tr>
...
<div class="wikitext">
Доступ к галерее можно получить через следующий URL: <a class="fgallink" href="<?php echo $this->_tpl_vars['url']; ?>
...
<h2>Доступные файловые галереи</h2>
<?php if ($this->_tpl_vars['tiki_p_create_file_galleries'] == 'y'): ?>
<a class="linkbut" href="tiki-file_galleries.php?edit_mode=1&amp;galleryId=0">создать новую галерею</a><br /><br />
<?php endif; ?>
<div style="text-align: center">
...
<?php if ($this->_tpl_vars['fgal_list_files'] == 'y'): ?>	
	<?php $this->assign('cntcol', $this->_tpl_vars['cntcol']+1); ?>
	<td style="text-align:right;" class="heading">Файлы</td>
<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">Запросы</a></td>
<?php endif; ?>
...
"><img src="img/icons/config.gif" border="0" width="16" height="16" alt='правка' title='правка' /></a>
		<?php endif; ?>
	<?php endif; ?>
...
"><img src='img/icons2/upload.gif' border='0' alt='Закачать' title='Закачать' /></a>
			<?php endif; ?>
		<?php endif; ?>
	<?php endif; ?>
...
"><img src='img/icons/key_active.gif' alt='active perms' title='active perms' border='0' /></a>
		...
		<a class="fgallink" href="tiki-objectpermissions.php?objectName=<?php echo ((is_array($_tmp=$this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;objectType=file+gallery&amp;permType=file+galleries&amp;objectId=<?php echo $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['id']; ?>
"><img src='img/icons/key.gif' alt='права' title='права' border='0' /></a>
	    <?php endif; ?>
	<?php endif; ?>
<?php if ($this->_tpl_vars['tiki_p_admin_file_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['user'] == $this->_tpl_vars['user'] )): ?>
                <?php if (( $this->_tpl_vars['tiki_p_admin'] == 'y' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual'] == 'n' ) || ( $this->_tpl_vars['galleries'][$this->_sections['changes']['index']]['individual_tiki_p_create_file_galleries'] == 'y' )): ?>
...
"><img src='img/icons2/delete.gif' border='0' alt='удалить' title='удалить' /></a>
                <?php endif; ?>
        <?php endif; ?>
