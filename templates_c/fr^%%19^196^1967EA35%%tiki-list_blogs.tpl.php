<?php /* Smarty version 2.6.18, created on 2011-06-18 14:13:02
	...
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=blogs">
				<img src='img/icons/config.gif' border='0'  alt="configurer l'affichage" title="configurer l'affichage" />
			</a>
		<?php endif; ?>
	</h1>
...
">
									<img title='modifier' alt='modifier' src='img/icons/config.gif' />
								</a>
							</td>
						<?php endif; ?>
					<?php endif; ?>
...
">
									<img title='publier' alt='publier' src='img/icons/edit.gif' />
								</a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
...
">
								<img title='perms activées' alt='perms activées' src='img/icons/key_active.gif' />
							</a>
							</td>
					    <?php else: ?>
					    	<td>
...
&amp;objectType=blog&amp;permType=blogs&amp;objectId=<?php echo $this->_tpl_vars['listpages'][$this->_sections['changes']['index']]['blogId']; ?>
">
								<img title='droits' alt='droits' src='img/icons/key.gif' />
							</a>
							</td>
					    <?php endif; ?>
					<?php endif; ?>		
...
">
		                      	<img title='supprimer' alt='supprimer' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
