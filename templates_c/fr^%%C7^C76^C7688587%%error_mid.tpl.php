<?php /* Smarty version 2.6.18, created on 2011-04-06 07:36:40
...
" class="wiki"><?php echo $this->_tpl_vars['likepages'][$this->_sections['back']['index']]; ?>
	...
	<?php else: ?>
		Il n'y a pas de page similaire à '<?php echo $this->_tpl_vars['page']; ?>
'
			<br/><br/>
	<?php endif; ?>
...
" class="linkmenu">Créer cette page</a>
	(la page sera orpheline)<br /><br/>
<?php endif; ?>
<a href="javascript:history.back()" class="linkmenu">Revenir à la page précédente</a><br /><br />
<a href="<?php echo $this->_tpl_vars['tikiIndex']; ?>
" class="linkmenu">Retour à la page d'accueil</a>