...
" />
		...
		<?php endif; ?>
		<div id="comButtons">
			<input type="submit" name="comments_previewComment" value="תצוגה מקדימה"/>
			<input type="submit" name="comments_postComment" value="הוספה"/>
			
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="ביטול" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	יש להשתמש ב- [http://www.foo.com] או [http://www.foo.com|תיאור] כדי להוסיף קישורים.<br />
	HTML tags are not allowed inside posts.<br />
