<?php /* Smarty version 2.6.18, created on 2011-06-06 09:02:46
...
<h1><a class="pagetitle" href="tiki-my_tiki.php">Meu Tiki</a>

<?php if ($this->_tpl_vars['feature_help'] == 'y'): ?>
<a href="<?php echo $this->_tpl_vars['helpurl']; ?>
MyTiki" target="tikihelp" class="tikihelp" title="Área pessoal">
<img src="img/icons/help.gif" border="0" height="16" width="16" alt='auxílio' /></a>
<?php endif; ?>

<?php if ($this->_tpl_vars['feature_view_tpl'] == 'y'): ?>
<a href="tiki-edit_templates.php?template=tiki-my_tiki.tpl" target="tikihelp" class="tikihelp" title="Exibir tpl: área pessoal tpl">
...
<div id="content1" class="content">
  <div class="cbox">
  <div class="cbox-title"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user']): ?>Minhas páginas<?php else: ?>Páginas de Usuários<?php endif; ?></div>
  <div class="cbox-data">
  <table class="normal">
  <tr>
  <th class="heading"><a class="tableheading" href="tiki-my_tiki.php?sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'pageName_desc'): ?>pageName_asc<?php else: ?>pageName_desc<?php endif; ?>">Página</a></th>
  <th class="heading">Criador</th>
  <th class="heading">Último editor</th>
  <th class="heading"><a class="tableheading" href="tiki-my_tiki.php?sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'date_desc'): ?>date_asc<?php else: ?>date_desc<?php endif; ?>">Última alteração</a></th><th class="heading">Ações</th></tr>
...
"><a class="link" title="ver: <?php echo $this->_tpl_vars['user_pages'][$this->_sections['ix']['index']]['pageName']; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['user_pages'][$this->_sections['ix']['index']]['pageName'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, "(...)") : smarty_modifier_truncate($_tmp, 40, "(...)")); ?>
  ...
  <td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
" style="text-align:center;"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user_pages'][$this->_sections['ix']['index']]['creator']): ?>s<?php else: ?>&nbsp;<?php endif; ?></td>
  <td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
" style="text-align:center;"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user_pages'][$this->_sections['ix']['index']]['lastEditor']): ?>s<?php else: ?>&nbsp;<?php endif; ?></td>
  <td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
...
"><img border="0" alt="editar" title="editar: <?php echo $this->_tpl_vars['user_pages'][$this->_sections['ix']['index']]['pageName']; ?>
...
<div id="content2" class="content">
  <div class="cbox">
  <div class="cbox-title"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user']): ?>Minhas galerias<?php else: ?>Galerias de Usuário<?php endif; ?></div>
  <div class="cbox-data">
  <table class="normal">
  <?php echo smarty_function_cycle(array('values' => "even,odd",'print' => false), $this);?>
...
"><img border="0" alt="editar" title="editar" src="img/icons/edit.gif" /></a>
  </td></tr>
  <?php endfor; endif; ?>
  </table>
  </div>
...
<div id="content3" class="content">
  <div class="cbox">
  <div class="cbox-title"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user']): ?>Meus itens<?php else: ?>Itens atribuídos<?php endif; ?></div>
  <div class="cbox-data">
  <table class="normal">
  <tr><th class="heading">Ítem</th><th class="heading">Acompanhamento</th></tr>
  <?php echo smarty_function_cycle(array('values' => "even,odd",'print' => false), $this);?>
...
?>
  <tr><td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
">
  <a class="link" title="ver" href="tiki-view_tracker_item.php?trackerId=<?php echo $this->_tpl_vars['user_items'][$this->_sections['ix']['index']]['trackerId']; ?>
...
"><?php echo $this->_tpl_vars['user_items'][$this->_sections['ix']['index']]['value']; ?>
   ...
   <td class="<?php echo smarty_function_cycle(array(), $this);?>
"><a class="link" title="ver" href="tiki-view_tracker.php?trackerId=<?php echo $this->_tpl_vars['user_items'][$this->_sections['ix']['index']]['trackerId']; ?>
...
<div id="content4" class="content">
  <div class="cbox">
  <div class="cbox-title">Mensagens não lidas</div>
  <table  class="normal">
  <tr><th class="heading">Assunto</th><th class="heading">De</th><th class="heading">Data</th></tr>
  <?php echo smarty_function_cycle(array('values' => "even,odd",'print' => false), $this);?>
...
?>
  <tr><td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
">
  <a class="link" title="ver" href="messu-read.php?offset=0&amp;flag=&amp;flagval=&amp;find=&amp;sort_mode=date_desc&amp;priority=&amp;msgId=<?php echo $this->_tpl_vars['msgs'][$this->_sections['ix']['index']]['msgId']; ?>
...
<div id="content5" class="content">
  <div class="cbox">
  <div class="cbox-title"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user']): ?>Minhas tarefas<?php else: ?>Tarefas do usuário<?php endif; ?></div>
  <table  class="normal">
  <?php echo smarty_function_cycle(array('values' => "even,odd",'print' => false), $this);?>
...
<div id="content6" class="content">
  <div class="cbox">
  <div class="cbox-title"><?php if ($this->_tpl_vars['userwatch'] == $this->_tpl_vars['user']): ?>Meus Blogs<?php else: ?>Blogs de Usuários<?php endif; ?></div>
  <table  class="normal">
  <?php echo smarty_function_cycle(array('values' => "even,odd",'print' => false), $this);?>
...
?>
  <tr><td class="<?php echo smarty_function_cycle(array('advance' => false), $this);?>
">
  <a class="link" title="ver" href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['user_blogs'][$this->_sections['ix']['index']]['blogId']; ?>
...
<?php if (((is_array($_tmp=$this->_smarty_vars['capture']['my'])) ? $this->_run_mod_handler('strip', true, $_tmp, '') : smarty_modifier_strip($_tmp, '')) == ''): ?>To display the objects you participate to: <a href="tiki-user_preferences.php?tab3#MyTiki">Meu Tiki</a><?php endif; ?>