<?php /* Smarty version 2.6.18, created on 2011-04-07 23:22:29
...
">
ギャラリー: <?php echo $this->_tpl_vars['name']; ?>
...
" class="linkbut">サムネールを再作成</a></span>
  <?php endif; ?>
...
" class="linkbut">画像のアップロード</a></span>
    <?php endif; ?>
  <?php endif; ?>
...
<br />
	...
	<span class="sorttitle">画像のソート</span>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'name_desc'): ?>name_asc<?php else: ?>name_desc<?php endif; ?>">名前</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>created_asc<?php else: ?>created_desc<?php endif; ?>">日付</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">ヒット数</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">ユーザー</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filesize_desc'): ?>filesize_asc<?php else: ?>filesize_desc<?php endif; ?>">サイズ</a></span> ]
...
<br /><?php endif; ?>
			<?php if ($this->_tpl_vars['showcreated'] == 'y'): ?>作成日: <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['created'])) ? $this->_run_mod_handler('tiki_short_date', true, $_tmp) : smarty_modifier_tiki_short_date($_tmp)); ?>
<br /><?php endif; ?>
			<?php if ($this->_tpl_vars['showuser'] == 'y'): ?>ユーザー: <a href="tiki-user_information.php?user=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['user'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo $this->_tpl_vars['item']['user']; ?>
 ...
 <?php if ($this->_tpl_vars['item']['hits'] == 1): ?>hit<?php else: ?>ヒット数<?php endif; ?>]<br /><?php endif; ?>
                        </small>
	  </td>
...
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['showfilename'] == 'y'): ?>ファイル名: <?php echo $this->_tpl_vars['item']['filename']; ?>
<br /><?php endif; ?>
...
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['showcreated'] == 'y'): ?>作成日: <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['created'])) ? $this->_run_mod_handler('tiki_short_date', true, $_tmp) : smarty_modifier_tiki_short_date($_tmp)); ?>
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['showuser'] == 'y'): ?>ユーザー: <a href="tiki-user_information.php?view_user=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['user'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo $this->_tpl_vars['item']['user']; ?>
</a><br /><?php endif; ?>
...
x<?php echo $this->_tpl_vars['item']['ysize']; ?>
 ...
 Bytes)<?php endif; ?>
		<?php if ($this->_tpl_vars['showhits'] == 'y'): ?>[<?php echo $this->_tpl_vars['item']['hits']; ?>
 <?php if ($this->_tpl_vars['item']['hits'] == 1): ?>hit<?php else: ?>ヒット数<?php endif; ?>]<?php endif; ?>
          <br />
          <?php if ($this->_tpl_vars['tiki_p_admin_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['user'] == $this->_tpl_vars['owner'] )): ?>
...
&amp;sort_mode=<?php echo $this->_tpl_vars['sort_mode']; ?>
&amp;imageId=<?php echo $this->_tpl_vars['item']['imageId']; ?>
&amp;scalesize=0" title="元のサイズ"><img src='img/icons2/nav_dot.gif' border='0' width='8' height='11' alt='元のサイズ' title='元のサイズ' /></a>
	    		<?php endif; ?>
...
" title="右回転"><img src='img/icons2/admin_rotate.gif' border='0' width='11' height='11 alt='回転' title='回転' /></a>
            	<?php endif; ?>
            	<a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;remove=<?php echo $this->_tpl_vars['item']['imageId']; ?>
" title="削除"><img src='img/icons2/admin_delete.gif' border='0' width='11' height='11 alt='削除' title='削除' /></a>
...
" title="管理・編集"><img src='img/icons2/admin_move.gif' border='0' width='11' height='11 alt='管理・編集' title='管理・編集' /></a>
          <?php endif; ?>
 ...
 class="gallink">
<img src='img/icons2/admin_unhide.gif' border='0' width='11' height='11 alt='ポップアップ' title='ポップアップ' /></a>
          <br />
	</small>
         </td>
