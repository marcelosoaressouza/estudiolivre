<?php /* Smarty version 2.6.18, created on 2011-04-05 18:48:57
...
">Listing Gallery: <?php echo $this->_tpl_vars['name']; ?>
</a></h1>
...
" />
<table class="normal">
<tr><td class="formcolor">Filename:</td><td class="formcolor"><?php echo ((is_array($_tmp=$this->_tpl_vars['filename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td></tr>
<tr><td class="formcolor">Name:</td><td class="formcolor"><input type="text" name="fname" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fname'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"/></td></tr>
<tr><td class="formcolor">Description:</td><td class="formcolor"><textarea rows="5" cols="40" name="fdescription"><?php echo ((is_array($_tmp=$this->_tpl_vars['fdescription'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td></tr>
<tr><td class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" value="edit" name="edit" /></td></tr>
</table>
</form>
</div>
<br />
...
<tr>	
	...
	<input type="image" name="movesel" src="img/icons/topic_move.gif" alt="move" title="move selected files" />
	<input type="image" name="delsel" src="img/icons/topic_delete.gif" alt="delete" title="delete selected files" />
...
<?php if ($this->_tpl_vars['gal_info']['show_icon'] == 'y'): ?>
	<td class="heading"><a class="tableheading" href="tiki-list_file_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filetype_desc'): ?>filetype_asc<?php else: ?>filetype_desc<?php endif; ?>">Type</a></td>
<?php endif; ?>
...
<td class="heading"><a class="tableheading" href="tiki-list_file_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filename_desc'): ?>filename_asc<?php else: ?>filename_desc<?php endif; ?>">Filename</a></td>
<?php endif; ?>
...
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filesize_desc'): ?>filesize_asc<?php else: ?>filesize_desc<?php endif; ?>">Filesize</a></td>
<?php endif; ?>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>created_asc<?php else: ?>created_desc<?php endif; ?>">Created</a></td>
	<td  class="heading"><a class="tableheading" href="tiki-list_file_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">Creator</a></td>
<?php endif; ?>
...
"><img src='img/icons/edit.gif' border='0' alt="edit" title="edit" /></a>
