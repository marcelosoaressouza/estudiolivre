<?php /* Smarty version 2.6.18, created on 2011-06-03 07:39:29
...
<table class="normal">
<tr><td class="formcolor">계정이름:</td><td class="formcolor"><input type="text" name="name" /></td></tr>
<?php if ($this->_tpl_vars['useRegisterPasscode'] == 'y'): ?>
<tr><td class="formcolor">Passcode to register (not your user password):</td><td class="formcolor"><input type="password" name="passcode" /></td></tr>
<?php endif; ?>
<?php if ($this->_tpl_vars['rnd_num_reg'] == 'y'): ?>
<tr><td class="formcolor">Registration code:</td>
<td class="formcolor"><input type="text" maxlength="8" size="8" name="regcode" /></td></tr>
<?php endif; ?>

<tr><td class="formcolor">암호:</td><td class="formcolor"><input id='pass1' type="password" name="pass" /></td></tr>

<tr><td class="formcolor">암호 반복:</td><td class="formcolor"><input id='pass2' type="password" name="passAgain" /></td></tr>

<tr><td class="formcolor">이메일:</td><td class="formcolor"><input type="text" name="email" />
...
<tr><td  class="formcolor">&nbsp;</td><td class="formcolor"><input type="submit" name="register" value="등록" /></td></tr>

</table>
</form>
<br />
<table class="normal">
<tr><td class="formcolor"><a class="link" href="javascript:genPass('genepass','pass1','pass2');">암호생성</a></td>
