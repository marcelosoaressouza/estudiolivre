...
<?php if ($this->_tpl_vars['file']->width || ( ! $this->_tpl_vars['file']->width && $this->_tpl_vars['permission'] )): ?>
	<span class="fInfo">Width:</span> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['file']->width,'id' => 'width','display' => 'inline','file' => $this->_tpl_vars['viewFile']), $this);?>
 px
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php endif; ?>
<?php if ($this->_tpl_vars['file']->height || ( ! $this->_tpl_vars['file']->height && $this->_tpl_vars['permission'] )): ?>
	<span class="fInfo">Height:</span> <?php echo smarty_function_ajax_input(array('permission' => $this->_tpl_vars['permission'],'value' => $this->_tpl_vars['file']->height,'id' => 'height','display' => 'inline','file' => $this->_tpl_vars['viewFile']), $this);?>
 px
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php endif; ?>
