...
/img/logoAudio.png"></a>
    ...
    <?php else: ?>
        <li><a href="tiki-index.php?page=Links+de+%C3%81udio&bl">lenker</a></li>
    <?php endif; ?>
	</ul>
	</div>
...
/img/logoGrafi.png"></a>
    ...
    <?php if ($this->_tpl_vars['page'] == "Links de Gráfico"): ?>
       <li class="selectedGraf">lenker</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=Links de Gráfico&bl">lenker</a></li>
    <?php endif; ?>
	</ul>
	</div>
...
/img/logoVideo.png"></a>
    ...
    <?php if ($this->_tpl_vars['page'] == "Links de Vídeo"): ?>
       <li class="selectedVideo">lenker</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=Links de Vídeo&bl">lenker</a></li>
    <?php endif; ?>
	</ul>
	</div>
      		...
      		<div id="precisaLogar" class="none" style="width:200px;padding:5px">
      			...
      			Se for cadastrado, efetue o login:<br>
					    ...
					    <form id="uLoginBox" action="tiki-login.php" method="post">
					      ...
					      <input class="uText" type="text" name="user" id="login-user" size="12" value="bruker" onFocus="this.value=''"/>
