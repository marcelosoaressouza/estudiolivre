<?php /* Smarty version 2.6.18, created on 2011-04-16 21:42:32
	...
	<h1>
		...
		<?php if ($this->_tpl_vars['tiki_p_admin'] == 'y'): ?>
			<a href="tiki-admin.php?page=blogs">
				<img src='img/icons/config.gif' border='0'  alt="configurar listado" title="configurar listado" />
			</a>
		<?php endif; ?>
	</h1>
...
">
									<img title='post' alt='post' src='img/icons/edit.gif' />
								</a>
								</td>
							<?php endif; ?>
						<?php endif; ?>
...
">
								<img title='perms activos' alt='perms activos' src='img/icons/key_active.gif' />
							</a>
							</td>
					    <?php else: ?>
					    	<td>
...
">
		                      	<img title='eliminar' alt='eliminar' src='img/icons2/delete.gif' />
		                    </a>
		                    </td>
		                <?php endif; ?>
		    	    <?php endif; ?>
