...
" />
		...
		<div id="comButtons">
			...
			<?php if ($this->_tpl_vars['forum_mode'] == 'y'): ?>
				<input type="button" name="comments_cancelComment" value="取消" onclick="hide('<?php echo $this->_tpl_vars['postclass']; ?>
');"/>
		    <?php endif; ?>
	    </div>
	...
	Use [http://www.foo.com] or [http://www.foo.com|説明] for links.<br />
