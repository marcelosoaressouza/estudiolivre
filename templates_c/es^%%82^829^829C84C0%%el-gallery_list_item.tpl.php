<?php /* Smarty version 2.6.18, created on 2011-04-05 20:07:50
...
"><?php echo $this->_tpl_vars['arquivo']->user; ?>
					...
					<br />
					en: <em><?php echo ((is_array($_tmp=$this->_tpl_vars['arquivo']->publishDate)) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y") : smarty_modifier_date_format($_tmp, "%d/%m/%y")); ?>
</em>
				</span>
				<span class="rig">
