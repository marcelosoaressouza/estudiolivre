<?php /* Smarty version 2.6.18, created on 2011-04-04 18:25:52
...
">
Navegando pela Galeria: <?php echo $this->_tpl_vars['name']; ?>

</a></h1>

<div class="navbar">
<span class="button2"><a href="tiki-galleries.php" class="linkbut" title="listar galerias">listar galerias</a></span>
...
" class="linkbut">editar galeria</a></span>
...
" class="linkbut">Recriar miniaturas</a></span>
  <?php endif; ?>
...
" class="linkbut">carregar uma imagem</a></span>
    <?php endif; ?>
  <?php endif; ?>
...
" class="linkbut">Diretório em lote</a></span>
    <?php endif; ?>
  <?php endif; ?>
<?php endif; ?>
...
&amp;watch_action=add" title="monitorar essa galeria"><?php echo smarty_function_html_image(array('file' => 'img/icons/icon_watch.png','border' => '0','alt' => 'monitorar essa galeria'), $this);?>
</a>
		<?php else: ?>
			<a href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;watch_event=image_gallery_changed&amp;watch_object=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;watch_action=remove" title="parar de monitorar essa galeria"><?php echo smarty_function_html_image(array('file' => 'img/icons/icon_unwatch.png','border' => '0','alt' => 'parar de monitorar essa galeria'), $this);?>
</a>
		<?php endif; ?>
	<?php endif; ?>
</div>
...
<br />
	...
	<span class="sorttitle">Ordenar imagens por</span>
...
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'name_desc'): ?>name_asc<?php else: ?>name_desc<?php endif; ?>">Nome</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'created_desc'): ?>created_asc<?php else: ?>created_desc<?php endif; ?>">Data</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'hits_desc'): ?>hits_asc<?php else: ?>hits_desc<?php endif; ?>">Visitas</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'user_desc'): ?>user_asc<?php else: ?>user_desc<?php endif; ?>">Usuári@</a></span>
    | <span class="sortoption"><a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;offset=<?php echo $this->_tpl_vars['offset']; ?>
&amp;sort_mode=<?php if ($this->_tpl_vars['sort_mode'] == 'filesize_desc'): ?>filesize_asc<?php else: ?>filesize_desc<?php endif; ?>">Tamanho</a></span> ]
...
"><img alt="sub galeria <?php echo $this->_tpl_vars['item']['name']; ?>
...
<br /><?php endif; ?>
			<?php if ($this->_tpl_vars['showcreated'] == 'y'): ?>Criado em: <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['created'])) ? $this->_run_mod_handler('tiki_short_date', true, $_tmp) : smarty_modifier_tiki_short_date($_tmp)); ?>
<br /><?php endif; ?>
			<?php if ($this->_tpl_vars['showuser'] == 'y'): ?>Usuári@: <a href="tiki-user_information.php?user=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['user'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo $this->_tpl_vars['item']['user']; ?>
 ...
 <?php if ($this->_tpl_vars['item']['hits'] == 1): ?>visita<?php else: ?>visitas<?php endif; ?>]<br /><?php endif; ?>
                        </small>
	  </td>
...
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['showfilename'] == 'y'): ?>Nome do arquivo: <?php echo $this->_tpl_vars['item']['filename']; ?>
<br /><?php endif; ?>
...
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['showcreated'] == 'y'): ?>Criado em: <?php echo ((is_array($_tmp=$this->_tpl_vars['item']['created'])) ? $this->_run_mod_handler('tiki_short_date', true, $_tmp) : smarty_modifier_tiki_short_date($_tmp)); ?>
<br /><?php endif; ?>
		<?php if ($this->_tpl_vars['showuser'] == 'y'): ?>Usuári@: <a href="tiki-user_information.php?view_user=<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['user'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo $this->_tpl_vars['item']['user']; ?>
</a><br /><?php endif; ?>
...
x<?php echo $this->_tpl_vars['item']['ysize']; ?>
 ...
 Bytes)<?php endif; ?>
		<?php if ($this->_tpl_vars['showhits'] == 'y'): ?>[<?php echo $this->_tpl_vars['item']['hits']; ?>
 <?php if ($this->_tpl_vars['item']['hits'] == 1): ?>visita<?php else: ?>visitas<?php endif; ?>]<?php endif; ?>
          <br />
          <?php if ($this->_tpl_vars['tiki_p_admin_galleries'] == 'y' || ( $this->_tpl_vars['user'] && $this->_tpl_vars['user'] == $this->_tpl_vars['owner'] )): ?>
...
&amp;sort_mode=<?php echo $this->_tpl_vars['sort_mode']; ?>
&amp;imageId=<?php echo $this->_tpl_vars['item']['imageId']; ?>
&amp;scalesize=0" title="tamanho original"><img src='img/icons2/nav_dot.gif' border='0' width='8' height='11' alt='tamanho original' title='tamanho original' /></a>
	    		<?php endif; ?>
...
" title="girar para a direita"><img src='img/icons2/admin_rotate.gif' border='0' width='11' height='11 alt='girar' title='girar' /></a>
            	<?php endif; ?>
            	<a class="gallink" href="tiki-browse_gallery.php?galleryId=<?php echo $this->_tpl_vars['galleryId']; ?>
&amp;remove=<?php echo $this->_tpl_vars['item']['imageId']; ?>
" title="apagar"><img src='img/icons2/admin_delete.gif' border='0' width='11' height='11 alt='apagar' title='apagar' /></a>
...
" title="editar"><img src='img/icons2/admin_move.gif' border='0' width='11' height='11 alt='editar' title='editar' /></a>
          <?php endif; ?>
...
<img src='img/icons2/admin_unhide.gif' border='0' width='11' height='11 alt='popup' title='popup' /></a>
        ...
        <?php else: ?>
          <tr><td colspan="6">
            <p class="norecords">Nenhum registro encontrado</p>
          </td></tr>
        <?php endif; ?>
      </tr>
    </table>
