<?php /* Smarty version 2.6.18, created on 2011-05-03 19:41:11
         compiled from modules/mod-user_blogs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tikimodule', 'modules/mod-user_blogs.tpl', 5, false),)), $this); ?>


<?php if ($this->_tpl_vars['user']): ?>
    <?php if ($this->_tpl_vars['feature_blogs'] == 'y'): ?>
	<?php $this->_tag_stack[] = array('tikimodule', array('title' => 'Meus Blogs','name' => 'user_blogs','flip' => $this->_tpl_vars['module_params']['flip'],'decorations' => $this->_tpl_vars['module_params']['decorations'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
?>
	    <tr><?php if ($this->_tpl_vars['nonums'] != 'y'): ?><td class="module" valign="top"><?php echo $this->_sections['ix']['index_next']; ?>
)</td><?php endif; ?>
	    <td class="module"><a class="linkmodule" href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['modUserBlogs'][$this->_sections['ix']['index']]['blogId']; ?>
"><?php echo $this->_tpl_vars['modUserBlogs'][$this->_sections['ix']['index']]['title']; ?>
</a></td></tr>
	<?php endfor; endif; ?>
	</table>
