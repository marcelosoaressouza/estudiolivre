...
<?php if ($this->_tpl_vars['change_theme'] != 'n' || $this->_tpl_vars['user'] == ''): ?>
	...
	<?php $this->_tag_stack[] = array('tikimodule', array('title' => 'Change Style','name' => 'switch_theme','flip' => $this->_tpl_vars['module_params']['flip'],'decorations' => $this->_tpl_vars['module_params']['decorations'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
