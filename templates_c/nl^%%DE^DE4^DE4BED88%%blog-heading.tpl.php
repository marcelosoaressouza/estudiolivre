...
<div id="blogHead">
	<h1 onmouseover="tooltip('<b>Journaal Gemaakt door:</b> <?php echo $this->_tpl_vars['creator']; ?>
 <br><b> op :</b> <?php echo ((is_array($_tmp=$this->_tpl_vars['created'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m/%y") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m/%y")); ?>
')" onmouseout="nd();">
		Journaal: <a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['id']; ?>
...
.png');storeState('blogDescCont');">
			        Omschrijving<img id="TArrowBlogDesc"  src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
...
">
 ...
 bijdragen | <?php echo $this->_tpl_vars['hits']; ?>
 aantal bezoekers | Activiteit=<?php echo ((is_array($_tmp=$this->_tpl_vars['activity'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%.2f") : smarty_modifier_string_format($_tmp, "%.2f")); ?>
</h5>
			</div>
		</div>
		<h4>
			Laatst gewijzigd: <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%y - %H:%M") : smarty_modifier_date_format($_tmp, "%d/%m/%y - %H:%M")); ?>

			<?php if ($this->_tpl_vars['rss_blog'] == 'y'): ?>
				&nbsp;&nbsp;&nbsp;
				<a class="bloglink" href="tiki-blog_rss.php?blogId=<?php echo $this->_tpl_vars['blogId']; ?>
">
					<img src='styles/estudiolivre/iRss.png' alt='RSS-invoer' title='RSS-invoer' />
				</a>
			<?php endif; ?>
...
&amp;watch_action=add">
						monitor dit journaal
					</a>
				<?php else: ?>
					<a href="tiki-view_blog.php?blogId=<?php echo $this->_tpl_vars['blogId']; ?>
&amp;watch_event=blog_post&amp;watch_object=<?php echo $this->_tpl_vars['blogId']; ?>
&amp;watch_action=remove">
						stop monitoring van dit journaal
					</a>
				<?php endif; ?>
			<?php endif; ?>
		</h4>
