...
" />
	  ...
	  <?php if ($this->_tpl_vars['feature_blogs'] == 'y' && $this->_tpl_vars['rss_blogs'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Journaals" href="tiki-blogs_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_articles'] == 'y' && $this->_tpl_vars['rss_articles'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Artikelen" href="tiki-articles_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_galleries'] == 'y' && $this->_tpl_vars['rss_image_galleries'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Afbeeldinggalerijen" href="tiki-image_galleries_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['feature_file_galleries'] == 'y' && $this->_tpl_vars['rss_file_galleries'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Bestandgalerijen" href="tiki-file_galleries_rss.php?<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
...
" />
	  ...
	  <?php if ($this->_tpl_vars['feature_maps'] == 'y' && $this->_tpl_vars['rss_mapfiles'] == 'y'): ?>
		  <link rel="alternate" type="application/xml" title="RSS Kaarten" href="tiki-map_rss.php?ver=<?php echo $this->_tpl_vars['rssfeed_default_version']; ?>
" />
	  <?php endif; ?>
