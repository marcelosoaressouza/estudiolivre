...
/img/logoAudio.png"></a>
    ...
    <?php if ($this->_tpl_vars['page'] == 'equipamentos audio'): ?>
       <li class="selectedAudio">equipos</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=equipamentos audio&bl">equipos</a></li>
    <?php endif; ?>

    <?php if ($this->_tpl_vars['page'] == 'Produzindo Audio'): ?>
       <li class="selectedAudio">produciendo</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=Produzindo+Audio&bl">produciendo</a></li>
    <?php endif; ?>
...
/img/logoGrafi.png"></a>
    ...
    <?php if ($this->_tpl_vars['page'] == 'equipamentos grafico'): ?>
       <li class="selectedGraf">equipos</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=equipamentos grafico&bl">equipos</a></li>
    <?php endif; ?>

    <?php if ($this->_tpl_vars['page'] == "Produzindo Gráfico"): ?>
       <li class="selectedGraf">produciendo</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=Produzindo+Gráfico&bl">produciendo</a></li>
    <?php endif; ?>
...
/img/logoVideo.png"></a>
    ...
    <?php if ($this->_tpl_vars['page'] == 'equipamentos video'): ?>
       <li class="selectedVideo">equipos</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=equipamentos video&bl">equipos</a></li>
    <?php endif; ?>
    
    <?php if ($this->_tpl_vars['page'] == "Produzindo Vídeo"): ?>
       <li class="selectedVideo">produciendo</li>
    <?php else: ?>
       <li><a href="tiki-index.php?page=Produzindo+Vídeo&bl">produciendo</a></li>
    <?php endif; ?>
...
/img/logoAcervo.png"></a>
    ...
    <?php if ($this->_tpl_vars['current_location'] == "el-gallery_upload.php"): ?>      
      	<li class="selectedAcervo">compartir obra</li>
    <?php else: ?>
    	<?php if ($this->_tpl_vars['user']): ?>
        	<li><a href="el-gallery_upload.php">compartir obra</a></li>
        <?php else: ?>
      		<div id="precisaLogar" class="none" style="width:200px;padding:5px">
      			...
      			Se for cadastrado, efetue o login:<br>
					    ...
					    <form id="uLoginBox" action="tiki-login.php" method="post">
					      ...
					      <input class="uText" type="text" name="user" id="login-user" size="12" value="usuario" onFocus="this.value=''"/>
					      senha:<input class="uText" type="<?php if ($this->_tpl_vars['isIE']): ?>password<?php else: ?>text<?php endif; ?>" name="pass" id="login-pass" size="<?php if ($this->_tpl_vars['isIE']): ?>8<?php else: ?>10<?php endif; ?>" <?php if (! $this->_tpl_vars['isIE']): ?>value="contraseña" onFocus="this.value='';this.type='password'"<?php endif; ?>/>
...
/img/iLogin.png" />      
			  ...
			  <br><br>
				Se preferir, <a href="tiki-index.php?page=faq Acervo&bl">leia más</a> sobre el <b>Acervo Livre</b>.
      		</div>
      		<li onclick="showLightbox('precisaLogar')" style="cursor:pointer"><a>compartir obra</a></li>
        <?php endif; ?>   
    <?php endif; ?>
    ...
    <?php endif; ?>
     <li><a href="tiki-index.php?page=faq">sobre el acervo</a></li>
	</ul>
	</div>
  <?php endif; ?>
