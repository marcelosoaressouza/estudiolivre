<?php /* Smarty version 2.6.18, created on 2011-05-08 21:48:08
...
" class="link">
	...
	<div id="edit">
		<?php if ($this->_tpl_vars['tiki_p_admin_forum'] == 'y'): ?>
			<a class="linkbut" title="Modifier ce forum" href="tiki-admin_forums.php?forumId=<?php echo $this->_tpl_vars['forumId']; ?>
">Modifier ce forum</a><br />
		<?php endif; ?>
	</div>
...
/img/iWikiRemove.png" alt="Supprimer"/>
				...
				<?php if ($this->_tpl_vars['user'] && $this->_tpl_vars['feature_notepad'] == 'y' && $this->_tpl_vars['tiki_p_notepad'] == 'y'): ?>
					<a title="Enregistrer dans le bloc-note" href="tiki-view_forum_thread.php?topics_offset=<?php echo $_REQUEST['topics_offset']; ?>
<?php echo $this->_tpl_vars['topics_sort_mode_param']; ?>
<?php echo $this->_tpl_vars['topics_threshold_param']; ?>
<?php echo $this->_tpl_vars['topics_find_param']; ?>
...
/img/iSave.png" alt="Enregistrer"/>
	...
	<div class="postbottom">
		publié par:<i><?php echo ((is_array($_tmp=$this->_tpl_vars['thread_info']['userName'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
</i>
		le: <i><?php echo ((is_array($_tmp=$this->_tpl_vars['thread_info']['commentDate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M - %d/%m") : smarty_modifier_date_format($_tmp, "%H:%M - %d/%m")); ?>
</i>
...
">
					<img src="img/icons/attachment.gif" border="0" width="10" height= "13" alt='fichier joint' />
...
">
						<img src='img/icons2/delete.gif' border='0' alt='supprimer' title='supprimer' />
					</a>					
				<?php endif; ?>
				<br />
			<?php endfor; endif; ?>
		<?php endif; ?>
		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
		lectures: <i><?php echo $this->_tpl_vars['thread_info']['hits']; ?>
</i>
		&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
		<?php if ($this->_tpl_vars['tiki_p_forum_post'] == 'y'): ?>
			<a class="linkbut" href="#form" onclick="flip('comzone')">répondre</a>
		<?php endif; ?>
	</div>
...
unset($_smarty_tpl_vars);
 ...
 Commentaires au-dessus de votre seuil courant
		</small>
	<?php endif; ?>
</div>