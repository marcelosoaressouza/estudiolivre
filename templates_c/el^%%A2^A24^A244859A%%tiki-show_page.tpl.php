<?php /* Smarty version 2.6.18, created on 2011-04-21 10:50:59
...
"><img src="styles/<?php echo ((is_array($_tmp=$this->_tpl_vars['style'])) ? $this->_run_mod_handler('replace', true, $_tmp, ".css", "") : smarty_modifier_replace($_tmp, ".css", "")); ?>
/img/iWikiPrint.png" alt="εκτύπωση" /></a><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tooltip($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Προηγούμενη σελίδα" 
...
"><img src="img/icons2/nav_dot_left.gif" height="11" width="8" border="0" alt="Επόμενη σελίδα" 
...
"><img src="img/icons2/nav_first.gif" border="0" height="11" width="27" alt="Πρώτη σελίδα" title="Πρώτη σελίδα" /></a>
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['prev_page']; ?>
"><img src="img/icons2/nav_dot_right.gif" border="0" height="11" width="8" alt="Προηγούμενη σελίδα" title="Προηγούμενη σελίδα" /></a>
	
			<small>σελίδα:<?php echo $this->_tpl_vars['pagenum']; ?>
...
"><img src="img/icons2/nav_dot_left.gif" border="0" height="11" width="8" alt="Επόμενη σελίδα" title="Επόμενη σελίδα" /></a>
	
	
			<a href="tiki-index.php?<?php if ($this->_tpl_vars['page_info']): ?>page_ref_id=<?php echo $this->_tpl_vars['page_info']['page_ref_id']; ?>
<?php else: ?>page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php endif; ?>&amp;pagenum=<?php echo $this->_tpl_vars['last_page']; ?>
"><img src="img/icons2/nav_last.gif" border="0" height="11" width="27" alt="Τελευταία σελίδα" title="Τελευταία σελίδα" /></a>
		</div>
	<?php endif; ?>
	</div> 
...
?>
	  ...
	  <?php endfor; endif; ?>.<br />
	  Page last modified on <?php echo ((is_array($_tmp=$this->_tpl_vars['lastModif'])) ? $this->_run_mod_handler('tiki_long_datetime', true, $_tmp) : smarty_modifier_tiki_long_datetime($_tmp)); ?>
 από <?php echo ((is_array($_tmp=$this->_tpl_vars['lastUser'])) ? $this->_run_mod_handler('userlink', true, $_tmp) : smarty_modifier_userlink($_tmp)); ?>
.
	</p>
...
</i>, από: <a href="el-user.php?view_user=<?php echo $this->_tpl_vars['lastUser']; ?>
"><?php echo $this->_tpl_vars['lastUser']; ?>
</a>
	</p>
	<?php endif; ?>
